  ...
  en: {
    ...
    factStrip: [
      {
        ...
        value: "2 – 3 days",
        sub: "Two ceremonies, one arc",
      },
      { label: "Guest range", value: "120 – 400", sub: "Larger by request" },
      {
        label: "Lead time",
        value: "18 – 24 months",
        sub: "Two clergy book early",
      },
      {
        label: "Common pairings",
        value: "Hindu · Jewish",
        sub: "Catholic · Muslim · more",
      },
      {
        label: "Clergy",
        value: "Two officiants",
        sub: "As standard, not exception",
      },
      {
        label: "Languages",
        value: "EN + 1",
        sub: "Hebrew · Hindi · Arabic · Latin",
      },
    ],
    overview: {
    ...
    ceremonyArc: {
      ...
      steps: [
        {
          numeral: "I",
          name: "The two-clergy consultation",
          sub: "Both officiants, one table",
          when: "12 – 9 months out",
          body: "We bring both clergy together early to establish what each tradition permits, what each requires, and where the lines are. This conversation decides everything that follows.",
        },
        {
          numeral: "II",
          name: "Mapping the two rituals",
          sub: "Each tradition, held whole",
          when: "9 – 6 months out",
          body: "We lay each ceremony out in full — nothing abbreviated to make room for the other — then design the timing and the room so both can be honoured completely.",
        },
        {
          numeral: "III",
          name: "The first ceremony",
          sub: "The couple's chosen order",
          when: "Ceremony day",
          body: "The first tradition is held in full, led by its own clergy, in its own language, with its own sacred objects. Guests receive a guide so the unfamiliar feels welcoming, not opaque.",
        },
        {
          numeral: "IV",
          name: "The shared moment",
          sub: "Built by the couple",
          when: "Between the ceremonies",
          body: "One jointly designed element — a reading, a blessing, a procession from one ceremony to the next — that the couple authors together. It belongs to neither tradition and asks nothing of either clergy.",
        },
        {
          numeral: "V",
          name: "The second ceremony",
          sub: "The second tradition, whole",
          when: "Ceremony day",
          body: "The second tradition is held with the same completeness as the first, led by its own officiant. Neither ceremony is the headline; neither is the opening act.",
        },
        {
          numeral: "VI",
          name: "One reception",
          sub: "Two families, one table",
          when: "Evening",
          body: "A single celebration that carries both cultures forward — two cuisines, two kinds of music, one room. The point at which two families become, visibly, one.",
        },
      ],
    },
    designConcepts: {
    ...
    protocols: {
      ...
      items: [
        {
          title: "Neither tradition is abbreviated",
          body: "We never shorten one ceremony to make room for the other. If both cannot be held in full, we add a day rather than cut a rite. The whole point is that neither family watches their tradition treated as the lesser.",
        },
        {
          title: "Clergy meet each other first",
          body: "The two officiants speak before either of them sees the schedule. What each tradition permits, requires, and forbids is established between them — not assumed by us, and not discovered on the day.",
        },
        {
          title: "Families are briefed privately, separately",
          body: "Each family tells us, in confidence and apart, where their comfort and their lines are. Concerns are heard before they become tensions, and never relayed across the aisle without consent.",
        },
        {
          title: "Sacred objects do not share a stage casually",
          body: "A Torah, a sacred fire, a cross, a Qur'an — these are not props arranged for symmetry. Each is handled as its own tradition requires, and never combined for the sake of a photograph.",
        },
        {
          title: "The order of ceremonies is the couple's decision",
          body: "Which tradition goes first is theirs to choose — and once chosen, held firmly. We do not relitigate it under family pressure. Neither order implies precedence; both ceremonies are complete.",
        },
        {
          title: "Guests receive a guide to both traditions",
          body: "Every guest is given context for the faith that is not their own — what they will see, what it means, when to stand, what is invitation and what is observance. No one watches half the weekend as an outsider.",
        },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            {
              time: "Afternoon",
              body: "Guest arrivals · transfers · hotel check-in",
            },
            {
              time: "17:00",
              body: "Welcome reception · both families · introductions",
            },
            {
              time: "19:00",
              body: "Pre-wedding rite (mehndi, henna, or rehearsal) as the pairing calls for",
            },
            {
              time: "21:00",
              body: "Informal dinner · two cuisines · mixed seating",
            },
          ],
        },
        {
          ...
          events: [
            {
              time: "10:30",
              body: "First ceremony · own clergy · own language · own rites",
            },
            {
              time: "12:30",
              body: "The shared moment · couple-authored · between the ceremonies",
            },
            {
              time: "13:00",
              body: "Second ceremony · second clergy · held in full",
            },
            { time: "15:00", body: "Celebration lunch · both cuisines" },
            {
              time: "19:30",
              body: "Reception · two musical traditions · braided seating · first dance",
            },
          ],
        },
        {
    ...
    guest: {
      ...
      cells: [
        {
          title: "Dual dietary protocol",
          body: "Kosher and halal coordinated within a single kitchen plan — separate preparation, certified sourcing, no cross-contact — alongside vegetarian, Jain, vegan and allergen-free menus. One catering brief that honours both families' laws.",
        },
        {
          title: "Guides to both traditions",
          body: "Every guest receives context for the faith that is not their own: what they will see, what it means, when to stand, what is participation and what is witness. Printed in the welcome pack and on the wedding site.",
        },
        {
          title: "Seating across families",
          body: "We braid the two families rather than seating them apart. Place settings designed so neither side spends the reception among only its own — the room itself does the work of joining.",
        },
        {
          title: "Elders & sensitivities",
          body: "The relatives most attached to tradition are briefed first and seated with care. An elders' liaison from the studio manages comfort, mobility, and any quiet concern before it reaches the couple.",
        },
        {
          title: "Travel & accommodations",
          body: "Group room blocks across tiers, transfers coordinated across days of arrivals, welcome packages with the schedule, dress code per event, and a guide to both ceremonies in every room.",
        },
        {
          title: "Communications",
          body: "One WhatsApp group three weeks ahead, a wedding website carrying both ceremonies' context, and a studio team on hand through the weekend to answer — in either tradition — any question a guest is too polite to ask.",
        },
      ],
    },
    related: {
      ...
      articles: [
        {
          category: "Interfaith · Method",
          title:
            "How to Plan an Interfaith Wedding Without Diminishing Either Faith",
          body: "On holding two traditions whole — and why fusion is the wrong instinct.",
          imageKey: "culture-related-1",
        },
        {
          category: "Interfaith · Clergy",
          title: "Finding Two Clergy Who Will Share a Weekend",
          body: "The first and hardest question — and how denomination shapes the answer.",
          imageKey: "culture-related-2",
        },
        {
          category: "Hindu + Jewish",
          title: "The Pheras Beside the Chuppah",
          body: "A field note on the pairing we are asked for most.",
          imageKey: "culture-related-3",
        },
        {
          category: "Design · Interfaith",
          title: "Two Canopies, One Lawn",
          body: "Designing a setting that holds both traditions without forcing them to merge.",
          imageKey: "culture-related-4",
        },
        {
          category: "Cost · Interfaith",
          title: "What an Interfaith Destination Wedding Actually Costs",
          body: "Frank 2026 budgets for two-ceremony weekends.",
    ...
    faq: {
      ...
      items: [
        ...
        {
          question:
            "What about guests who have never attended either tradition?",
          answer: [
  ...
  es: {
    ...
    factStrip: [
      ...
      },
      {
        label: "Antelación",
        value: "18 – 24 meses",
        sub: "Dos oficiantes reservan pronto",
      },
      {
        label: "Combinaciones comunes",
        value: "Hindú · Judía",
        sub: "Católica · Musulmana · más",
      },
      {
        label: "Oficiantes",
        value: "Dos oficiantes",
        sub: "Como norma, no excepción",
      },
      {
        label: "Idiomas",
        value: "ES + 1",
        sub: "Hebreo · Hindi · Árabe · Latín",
      },
    ],
    overview: {
    ...
    ceremonyArc: {
      ...
      steps: [
        {
          numeral: "I",
          name: "La consulta de los dos oficiantes",
          sub: "Ambos oficiantes, una mesa",
          when: "12 – 9 meses antes",
          body: "Reunimos pronto a ambos oficiantes para establecer qué permite cada tradición, qué exige cada una y dónde están los límites. Esta conversación decide todo lo que sigue.",
        },
        {
          numeral: "II",
          name: "Trazar los dos rituales",
          sub: "Cada tradición, entera",
          when: "9 – 6 meses antes",
          body: "Desplegamos cada ceremonia por completo —nada acortado para dejar sitio a la otra— y luego diseñamos los tiempos y el espacio para que ambas puedan honrarse íntegramente.",
        },
        {
          numeral: "III",
          name: "La primera ceremonia",
          sub: "El orden elegido por la pareja",
          when: "Día de la ceremonia",
          body: "La primera tradición se sostiene entera, dirigida por su propio oficiante, en su propio idioma, con sus propios objetos sagrados. Los invitados reciben una guía para que lo desconocido resulte acogedor, no opaco.",
        },
        {
          numeral: "IV",
          name: "El momento compartido",
          sub: "Construido por la pareja",
          when: "Entre las ceremonias",
          body: "Un elemento diseñado en común —una lectura, una bendición, una procesión de una ceremonia a la otra— que la pareja crea junta. No pertenece a ninguna tradición ni exige nada de ninguno de los oficiantes.",
        },
        {
          numeral: "V",
          name: "La segunda ceremonia",
          sub: "La segunda tradición, entera",
          when: "Día de la ceremonia",
          body: "La segunda tradición se sostiene con la misma plenitud que la primera, dirigida por su propio oficiante. Ninguna ceremonia es el plato fuerte; ninguna es el telonero.",
        },
        {
          numeral: "VI",
          name: "Una recepción",
          sub: "Dos familias, una mesa",
          when: "Noche",
          body: "Una sola celebración que lleva adelante ambas culturas: dos cocinas, dos clases de música, una misma sala. El punto en que dos familias se vuelven, visiblemente, una.",
        },
      ],
    },
    designConcepts: {
      ...
      cards: [
        ...
        },
        {
          ...
          rows: [
            ...
            {
              label: "Ideal para",
              value: "Católica + Musulmana · capilla o villa",
            },
          ],
        },
        {
          ...
          rows: [
            ...
            {
              label: "Ideal para",
              value: "Cualquier combinación · centrada en la recepción",
            },
          ],
        },
      ],
    ...
    protocols: {
      ...
      items: [
        {
          title: "Ninguna tradición se acorta",
          body: "Nunca acortamos una ceremonia para dejar sitio a la otra. Si ambas no caben enteras, añadimos un día antes que recortar un rito. De eso se trata: que ninguna familia vea su tradición tratada como la menor.",
        },
        {
          title: "Los oficiantes se conocen primero",
          body: "Los dos oficiantes hablan antes de que ninguno vea el horario. Lo que cada tradición permite, exige y prohíbe se establece entre ellos, no lo suponemos nosotros ni se descubre el día de la boda.",
        },
        {
          title: "A las familias se las informa en privado y por separado",
          body: "Cada familia nos dice, en confianza y aparte, dónde están su comodidad y sus límites. Las inquietudes se escuchan antes de volverse tensiones, y nunca se trasladan al otro lado sin consentimiento.",
        },
        {
          title: "Los objetos sagrados no comparten escenario a la ligera",
          body: "Una Torá, un fuego sagrado, una cruz, un Corán: no son elementos decorativos dispuestos por simetría. Cada uno se trata como exige su tradición y nunca se combina para una fotografía.",
        },
        {
          title: "El orden de las ceremonias lo decide la pareja",
          body: "Qué tradición va primero es decisión suya, y una vez elegida, se mantiene con firmeza. No la revisamos bajo presión familiar. Ningún orden implica precedencia; ambas ceremonias son completas.",
        },
        {
          title: "Los invitados reciben una guía de ambas tradiciones",
          body: "A cada invitado se le da contexto sobre la fe que no es la suya: qué verá, qué significa, cuándo ponerse de pie, qué es invitación y qué es observancia. Nadie pasa medio fin de semana como extraño.",
        },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            ...
            {
              time: "17:00",
              body: "Recepción de bienvenida · ambas familias · presentaciones",
            },
            {
              time: "19:00",
              body: "Rito previo (mehndi, henna o ensayo) según lo pida la combinación",
            },
            {
              time: "21:00",
              body: "Cena informal · dos cocinas · asientos mixtos",
            },
          ],
        },
        {
          ...
          events: [
            {
              time: "10:30",
              body: "Primera ceremonia · su oficiante · su idioma · sus ritos",
            },
            {
              time: "12:30",
              body: "El momento compartido · creado por la pareja · entre las ceremonias",
            },
            {
              time: "13:00",
              body: "Segunda ceremonia · segundo oficiante · entera",
            },
            { time: "15:00", body: "Almuerzo de celebración · ambas cocinas" },
            {
              time: "19:30",
              body: "Recepción · dos tradiciones musicales · asientos entrelazados · primer baile",
            },
          ],
        },
        {
    ...
    guest: {
      ...
      cells: [
        {
          title: "Protocolo dietético doble",
          body: "Kosher y halal coordinados dentro de un único plan de cocina —preparación separada, suministro certificado, sin contacto cruzado— junto a menús vegetariano, jainista, vegano y sin alérgenos. Un solo encargo de catering que honra las leyes de ambas familias.",
        },
        {
          title: "Guías de ambas tradiciones",
          body: "Cada invitado recibe contexto sobre la fe que no es la suya: qué verá, qué significa, cuándo ponerse de pie, qué es participación y qué es presencia. Impreso en el paquete de bienvenida y en la web de la boda.",
        },
        {
          title: "Asientos entre familias",
          body: "Entrelazamos a las dos familias en vez de sentarlas aparte. Distribución pensada para que ningún lado pase la recepción solo entre los suyos: la propia sala hace el trabajo de unir.",
        },
        {
          title: "Mayores y sensibilidades",
          body: "A los parientes más apegados a la tradición se les informa primero y se les sienta con cuidado. Un enlace de mayores del atelier gestiona comodidad, movilidad y cualquier inquietud discreta antes de que llegue a la pareja.",
        },
        {
          title: "Viajes y alojamiento",
          body: "Bloques de habitaciones por categorías, traslados coordinados a lo largo de varios días de llegadas, paquetes de bienvenida con el horario, el código de vestimenta por evento y una guía de ambas ceremonias en cada habitación.",
        },
        {
          title: "Comunicaciones",
          body: "Un grupo de WhatsApp tres semanas antes, una web de la boda con el contexto de ambas ceremonias y un equipo del atelier disponible todo el fin de semana para responder —en cualquiera de las dos tradiciones— cualquier pregunta que un invitado sea demasiado cortés para hacer.",
        },
      ],
    },
    related: {
      ...
      articles: [
        {
          category: "Interreligiosa · Método",
          title:
            "Cómo planear una boda interreligiosa sin disminuir ninguna fe",
          body: "Sobre sostener dos tradiciones enteras, y por qué la fusión es el instinto equivocado.",
          imageKey: "culture-related-1",
        },
        {
          category: "Interreligiosa · Oficiantes",
          title: "Encontrar dos oficiantes que compartan un fin de semana",
          body: "La primera y más difícil pregunta, y cómo la confesión moldea la respuesta.",
          imageKey: "culture-related-2",
        },
        {
          category: "Hindú + Judía",
          title: "Los pheras junto a la chupá",
          body: "Una nota de campo sobre la combinación que más se nos pide.",
          imageKey: "culture-related-3",
        },
        {
          category: "Diseño · Interreligiosa",
          title: "Dos doseles, un jardín",
          body: "Diseñar un escenario que sostenga ambas tradiciones sin forzar su fusión.",
          imageKey: "culture-related-4",
        },
        {
          category: "Coste · Interreligiosa",
          title: "Lo que cuesta de verdad una boda interreligiosa en destino",
          body: "Presupuestos francos de 2026 para fines de semana de dos ceremonias.",
          imageKey: "culture-related-5",
        },
      ],
      sidebarDestinations: [
    ...
    faq: {
      ...
      items: [
        ...
        {
          question:
            "¿Y los invitados que nunca han asistido a ninguna de las dos tradiciones?",
          answer: [
  ...
  fr: {
    ...
    factStrip: [
      ...
      },
      {
        label: "Délai",
        value: "18 – 24 mois",
        sub: "Deux officiants réservent tôt",
      },
      {
        label: "Associations courantes",
        value: "Hindou · Juif",
        sub: "Catholique · Musulman · plus",
      },
      {
        label: "Officiants",
        value: "Deux officiants",
        sub: "Par principe, non par exception",
      },
      {
        label: "Langues",
        value: "FR + 1",
        sub: "Hébreu · Hindi · Arabe · Latin",
      },
    ],
    overview: {
    ...
    ceremonyArc: {
      ...
      steps: [
        {
          numeral: "I",
          name: "La consultation des deux officiants",
          sub: "Les deux officiants, une table",
          when: "12 – 9 mois avant",
          body: "Nous réunissons tôt les deux officiants pour établir ce que chaque tradition permet, ce que chacune exige et où sont les limites. Cette conversation décide de tout ce qui suit.",
        },
        {
          numeral: "II",
          name: "Cartographier les deux rituels",
          sub: "Chaque tradition, entière",
          when: "9 – 6 mois avant",
          body: "Nous déployons chaque cérémonie en entier — rien d'écourté pour faire place à l'autre — puis nous concevons le minutage et l'espace pour que les deux soient honorées pleinement.",
        },
        {
          numeral: "III",
          name: "La première cérémonie",
          sub: "L'ordre choisi par le couple",
          when: "Jour de la cérémonie",
          body: "La première tradition est tenue en entier, menée par son propre officiant, dans sa propre langue, avec ses propres objets sacrés. Les invités reçoivent un guide pour que l'inconnu se fasse accueillant, non opaque.",
        },
        {
          numeral: "IV",
          name: "Le moment partagé",
          sub: "Bâti par le couple",
          when: "Entre les cérémonies",
          body: "Un élément conçu en commun — une lecture, une bénédiction, une procession d'une cérémonie à l'autre — que le couple écrit ensemble. Il n'appartient à aucune tradition et ne demande rien à aucun officiant.",
        },
        {
          numeral: "V",
          name: "La seconde cérémonie",
          sub: "La seconde tradition, entière",
          when: "Jour de la cérémonie",
          body: "La seconde tradition est tenue avec la même plénitude que la première, menée par son propre officiant. Aucune cérémonie n'est la tête d'affiche ; aucune n'est la première partie.",
        },
        {
          numeral: "VI",
          name: "Une réception",
          sub: "Deux familles, une table",
          when: "Soirée",
          body: "Une seule fête qui porte les deux cultures en avant — deux cuisines, deux musiques, une même salle. Le moment où deux familles deviennent, visiblement, une.",
        },
      ],
    },
    designConcepts: {
      ...
      cards: [
        ...
        },
        {
          ...
          rows: [
            ...
            {
              label: "Idéal pour",
              value: "Catholique + Musulman · chapelle ou villa",
            },
          ],
        },
        {
          ...
          rows: [
            ...
            {
              label: "Idéal pour",
              value: "Toute association · axée réception",
            },
          ],
        },
      ],
    ...
    protocols: {
      ...
      items: [
        {
          title: "Aucune tradition n'est écourtée",
          body: "Nous n'abrégeons jamais une cérémonie pour faire place à l'autre. Si les deux ne tiennent pas en entier, nous ajoutons un jour plutôt que d'amputer un rite. Tout est là : qu'aucune famille ne voie sa tradition traitée en parente pauvre.",
        },
        {
          title: "Les officiants se rencontrent d'abord",
          body: "Les deux officiants se parlent avant que l'un d'eux ne voie le programme. Ce que chaque tradition permet, exige et interdit s'établit entre eux — non supposé par nous, ni découvert le jour même.",
        },
        {
          title: "Les familles sont informées en privé, séparément",
          body: "Chaque famille nous dit, en confidence et à part, où se trouvent son confort et ses limites. Les inquiétudes sont entendues avant de devenir des tensions, et jamais transmises à l'autre côté sans accord.",
        },
        {
          title: "Les objets sacrés ne partagent pas une scène à la légère",
          body: "Une Torah, un feu sacré, une croix, un Coran : ce ne sont pas des accessoires disposés par souci de symétrie. Chacun est manié comme sa tradition l'exige, et jamais combiné pour une photographie.",
        },
        {
          title: "L'ordre des cérémonies est la décision du couple",
          body: "Quelle tradition passe en premier leur revient — et une fois choisi, tenu fermement. Nous ne le remettons pas en cause sous la pression familiale. Aucun ordre n'implique de préséance ; les deux cérémonies sont complètes.",
        },
        {
          title: "Les invités reçoivent un guide des deux traditions",
          body: "Chaque invité reçoit le contexte de la foi qui n'est pas la sienne : ce qu'il verra, ce que cela signifie, quand se lever, ce qui relève de l'invitation et ce qui relève de l'observance. Personne ne passe la moitié du week-end en étranger.",
        },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            ...
            {
              time: "17h00",
              body: "Réception d'accueil · les deux familles · présentations",
            },
            {
              time: "19h00",
              body: "Rite pré-nuptial (mehndi, henné ou répétition) selon l'association",
            },
            {
              time: "21h00",
              body: "Dîner informel · deux cuisines · placement mixte",
            },
          ],
        },
        {
          ...
          events: [
            {
              time: "10h30",
              body: "Première cérémonie · son officiant · sa langue · ses rites",
            },
            {
              time: "12h30",
              body: "Le moment partagé · écrit par le couple · entre les cérémonies",
            },
            {
              time: "13h00",
              body: "Seconde cérémonie · second officiant · tenue en entier",
            },
            { time: "15h00", body: "Déjeuner de fête · les deux cuisines" },
            {
              time: "19h30",
              body: "Réception · deux traditions musicales · placement entrelacé · première danse",
            },
          ],
        },
        {
    ...
    guest: {
      ...
      cells: [
        {
          title: "Protocole alimentaire double",
          body: "Casher et halal coordonnés dans un seul plan de cuisine — préparation séparée, approvisionnement certifié, sans contact croisé — aux côtés de menus végétariens, jaïns, végétaliens et sans allergènes. Un seul cahier des charges qui honore les lois des deux familles.",
        },
        {
          title: "Guides des deux traditions",
          body: "Chaque invité reçoit le contexte de la foi qui n'est pas la sienne : ce qu'il verra, ce que cela signifie, quand se lever, ce qui relève de la participation et ce qui relève du témoignage. Imprimé dans le coffret d'accueil et sur le site du mariage.",
        },
        {
          title: "Placement entre familles",
          body: "Nous entrelaçons les deux familles plutôt que de les asseoir à part. Un plan de table pensé pour qu'aucun côté ne passe la réception entre les siens : la salle elle-même fait le travail de réunir.",
        },
        {
          title: "Aînés & sensibilités",
          body: "Les proches les plus attachés à la tradition sont informés en premier et placés avec soin. Un référent aînés de l'atelier gère le confort, la mobilité et toute inquiétude discrète avant qu'elle n'atteigne le couple.",
        },
        {
          title: "Voyage & hébergement",
          body: "Des blocs de chambres par catégories, des transferts coordonnés sur plusieurs jours d'arrivées, des coffrets d'accueil avec le programme, le code vestimentaire par événement et un guide des deux cérémonies dans chaque chambre.",
        },
        {
          title: "Communications",
          body: "Un groupe WhatsApp trois semaines avant, un site de mariage portant le contexte des deux cérémonies et une équipe de l'atelier disponible tout le week-end pour répondre — dans l'une ou l'autre tradition — à toute question qu'un invité serait trop poli pour poser.",
        },
      ],
    },
    related: {
      ...
      articles: [
        {
          category: "Interconfessionnel · Méthode",
          title:
            "Organiser un mariage interconfessionnel sans amoindrir aucune foi",
          body: "Sur l'art de tenir deux traditions entières — et pourquoi la fusion est le mauvais réflexe.",
          imageKey: "culture-related-1",
        },
        {
          category: "Interconfessionnel · Officiants",
          title: "Trouver deux officiants qui partageront un week-end",
          body: "La première et la plus difficile question — et comment la confession façonne la réponse.",
          imageKey: "culture-related-2",
        },
        {
          category: "Hindou + Juif",
          title: "Les pheras près de la houppa",
          body: "Une note de terrain sur l'association qu'on nous demande le plus.",
          imageKey: "culture-related-3",
        },
        {
          category: "Design · Interconfessionnel",
          title: "Deux dais, une pelouse",
          body: "Concevoir un décor qui tient les deux traditions sans les forcer à fusionner.",
          imageKey: "culture-related-4",
        },
        {
          category: "Coût · Interconfessionnel",
          title: "Le vrai coût d'un mariage interconfessionnel en destination",
          body: "Budgets francs 2026 pour les week-ends à deux cérémonies.",
          imageKey: "culture-related-5",
        },
      ],
      sidebarDestinations: [
    ...
    faq: {
      ...
      items: [
        ...
        {
          question:
            "Et si une famille est mal à l'aise avec l'autre tradition ?",
          answer: [
        ...
        {
          question:
            "Et les invités qui n'ont jamais assisté à l'une ou l'autre tradition ?",
          answer: [
  ...
  pt: {
    ...
    factStrip: [
      ...
      },
      {
        label: "Antecedência",
        value: "18 – 24 meses",
        sub: "Dois celebrantes reservam cedo",
      },
      {
        label: "Combinações comuns",
        value: "Hindu · Judaica",
        sub: "Católica · Muçulmana · mais",
      },
      {
        label: "Celebrantes",
        value: "Dois celebrantes",
        sub: "Por norma, não por exceção",
      },
      {
        label: "Línguas",
        value: "PT + 1",
        sub: "Hebraico · Híndi · Árabe · Latim",
      },
    ],
    overview: {
    ...
    ceremonyArc: {
      ...
      steps: [
        {
          numeral: "I",
          name: "A consulta dos dois celebrantes",
          sub: "Ambos os celebrantes, uma mesa",
          when: "12 – 9 meses antes",
          body: "Reunimos cedo os dois celebrantes para estabelecer o que cada tradição permite, o que cada uma exige e onde estão os limites. Esta conversa decide tudo o que se segue.",
        },
        {
          numeral: "II",
          name: "Mapear os dois rituais",
          sub: "Cada tradição, inteira",
          when: "9 – 6 meses antes",
          body: "Dispomos cada cerimónia por inteiro — nada encurtado para dar lugar à outra — e depois desenhamos os tempos e o espaço para que ambas possam ser honradas por completo.",
        },
        {
          numeral: "III",
          name: "A primeira cerimónia",
          sub: "A ordem escolhida pelo casal",
          when: "Dia da cerimónia",
          body: "A primeira tradição é sustentada por inteiro, conduzida pelo seu próprio celebrante, na sua própria língua, com os seus próprios objetos sagrados. Os convidados recebem um guia para que o desconhecido seja acolhedor, não opaco.",
        },
        {
          numeral: "IV",
          name: "O momento partilhado",
          sub: "Construído pelo casal",
          when: "Entre as cerimónias",
          body: "Um elemento desenhado em conjunto — uma leitura, uma bênção, um cortejo de uma cerimónia para a outra — que o casal cria junto. Não pertence a nenhuma tradição nem exige nada de nenhum celebrante.",
        },
        {
          numeral: "V",
          name: "A segunda cerimónia",
          sub: "A segunda tradição, inteira",
          when: "Dia da cerimónia",
          body: "A segunda tradição é sustentada com a mesma plenitude da primeira, conduzida pelo seu próprio celebrante. Nenhuma cerimónia é o destaque; nenhuma é a abertura.",
        },
        {
          numeral: "VI",
          name: "Uma receção",
          sub: "Duas famílias, uma mesa",
          when: "Noite",
          body: "Uma só celebração que leva ambas as culturas em frente — duas cozinhas, dois tipos de música, uma mesma sala. O ponto em que duas famílias se tornam, visivelmente, uma.",
        },
      ],
    },
    designConcepts: {
      ...
      cards: [
        {
          ...
          rows: [
            ...
            {
              label: "Ideal para",
              value: "Hindu + Judaica · quinta com jardim",
            },
          ],
        },
        {
          ...
          rows: [
            ...
            {
              label: "Ideal para",
              value: "Católica + Muçulmana · capela ou villa",
            },
          ],
        },
        {
          ...
          rows: [
            {
              label: "Estrutura",
              value: "Mesa comprida, lugares entrelaçados",
            },
            { label: "Flores", value: "Ambas as paletas, um caminho" },
            {
              label: "Ideal para",
              value: "Qualquer combinação · centrada na receção",
            },
          ],
        },
      ],
    ...
    protocols: {
      ...
      items: [
        {
          title: "Nenhuma tradição é encurtada",
          body: "Nunca encurtamos uma cerimónia para dar lugar à outra. Se ambas não couberem por inteiro, acrescentamos um dia em vez de cortar um rito. É disto que se trata: que nenhuma família veja a sua tradição tratada como a menor.",
        },
        {
          title: "Os celebrantes conhecem-se primeiro",
          body: "Os dois celebrantes falam antes de qualquer um deles ver o horário. O que cada tradição permite, exige e proíbe estabelece-se entre eles — não suposto por nós, nem descoberto no próprio dia.",
        },
        {
          title: "As famílias são informadas em privado e em separado",
          body: "Cada família diz-nos, em confidência e à parte, onde estão o seu conforto e os seus limites. As preocupações são ouvidas antes de se tornarem tensões, e nunca transmitidas ao outro lado sem consentimento.",
        },
        {
          title: "Os objetos sagrados não partilham um palco de ânimo leve",
          body: "Uma Torá, um fogo sagrado, uma cruz, um Alcorão: não são adereços dispostos por simetria. Cada um é manuseado como a sua tradição exige, e nunca combinado por causa de uma fotografia.",
        },
        {
          title: "A ordem das cerimónias é decisão do casal",
          body: "Qual tradição vem primeiro cabe-lhes a eles — e, uma vez escolhida, mantida com firmeza. Não a revemos sob pressão familiar. Nenhuma ordem implica precedência; ambas as cerimónias são completas.",
        },
        {
          title: "Os convidados recebem um guia de ambas as tradições",
          body: "A cada convidado é dado contexto sobre a fé que não é a sua: o que vai ver, o que significa, quando se levantar, o que é convite e o que é observância. Ninguém passa meio fim de semana como estranho.",
        },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            ...
            {
              time: "17:00",
              body: "Receção de boas-vindas · ambas as famílias · apresentações",
            },
            {
              time: "19:00",
              body: "Rito pré-nupcial (mehndi, hena ou ensaio) conforme a combinação",
            },
            {
              time: "21:00",
              body: "Jantar informal · duas cozinhas · lugares mistos",
            },
          ],
        },
        {
          ...
          events: [
            {
              time: "10:30",
              body: "Primeira cerimónia · o seu celebrante · a sua língua · os seus ritos",
            },
            {
              time: "12:30",
              body: "O momento partilhado · criado pelo casal · entre as cerimónias",
            },
            {
              time: "13:00",
              body: "Segunda cerimónia · segundo celebrante · sustentada por inteiro",
            },
            { time: "15:00", body: "Almoço de celebração · ambas as cozinhas" },
            {
              time: "19:30",
              body: "Receção · duas tradições musicais · lugares entrelaçados · primeira dança",
            },
          ],
        },
        {
    ...
    guest: {
      ...
      cells: [
        {
          title: "Protocolo dietético duplo",
          body: "Kosher e halal coordenados dentro de um único plano de cozinha — preparação separada, fornecimento certificado, sem contacto cruzado — a par de menus vegetariano, jainista, vegano e sem alergénios. Um só caderno de catering que honra as leis de ambas as famílias.",
        },
        {
          title: "Guias de ambas as tradições",
          body: "Cada convidado recebe contexto sobre a fé que não é a sua: o que vai ver, o que significa, quando se levantar, o que é participação e o que é presença. Impresso no kit de boas-vindas e no site do casamento.",
        },
        {
          title: "Lugares entre famílias",
          body: "Entrelaçamos as duas famílias em vez de as sentar à parte. Disposição pensada para que nenhum lado passe a receção só entre os seus: a própria sala faz o trabalho de unir.",
        },
        {
          title: "Mais velhos e sensibilidades",
          body: "Os familiares mais ligados à tradição são informados primeiro e sentados com cuidado. Um elo de ligação para os mais velhos, do ateliê, gere conforto, mobilidade e qualquer preocupação discreta antes de chegar ao casal.",
        },
        {
          title: "Viagem e alojamento",
          body: "Blocos de quartos por categorias, transferes coordenados ao longo de vários dias de chegadas, kits de boas-vindas com o horário, o código de vestuário por evento e um guia de ambas as cerimónias em cada quarto.",
        },
        {
          title: "Comunicações",
          body: "Um grupo de WhatsApp três semanas antes, um site de casamento com o contexto de ambas as cerimónias e uma equipa do ateliê disponível todo o fim de semana para responder — em qualquer das duas tradições — a qualquer pergunta que um convidado seja demasiado cortês para fazer.",
        },
      ],
    },
    related: {
      ...
      articles: [
        {
          category: "Inter-religioso · Método",
          title:
            "Como planear um casamento inter-religioso sem diminuir nenhuma fé",
          body: "Sobre sustentar duas tradições inteiras — e por que a fusão é o instinto errado.",
          imageKey: "culture-related-1",
        },
        {
          category: "Inter-religioso · Celebrantes",
          title: "Encontrar dois celebrantes que partilhem um fim de semana",
          body: "A primeira e mais difícil pergunta — e como a confissão molda a resposta.",
          imageKey: "culture-related-2",
        },
        {
          category: "Hindu + Judaica",
          title: "Os pheras junto à chupá",
          body: "Uma nota de campo sobre a combinação que mais nos pedem.",
          imageKey: "culture-related-3",
        },
        {
          category: "Design · Inter-religioso",
          title: "Dois dosséis, um relvado",
          body: "Desenhar um cenário que sustente ambas as tradições sem forçar a sua fusão.",
          imageKey: "culture-related-4",
        },
        {
          category: "Custo · Inter-religioso",
          title:
            "Quanto custa realmente um casamento inter-religioso em destino",
          body: "Orçamentos francos de 2026 para fins de semana de duas cerimónias.",
          imageKey: "culture-related-5",
        },
      ],
      sidebarDestinations: [
    ...
    faq: {
      ...
      items: [
        ...
        {
          question:
            "E se uma família estiver desconfortável com a outra tradição?",
          answer: [
        ...
        {
          question:
            "E os convidados que nunca assistiram a nenhuma das tradições?",
          answer: [
  ...
  de: {
    ...
    factStrip: [
      {
        ...
        value: "2 – 3 Tage",
        sub: "Zwei Zeremonien, ein Bogen",
      },
      { label: "Gästezahl", value: "120 – 400", sub: "Mehr auf Anfrage" },
      {
        label: "Vorlaufzeit",
        value: "18 – 24 Monate",
        sub: "Zwei Geistliche buchen früh",
      },
      {
        label: "Häufige Paarungen",
        value: "Hinduistisch · Jüdisch",
        sub: "Katholisch · Muslimisch · mehr",
      },
      {
        label: "Geistliche",
        value: "Zwei Geistliche",
        sub: "Als Regel, nicht als Ausnahme",
      },
      {
        label: "Sprachen",
        value: "DE + 1",
        sub: "Hebräisch · Hindi · Arabisch · Latein",
      },
    ],
    overview: {
    ...
    ceremonyArc: {
      ...
      steps: [
        {
          numeral: "I",
          name: "Die Beratung der zwei Geistlichen",
          sub: "Beide Geistliche, ein Tisch",
          when: "12 – 9 Monate vorher",
          body: "Wir bringen beide Geistliche früh zusammen, um festzulegen, was jede Tradition erlaubt, was jede erfordert und wo die Grenzen liegen. Dieses Gespräch entscheidet über alles Weitere.",
        },
        {
          numeral: "II",
          name: "Die zwei Rituale kartieren",
          sub: "Jede Tradition, ganz",
          when: "9 – 6 Monate vorher",
          body: "Wir legen jede Zeremonie vollständig aus — nichts gekürzt, um der anderen Platz zu machen — und gestalten dann Timing und Raum so, dass beide vollständig geehrt werden können.",
        },
        {
          numeral: "III",
          name: "Die erste Zeremonie",
          sub: "Die vom Paar gewählte Reihenfolge",
          when: "Zeremonientag",
          body: "Die erste Tradition wird vollständig gehalten, geführt von ihrem eigenen Geistlichen, in ihrer eigenen Sprache, mit ihren eigenen heiligen Gegenständen. Die Gäste erhalten einen Leitfaden, damit das Unbekannte einladend statt undurchsichtig wirkt.",
        },
        {
          numeral: "IV",
          name: "Der gemeinsame Moment",
          sub: "Vom Paar gebaut",
          when: "Zwischen den Zeremonien",
          body: "Ein gemeinsam gestaltetes Element — eine Lesung, ein Segen, eine Prozession von einer Zeremonie zur nächsten — das das Paar zusammen verfasst. Es gehört zu keiner Tradition und verlangt nichts von einem der Geistlichen.",
        },
        {
          numeral: "V",
          name: "Die zweite Zeremonie",
          sub: "Die zweite Tradition, ganz",
          when: "Zeremonientag",
          body: "Die zweite Tradition wird mit derselben Vollständigkeit wie die erste gehalten, geführt von ihrem eigenen Geistlichen. Keine Zeremonie ist der Höhepunkt; keine ist das Vorprogramm.",
        },
        {
          numeral: "VI",
          name: "Ein Empfang",
          sub: "Zwei Familien, ein Tisch",
          when: "Abend",
          body: "Eine einzige Feier, die beide Kulturen weiterträgt — zwei Küchen, zwei Arten von Musik, ein Raum. Der Punkt, an dem zwei Familien sichtbar zu einer werden.",
        },
      ],
    },
    designConcepts: {
      ...
      cards: [
        {
          ...
          rows: [
            ...
            {
              label: "Am besten für",
              value: "Hinduistisch + Jüdisch · Gartengut",
            },
          ],
        },
        {
          ...
          rows: [
            ...
            {
              label: "Am besten für",
              value: "Katholisch + Muslimisch · Kapelle oder Villa",
            },
          ],
        },
        {
    ...
    protocols: {
      ...
      items: [
        {
          title: "Keine Tradition wird gekürzt",
          body: "Wir kürzen nie eine Zeremonie, um der anderen Platz zu machen. Passen beide nicht ganz, fügen wir lieber einen Tag hinzu, als einen Ritus zu beschneiden. Genau darum geht es: dass keine Familie ihre Tradition als die geringere behandelt sieht.",
        },
        {
          title: "Die Geistlichen treffen sich zuerst",
          body: "Die beiden Geistlichen sprechen miteinander, bevor einer von ihnen den Zeitplan sieht. Was jede Tradition erlaubt, erfordert und verbietet, wird zwischen ihnen festgelegt — nicht von uns angenommen und nicht am Tag selbst entdeckt.",
        },
        {
          title: "Die Familien werden privat und getrennt unterrichtet",
          body: "Jede Familie sagt uns vertraulich und für sich, wo ihre Wohlfühlgrenze und ihre roten Linien liegen. Bedenken werden gehört, bevor sie zu Spannungen werden, und nie ohne Einverständnis über den Gang getragen.",
        },
        {
          title: "Heilige Gegenstände teilen nicht leichtfertig eine Bühne",
          body: "Eine Tora, ein heiliges Feuer, ein Kreuz, ein Koran: das sind keine Requisiten, die der Symmetrie wegen arrangiert werden. Jeder wird gehandhabt, wie seine Tradition es verlangt, und nie für ein Foto kombiniert.",
        },
        {
          title: "Die Reihenfolge der Zeremonien entscheidet das Paar",
          body: "Welche Tradition zuerst kommt, liegt bei ihm — und ist einmal gewählt, fest gehalten. Wir rollen sie unter Familiendruck nicht wieder auf. Keine Reihenfolge bedeutet Vorrang; beide Zeremonien sind vollständig.",
        },
        {
          title: "Die Gäste erhalten einen Leitfaden zu beiden Traditionen",
          body: "Jeder Gast erhält Kontext zu dem Glauben, der nicht der seine ist: was er sehen wird, was es bedeutet, wann man steht, was Einladung und was Andacht ist. Niemand erlebt das halbe Wochenende als Außenstehender.",
        },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            ...
            {
              time: "17:00",
              body: "Willkommensempfang · beide Familien · Vorstellungen",
            },
            {
              time: "19:00",
              body: "Vorritus (Mehndi, Henna oder Probe) je nach Paarung",
            },
            {
              time: "21:00",
              body: "Lockeres Abendessen · zwei Küchen · gemischte Sitzordnung",
            },
          ],
        },
        {
          ...
          events: [
            {
              time: "10:30",
              body: "Erste Zeremonie · eigener Geistlicher · eigene Sprache · eigene Riten",
            },
            {
              time: "12:30",
              body: "Der gemeinsame Moment · vom Paar verfasst · zwischen den Zeremonien",
            },
            {
              time: "13:00",
              body: "Zweite Zeremonie · zweiter Geistlicher · ganz gehalten",
            },
            { time: "15:00", body: "Festessen · beide Küchen" },
            {
              time: "19:30",
              body: "Empfang · zwei Musiktraditionen · verflochtene Sitzordnung · erster Tanz",
            },
          ],
        },
        {
          ...
          events: [
            ...
            {
              time: "Abend",
              body: "Abendessen im engen Familienkreis (optional)",
            },
          ],
        },
      ],
    ...
    guest: {
      ...
      cells: [
        {
          title: "Doppeltes Speiseprotokoll",
          body: "Koscher und halal innerhalb eines einzigen Küchenplans koordiniert — getrennte Zubereitung, zertifizierte Beschaffung, kein Kreuzkontakt — neben vegetarischen, jainistischen, veganen und allergenfreien Menüs. Ein Catering-Briefing, das die Gebote beider Familien ehrt.",
        },
        {
          title: "Leitfäden zu beiden Traditionen",
          body: "Jeder Gast erhält Kontext zu dem Glauben, der nicht der seine ist: was er sehen wird, was es bedeutet, wann man steht, was Teilnahme und was Zeugenschaft ist. Gedruckt im Willkommenspaket und auf der Hochzeitsseite.",
        },
        {
          title: "Sitzordnung über Familien hinweg",
          body: "Wir verflechten die beiden Familien, statt sie getrennt zu setzen. Eine Tischordnung, die so gestaltet ist, dass keine Seite den Empfang nur unter den Ihren verbringt — der Raum selbst leistet die Arbeit des Zusammenführens.",
        },
        {
          title: "Ältere & Empfindlichkeiten",
          body: "Die der Tradition am stärksten verbundenen Verwandten werden zuerst unterrichtet und mit Bedacht platziert. Ein Ältesten-Ansprechpartner des Ateliers regelt Komfort, Mobilität und jede leise Sorge, bevor sie das Paar erreicht.",
        },
        {
          title: "Anreise & Unterkunft",
          body: "Zimmerkontingente in mehreren Kategorien, über mehrere Anreisetage koordinierte Transfers, Willkommenspakete mit Zeitplan, Kleiderordnung je Veranstaltung und einem Leitfaden zu beiden Zeremonien in jedem Zimmer.",
        },
        {
          title: "Kommunikation",
          body: "Eine WhatsApp-Gruppe drei Wochen vorher, eine Hochzeitsseite mit dem Kontext beider Zeremonien und ein Atelier-Team, das das ganze Wochenende über bereitsteht, um — in beiden Traditionen — jede Frage zu beantworten, für die ein Gast zu höflich ist.",
        },
      ],
    },
    related: {
      ...
      articles: [
        {
          category: "Interreligiös · Methode",
          title:
            "Eine interreligiöse Hochzeit planen, ohne einen Glauben zu schmälern",
          body: "Über das Ganzhalten zweier Traditionen — und warum Verschmelzung der falsche Instinkt ist.",
          imageKey: "culture-related-1",
        },
        {
          category: "Interreligiös · Geistliche",
          title: "Zwei Geistliche finden, die ein Wochenende teilen",
          body: "Die erste und schwierigste Frage — und wie die Konfession die Antwort prägt.",
          imageKey: "culture-related-2",
        },
        {
          category: "Hinduistisch + Jüdisch",
          title: "Die Pheras neben der Chuppa",
          body: "Eine Feldnotiz zu der Paarung, nach der wir am häufigsten gefragt werden.",
          imageKey: "culture-related-3",
        },
        {
          category: "Design · Interreligiös",
          title: "Zwei Baldachine, ein Rasen",
          body: "Eine Kulisse gestalten, die beide Traditionen hält, ohne sie zur Verschmelzung zu zwingen.",
          imageKey: "culture-related-4",
        },
        {
          category: "Kosten · Interreligiös",
          title: "Was eine interreligiöse Destinationshochzeit wirklich kostet",
          body: "Offene Budgets 2026 für Wochenenden mit zwei Zeremonien.",
          imageKey: "culture-related-5",
        },
      ],
      sidebarDestinations: [
    ...
    faq: {
      ...
      items: [
        {
          question:
            "Wie finden Sie Geistliche, die bereit sind, gemeinsam zu amtieren?",
          answer: [
        ...
        {
          question:
            "Was, wenn eine Familie mit der anderen Tradition fremdelt?",
          answer: [
        ...
        {
          question:
            "Was ist mit Gästen, die noch nie bei einer der beiden Traditionen waren?",
          answer: [
  ...
  it: {
    ...
    factStrip: [
      ...
      },
      {
        label: "Preavviso",
        value: "18 – 24 mesi",
        sub: "Due celebranti prenotano presto",
      },
      {
        label: "Abbinamenti comuni",
        value: "Indù · Ebraico",
        sub: "Cattolico · Musulmano · altri",
      },
      {
        label: "Celebranti",
        value: "Due celebranti",
        sub: "Per regola, non per eccezione",
      },
      {
        label: "Lingue",
        value: "IT + 1",
        sub: "Ebraico · Hindi · Arabo · Latino",
      },
    ],
    overview: {
    ...
    ceremonyArc: {
      ...
      steps: [
        {
          numeral: "I",
          name: "La consulenza dei due celebranti",
          sub: "Entrambi i celebranti, un tavolo",
          when: "12 – 9 mesi prima",
          body: "Riuniamo presto i due celebranti per stabilire cosa permette ciascuna tradizione, cosa esige ognuna e dove sono i confini. Questa conversazione decide tutto ciò che segue.",
        },
        {
          numeral: "II",
          name: "Mappare i due rituali",
          sub: "Ogni tradizione, intera",
          when: "9 – 6 mesi prima",
          body: "Stendiamo ogni cerimonia per intero — nulla accorciato per far posto all'altra — poi disegniamo i tempi e lo spazio perché entrambe possano essere onorate completamente.",
        },
        {
          numeral: "III",
          name: "La prima cerimonia",
          sub: "L'ordine scelto dalla coppia",
          when: "Giorno della cerimonia",
          body: "La prima tradizione si tiene per intero, guidata dal proprio celebrante, nella propria lingua, con i propri oggetti sacri. Gli ospiti ricevono una guida perché l'ignoto risulti accogliente, non opaco.",
        },
        {
          numeral: "IV",
          name: "Il momento condiviso",
          sub: "Costruito dalla coppia",
          when: "Tra le cerimonie",
          body: "Un elemento disegnato insieme — una lettura, una benedizione, una processione da una cerimonia all'altra — che la coppia crea insieme. Non appartiene a nessuna tradizione e non chiede nulla a nessuno dei celebranti.",
        },
        {
          numeral: "V",
          name: "La seconda cerimonia",
          sub: "La seconda tradizione, intera",
          when: "Giorno della cerimonia",
          body: "La seconda tradizione si tiene con la stessa pienezza della prima, guidata dal proprio celebrante. Nessuna cerimonia è il piatto forte; nessuna è l'apertura.",
        },
        {
          numeral: "VI",
          name: "Un ricevimento",
          sub: "Due famiglie, un tavolo",
          when: "Sera",
          body: "Un'unica festa che porta avanti entrambe le culture — due cucine, due tipi di musica, una sola sala. Il punto in cui due famiglie diventano, visibilmente, una.",
        },
      ],
    },
    designConcepts: {
      ...
      cards: [
        {
          ...
          rows: [
            ...
            {
              label: "Ideale per",
              value: "Indù + Ebraico · tenuta con giardino",
            },
          ],
        },
        {
          ...
          rows: [
            ...
            {
              label: "Ideale per",
              value: "Cattolico + Musulmano · cappella o villa",
            },
          ],
        },
        {
          ...
          rows: [
            ...
            {
              label: "Ideale per",
              value: "Qualsiasi abbinamento · centrato sul ricevimento",
            },
          ],
        },
      ],
    ...
    protocols: {
      ...
      items: [
        {
          title: "Nessuna tradizione viene accorciata",
          body: "Non accorciamo mai una cerimonia per far posto all'altra. Se entrambe non entrano intere, aggiungiamo un giorno anziché tagliare un rito. È tutto qui: che nessuna famiglia veda la propria tradizione trattata come la minore.",
        },
        {
          title: "I celebranti si incontrano per primi",
          body: "I due celebranti si parlano prima che uno di loro veda il programma. Ciò che ciascuna tradizione permette, esige e vieta si stabilisce tra loro — non lo supponiamo noi, né lo si scopre il giorno stesso.",
        },
        {
          title: "Le famiglie sono informate in privato e separatamente",
          body: "Ogni famiglia ci dice, in confidenza e a parte, dove sono il proprio agio e i propri limiti. Le preoccupazioni vengono ascoltate prima di diventare tensioni, e mai riferite all'altra parte senza consenso.",
        },
        {
          title: "Gli oggetti sacri non condividono un palco con leggerezza",
          body: "Una Torah, un fuoco sacro, una croce, un Corano: non sono oggetti di scena disposti per simmetria. Ciascuno è maneggiato come la sua tradizione esige, e mai combinato per una fotografia.",
        },
        {
          title: "L'ordine delle cerimonie è decisione della coppia",
          body: "Quale tradizione venga per prima spetta a loro — e, una volta scelto, mantenuto con fermezza. Non lo rimettiamo in discussione sotto pressione familiare. Nessun ordine implica precedenza; entrambe le cerimonie sono complete.",
        },
        {
          title: "Gli ospiti ricevono una guida a entrambe le tradizioni",
          body: "A ogni ospite viene dato il contesto della fede che non è la sua: cosa vedrà, cosa significa, quando alzarsi, cosa è invito e cosa è osservanza. Nessuno vive mezzo fine settimana da estraneo.",
        },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            {
              time: "Pomeriggio",
              body: "Arrivo degli ospiti · transfer · check-in in hotel",
            },
            {
              time: "17:00",
              body: "Ricevimento di benvenuto · entrambe le famiglie · presentazioni",
            },
            {
              time: "19:00",
              body: "Rito pre-nuziale (mehndi, henné o prova) secondo l'abbinamento",
            },
            {
              time: "21:00",
              body: "Cena informale · due cucine · posti misti",
            },
          ],
        },
        {
          ...
          events: [
            {
              time: "10:30",
              body: "Prima cerimonia · proprio celebrante · propria lingua · propri riti",
            },
            {
              time: "12:30",
              body: "Il momento condiviso · creato dalla coppia · tra le cerimonie",
            },
            {
              time: "13:00",
              body: "Seconda cerimonia · secondo celebrante · tenuta per intero",
            },
            { time: "15:00", body: "Pranzo di festa · entrambe le cucine" },
            {
              time: "19:30",
              body: "Ricevimento · due tradizioni musicali · posti intrecciati · primo ballo",
            },
          ],
        },
        {
    ...
    guest: {
      ...
      cells: [
        {
          title: "Protocollo dietetico doppio",
          body: "Kosher e halal coordinati all'interno di un unico piano di cucina — preparazione separata, approvvigionamento certificato, nessun contatto incrociato — accanto a menu vegetariano, jainista, vegano e privo di allergeni. Un solo brief di catering che onora le leggi di entrambe le famiglie.",
        },
        {
          title: "Guide a entrambe le tradizioni",
          body: "Ogni ospite riceve il contesto della fede che non è la sua: cosa vedrà, cosa significa, quando alzarsi, cosa è partecipazione e cosa è testimonianza. Stampato nel kit di benvenuto e sul sito del matrimonio.",
        },
        {
          title: "Posti tra le famiglie",
          body: "Intrecciamo le due famiglie anziché farle sedere a parte. Una disposizione pensata perché nessuna parte trascorra il ricevimento solo tra i propri: la sala stessa fa il lavoro di unire.",
        },
        {
          title: "Anziani e sensibilità",
          body: "I parenti più legati alla tradizione vengono informati per primi e seduti con cura. Un referente per gli anziani dell'atelier gestisce comfort, mobilità e ogni preoccupazione discreta prima che raggiunga la coppia.",
        },
        {
          title: "Viaggio e alloggio",
          body: "Blocchi di camere su più categorie, transfer coordinati su più giorni di arrivi, kit di benvenuto con il programma, il codice di abbigliamento per evento e una guida a entrambe le cerimonie in ogni camera.",
        },
        {
          title: "Comunicazioni",
          body: "Un gruppo WhatsApp tre settimane prima, un sito del matrimonio che riporta il contesto di entrambe le cerimonie e un team dell'atelier a disposizione per tutto il fine settimana per rispondere — in una o nell'altra tradizione — a qualsiasi domanda che un ospite sia troppo educato per fare.",
        },
      ],
    },
    related: {
      ...
      articles: [
        {
          category: "Interreligioso · Metodo",
          title:
            "Come pianificare un matrimonio interreligioso senza diminuire nessuna fede",
          body: "Sul tenere intere due tradizioni — e perché la fusione è l'istinto sbagliato.",
          imageKey: "culture-related-1",
        },
        {
          category: "Interreligioso · Celebranti",
          title: "Trovare due celebranti che condividano un fine settimana",
          body: "La prima e più difficile domanda — e come la confessione plasma la risposta.",
          imageKey: "culture-related-2",
        },
        {
          category: "Indù + Ebraico",
          title: "I pheras accanto alla chuppah",
          body: "Una nota sul campo sull'abbinamento che ci viene richiesto di più.",
          imageKey: "culture-related-3",
        },
        {
          category: "Design · Interreligioso",
          title: "Due baldacchini, un prato",
          body: "Disegnare una scenografia che tenga entrambe le tradizioni senza forzarle a fondersi.",
          imageKey: "culture-related-4",
        },
        {
          category: "Costo · Interreligioso",
          title:
            "Quanto costa davvero un matrimonio interreligioso di destinazione",
          body: "Budget franchi 2026 per fine settimana a due cerimonie.",
          imageKey: "culture-related-5",
        },
      ],
      sidebarDestinations: [
    ...
    faq: {
      ...
      items: [
        ...
        {
          question:
            "E gli ospiti che non hanno mai assistito a nessuna delle due tradizioni?",
          answer: [
