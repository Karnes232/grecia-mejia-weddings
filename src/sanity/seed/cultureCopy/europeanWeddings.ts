...
export const europeanWeddings: Record<Locale, CultureCopy> = {
  ...
  en: {
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Lake Como", sub: "Italy · May – September", imageKey: "compat-2", destinationHref: destinationPath("en", "lake-como") },
        { rating: 5, name: "Tuscany", sub: "Italy · May – October", imageKey: "compat-3", destinationHref: destinationPath("en", "tuscany") },
        { rating: 5, name: "Paris & Île-de-France", sub: "France · May – September", imageKey: "compat-4", destinationHref: destinationPath("en", "paris-ile-de-france") },
        { rating: 5, name: "Provence", sub: "France · May – October", imageKey: "compat-5", destinationHref: destinationPath("en", "provence") },
        { rating: 5, name: "Côte d'Azur", sub: "France · June – September", imageKey: "compat-6", destinationHref: destinationPath("en", "cote-dazur") },
        { rating: 3, name: "Punta Cana", sub: "Caribbean · year-round", imageKey: "compat-7", destinationHref: destinationPath("en", "punta-cana") },
        { rating: 3, name: "The Hamptons", sub: "United States · June – September", imageKey: "compat-8", destinationHref: destinationPath("en", "the-hamptons") },
      ],
    },
    guest: {
  ...
  es: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "Costa de Amalfi", sub: "Italia · mayo – octubre", imageKey: "compat-1", destinationHref: destinationPath("es", "amalfi") },
        { rating: 5, name: "Lago de Como", sub: "Italia · mayo – septiembre", imageKey: "compat-2", destinationHref: destinationPath("es", "lake-como") },
        { rating: 5, name: "Toscana", sub: "Italia · mayo – octubre", imageKey: "compat-3", destinationHref: destinationPath("es", "tuscany") },
        { rating: 5, name: "París e Isla de Francia", sub: "Francia · mayo – septiembre", imageKey: "compat-4", destinationHref: destinationPath("es", "paris-ile-de-france") },
        { rating: 5, name: "Provenza", sub: "Francia · mayo – octubre", imageKey: "compat-5", destinationHref: destinationPath("es", "provence") },
        { rating: 5, name: "Costa Azul", sub: "Francia · junio – septiembre", imageKey: "compat-6", destinationHref: destinationPath("es", "cote-dazur") },
        { rating: 3, name: "Punta Cana", sub: "Caribe · todo el año", imageKey: "compat-7", destinationHref: destinationPath("es", "punta-cana") },
        { rating: 3, name: "Los Hamptons", sub: "Estados Unidos · junio – septiembre", imageKey: "compat-8", destinationHref: destinationPath("es", "the-hamptons") },
      ],
    },
    guest: {
  ...
  fr: {
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Lac de Côme", sub: "Italie · mai – septembre", imageKey: "compat-2", destinationHref: destinationPath("fr", "lake-como") },
        { rating: 5, name: "Toscane", sub: "Italie · mai – octobre", imageKey: "compat-3", destinationHref: destinationPath("fr", "tuscany") },
        { rating: 5, name: "Paris & Île-de-France", sub: "France · mai – septembre", imageKey: "compat-4", destinationHref: destinationPath("fr", "paris-ile-de-france") },
        { rating: 5, name: "Provence", sub: "France · mai – octobre", imageKey: "compat-5", destinationHref: destinationPath("fr", "provence") },
        { rating: 5, name: "Côte d'Azur", sub: "France · juin – septembre", imageKey: "compat-6", destinationHref: destinationPath("fr", "cote-dazur") },
        { rating: 3, name: "Punta Cana", sub: "Caraïbes · toute l'année", imageKey: "compat-7", destinationHref: destinationPath("fr", "punta-cana") },
        { rating: 3, name: "Les Hamptons", sub: "États-Unis · juin – septembre", imageKey: "compat-8", destinationHref: destinationPath("fr", "the-hamptons") },
      ],
    },
    guest: {
  ...
  pt: {
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Lago de Como", sub: "Itália · maio – setembro", imageKey: "compat-2", destinationHref: destinationPath("pt", "lake-como") },
        { rating: 5, name: "Toscana", sub: "Itália · maio – outubro", imageKey: "compat-3", destinationHref: destinationPath("pt", "tuscany") },
        { rating: 5, name: "Paris & Île-de-France", sub: "França · maio – setembro", imageKey: "compat-4", destinationHref: destinationPath("pt", "paris-ile-de-france") },
        { rating: 5, name: "Provença", sub: "França · maio – outubro", imageKey: "compat-5", destinationHref: destinationPath("pt", "provence") },
        { rating: 5, name: "Costa Azul", sub: "França · junho – setembro", imageKey: "compat-6", destinationHref: destinationPath("pt", "cote-dazur") },
        { rating: 3, name: "Punta Cana", sub: "Caraíbas · todo o ano", imageKey: "compat-7", destinationHref: destinationPath("pt", "punta-cana") },
        { rating: 3, name: "Os Hamptons", sub: "Estados Unidos · junho – setembro", imageKey: "compat-8", destinationHref: destinationPath("pt", "the-hamptons") },
      ],
    },
    guest: {
  ...
  de: {
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Comer See", sub: "Italien · Mai – September", imageKey: "compat-2", destinationHref: destinationPath("de", "lake-como") },
        { rating: 5, name: "Toskana", sub: "Italien · Mai – Oktober", imageKey: "compat-3", destinationHref: destinationPath("de", "tuscany") },
        { rating: 5, name: "Paris & Île-de-France", sub: "Frankreich · Mai – September", imageKey: "compat-4", destinationHref: destinationPath("de", "paris-ile-de-france") },
        { rating: 5, name: "Provence", sub: "Frankreich · Mai – Oktober", imageKey: "compat-5", destinationHref: destinationPath("de", "provence") },
        { rating: 5, name: "Côte d'Azur", sub: "Frankreich · Juni – September", imageKey: "compat-6", destinationHref: destinationPath("de", "cote-dazur") },
        { rating: 3, name: "Punta Cana", sub: "Karibik · ganzjährig", imageKey: "compat-7", destinationHref: destinationPath("de", "punta-cana") },
        { rating: 3, name: "Die Hamptons", sub: "Vereinigte Staaten · Juni – September", imageKey: "compat-8", destinationHref: destinationPath("de", "the-hamptons") },
      ],
    },
    guest: {
  ...
  it: {
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Lago di Como", sub: "Italia · maggio – settembre", imageKey: "compat-2", destinationHref: destinationPath("it", "lake-como") },
        { rating: 5, name: "Toscana", sub: "Italia · maggio – ottobre", imageKey: "compat-3", destinationHref: destinationPath("it", "tuscany") },
        { rating: 5, name: "Parigi & Île-de-France", sub: "Francia · maggio – settembre", imageKey: "compat-4", destinationHref: destinationPath("it", "paris-ile-de-france") },
        { rating: 5, name: "Provenza", sub: "Francia · maggio – ottobre", imageKey: "compat-5", destinationHref: destinationPath("it", "provence") },
        { rating: 5, name: "Costa Azzurra", sub: "Francia · giugno – settembre", imageKey: "compat-6", destinationHref: destinationPath("it", "cote-dazur") },
        { rating: 3, name: "Punta Cana", sub: "Caraibi · tutto l'anno", imageKey: "compat-7", destinationHref: destinationPath("it", "punta-cana") },
        { rating: 3, name: "Gli Hamptons", sub: "Stati Uniti · giugno – settembre", imageKey: "compat-8", destinationHref: destinationPath("it", "the-hamptons") },
      ],
    },
    guest: {
