...
export const interfaithWeddings: Record<Locale, CultureCopy> = {
  en: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "Lake Como", sub: "Italy · May – October", destinationSlug: "lake-como" },
        { rating: 5, name: "Tuscany", sub: "Italy · May – October", destinationSlug: "tuscany" },
        { rating: 5, name: "Provence", sub: "France · June – September", destinationSlug: "provence" },
        { rating: 4, name: "Amalfi Coast", sub: "Italy · May – October", destinationSlug: "amalfi" },
        { rating: 4, name: "Paris & Île-de-France", sub: "France · April – October", destinationSlug: "paris-ile-de-france" },
        ...
        { rating: 3, name: "Mustique", sub: "Caribbean · November – April", destinationSlug: "mustique" },
      ],
    },
    guest: {
  ...
  es: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "Lago de Como", sub: "Italia · mayo – octubre", destinationSlug: "lake-como" },
        { rating: 5, name: "Toscana", sub: "Italia · mayo – octubre", destinationSlug: "tuscany" },
        { rating: 5, name: "Provenza", sub: "Francia · junio – septiembre", destinationSlug: "provence" },
        { rating: 4, name: "Costa de Amalfi", sub: "Italia · mayo – octubre", destinationSlug: "amalfi" },
        { rating: 4, name: "París e Isla de Francia", sub: "Francia · abril – octubre", destinationSlug: "paris-ile-de-france" },
        ...
        { rating: 3, name: "Mustique", sub: "Caribe · noviembre – abril", destinationSlug: "mustique" },
      ],
    },
    guest: {
  ...
  fr: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "Lac de Côme", sub: "Italie · mai – octobre", destinationSlug: "lake-como" },
        { rating: 5, name: "Toscane", sub: "Italie · mai – octobre", destinationSlug: "tuscany" },
        { rating: 5, name: "Provence", sub: "France · juin – septembre", destinationSlug: "provence" },
        { rating: 4, name: "Côte amalfitaine", sub: "Italie · mai – octobre", destinationSlug: "amalfi" },
        { rating: 4, name: "Paris & Île-de-France", sub: "France · avril – octobre", destinationSlug: "paris-ile-de-france" },
        ...
        { rating: 3, name: "Mustique", sub: "Caraïbes · novembre – avril", destinationSlug: "mustique" },
      ],
    },
    guest: {
  ...
  pt: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "Lago de Como", sub: "Itália · maio – outubro", destinationSlug: "lake-como" },
        { rating: 5, name: "Toscana", sub: "Itália · maio – outubro", destinationSlug: "tuscany" },
        { rating: 5, name: "Provença", sub: "França · junho – setembro", destinationSlug: "provence" },
        { rating: 4, name: "Costa Amalfitana", sub: "Itália · maio – outubro", destinationSlug: "amalfi" },
        { rating: 4, name: "Paris e Île-de-France", sub: "França · abril – outubro", destinationSlug: "paris-ile-de-france" },
        ...
        { rating: 3, name: "Mustique", sub: "Caraíbas · novembro – abril", destinationSlug: "mustique" },
      ],
    },
    guest: {
  ...
  de: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "Comer See", sub: "Italien · Mai – Oktober", destinationSlug: "lake-como" },
        { rating: 5, name: "Toskana", sub: "Italien · Mai – Oktober", destinationSlug: "tuscany" },
        { rating: 5, name: "Provence", sub: "Frankreich · Juni – September", destinationSlug: "provence" },
        { rating: 4, name: "Amalfiküste", sub: "Italien · Mai – Oktober", destinationSlug: "amalfi" },
        { rating: 4, name: "Paris & Île-de-France", sub: "Frankreich · April – Oktober", destinationSlug: "paris-ile-de-france" },
        { rating: 4, name: "Punta Cana", sub: "Karibik · ganzjährig", destinationSlug: "punta-cana" },
        { rating: 4, name: "Die Hamptons", sub: "USA · Juni – September", destinationSlug: "the-hamptons" },
        { rating: 3, name: "Mustique", sub: "Karibik · November – April", destinationSlug: "mustique" },
      ],
    },
    guest: {
  ...
  it: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "Lago di Como", sub: "Italia · maggio – ottobre", destinationSlug: "lake-como" },
        { rating: 5, name: "Toscana", sub: "Italia · maggio – ottobre", destinationSlug: "tuscany" },
        { rating: 5, name: "Provenza", sub: "Francia · giugno – settembre", destinationSlug: "provence" },
        { rating: 4, name: "Costiera Amalfitana", sub: "Italia · maggio – ottobre", destinationSlug: "amalfi" },
        { rating: 4, name: "Parigi e Île-de-France", sub: "Francia · aprile – ottobre", destinationSlug: "paris-ile-de-france" },
        ...
        { rating: 3, name: "Mustique", sub: "Caraibi · novembre – aprile", destinationSlug: "mustique" },
      ],
    },
    guest: {
