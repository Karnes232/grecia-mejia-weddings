  ...
  en: {
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Côte d'Azur", sub: "France · June – September", imageKey: "compat-2", destinationHref: destinationPath("en", "cote-dazur") },
        { rating: 5, name: "Amalfi Coast", sub: "Italy · May – October", imageKey: "compat-3", destinationHref: destinationPath("en", "amalfi") },
        { rating: 4, name: "Lake Como", sub: "Italy · June – September", imageKey: "compat-4", destinationHref: destinationPath("en", "lake-como") },
        { rating: 4, name: "St. Barths", sub: "Caribbean · November – April", imageKey: "compat-5", destinationHref: destinationPath("en", "st-barths") },
        { rating: 4, name: "Tuscany", sub: "Italy · May – October", imageKey: "compat-6", destinationHref: destinationPath("en", "tuscany") },
        { rating: 4, name: "Paris & Île-de-France", sub: "France · year-round indoor", imageKey: "compat-7", destinationHref: destinationPath("en", "paris-ile-de-france") },
        { rating: 3, name: "Provence", sub: "France · May – September", imageKey: "compat-8", destinationHref: destinationPath("en", "provence") },
      ],
    },
    guest: {
  ...
  es: {
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Costa Azul", sub: "Francia · junio – septiembre", imageKey: "compat-2", destinationHref: destinationPath("es", "cote-dazur") },
        { rating: 5, name: "Costa de Amalfi", sub: "Italia · mayo – octubre", imageKey: "compat-3", destinationHref: destinationPath("es", "amalfi") },
        { rating: 4, name: "Lago de Como", sub: "Italia · junio – septiembre", imageKey: "compat-4", destinationHref: destinationPath("es", "lake-como") },
        { rating: 4, name: "St. Barths", sub: "Caribe · noviembre – abril", imageKey: "compat-5", destinationHref: destinationPath("es", "st-barths") },
        { rating: 4, name: "Toscana", sub: "Italia · mayo – octubre", imageKey: "compat-6", destinationHref: destinationPath("es", "tuscany") },
        { rating: 4, name: "París e Isla de Francia", sub: "Francia · todo el año en interior", imageKey: "compat-7", destinationHref: destinationPath("es", "paris-ile-de-france") },
        { rating: 3, name: "Provenza", sub: "Francia · mayo – septiembre", imageKey: "compat-8", destinationHref: destinationPath("es", "provence") },
      ],
    },
    guest: {
  ...
  fr: {
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Côte d'Azur", sub: "France · juin – septembre", imageKey: "compat-2", destinationHref: destinationPath("fr", "cote-dazur") },
        { rating: 5, name: "Côte amalfitaine", sub: "Italie · mai – octobre", imageKey: "compat-3", destinationHref: destinationPath("fr", "amalfi") },
        { rating: 4, name: "Lac de Côme", sub: "Italie · juin – septembre", imageKey: "compat-4", destinationHref: destinationPath("fr", "lake-como") },
        { rating: 4, name: "St-Barth", sub: "Caraïbes · novembre – avril", imageKey: "compat-5", destinationHref: destinationPath("fr", "st-barths") },
        { rating: 4, name: "Toscane", sub: "Italie · mai – octobre", imageKey: "compat-6", destinationHref: destinationPath("fr", "tuscany") },
        { rating: 4, name: "Paris et Île-de-France", sub: "France · toute l'année en intérieur", imageKey: "compat-7", destinationHref: destinationPath("fr", "paris-ile-de-france") },
        { rating: 3, name: "Provence", sub: "France · mai – septembre", imageKey: "compat-8", destinationHref: destinationPath("fr", "provence") },
      ],
    },
    guest: {
  ...
  pt: {
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Costa Azul", sub: "França · junho – setembro", imageKey: "compat-2", destinationHref: destinationPath("pt", "cote-dazur") },
        { rating: 5, name: "Costa Amalfitana", sub: "Itália · maio – outubro", imageKey: "compat-3", destinationHref: destinationPath("pt", "amalfi") },
        { rating: 4, name: "Lago de Como", sub: "Itália · junho – setembro", imageKey: "compat-4", destinationHref: destinationPath("pt", "lake-como") },
        { rating: 4, name: "St. Barths", sub: "Caraíbas · novembro – abril", imageKey: "compat-5", destinationHref: destinationPath("pt", "st-barths") },
        { rating: 4, name: "Toscana", sub: "Itália · maio – outubro", imageKey: "compat-6", destinationHref: destinationPath("pt", "tuscany") },
        { rating: 4, name: "Paris e Île-de-France", sub: "França · todo o ano em interior", imageKey: "compat-7", destinationHref: destinationPath("pt", "paris-ile-de-france") },
        { rating: 3, name: "Provença", sub: "França · maio – setembro", imageKey: "compat-8", destinationHref: destinationPath("pt", "provence") },
      ],
    },
    guest: {
  ...
  de: {
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Côte d'Azur", sub: "Frankreich · Juni – September", imageKey: "compat-2", destinationHref: destinationPath("de", "cote-dazur") },
        { rating: 5, name: "Amalfiküste", sub: "Italien · Mai – Oktober", imageKey: "compat-3", destinationHref: destinationPath("de", "amalfi") },
        { rating: 4, name: "Comer See", sub: "Italien · Juni – September", imageKey: "compat-4", destinationHref: destinationPath("de", "lake-como") },
        { rating: 4, name: "St. Barths", sub: "Karibik · November – April", imageKey: "compat-5", destinationHref: destinationPath("de", "st-barths") },
        { rating: 4, name: "Toskana", sub: "Italien · Mai – Oktober", imageKey: "compat-6", destinationHref: destinationPath("de", "tuscany") },
        { rating: 4, name: "Paris & Île-de-France", sub: "Frankreich · ganzjährig im Innenraum", imageKey: "compat-7", destinationHref: destinationPath("de", "paris-ile-de-france") },
        { rating: 3, name: "Provence", sub: "Frankreich · Mai – September", imageKey: "compat-8", destinationHref: destinationPath("de", "provence") },
      ],
    },
    guest: {
  ...
  it: {
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Costa Azzurra", sub: "Francia · giugno – settembre", imageKey: "compat-2", destinationHref: destinationPath("it", "cote-dazur") },
        { rating: 5, name: "Costiera Amalfitana", sub: "Italia · maggio – ottobre", imageKey: "compat-3", destinationHref: destinationPath("it", "amalfi") },
        { rating: 4, name: "Lago di Como", sub: "Italia · giugno – settembre", imageKey: "compat-4", destinationHref: destinationPath("it", "lake-como") },
        { rating: 4, name: "St. Barths", sub: "Caraibi · novembre – aprile", imageKey: "compat-5", destinationHref: destinationPath("it", "st-barths") },
        { rating: 4, name: "Toscana", sub: "Italia · maggio – ottobre", imageKey: "compat-6", destinationHref: destinationPath("it", "tuscany") },
        { rating: 4, name: "Parigi e Île-de-France", sub: "Francia · tutto l'anno al chiuso", imageKey: "compat-7", destinationHref: destinationPath("it", "paris-ile-de-france") },
        { rating: 3, name: "Provenza", sub: "Francia · maggio – settembre", imageKey: "compat-8", destinationHref: destinationPath("it", "provence") },
      ],
    },
    guest: {
