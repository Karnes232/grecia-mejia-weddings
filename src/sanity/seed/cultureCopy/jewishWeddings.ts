...
export const jewishWeddings: Record<Locale, CultureCopy> = {
  en: {
    ...
    cardEyebrow: "Jewish",
    cardBlurb:
      "Chuppah, ketubah, sheva brachot — Orthodox, Conservative, Reform.",
    cardMeta: "Discover",
    intro:
      ...
      steps: [
        {
          numeral: "I",
          name: "Kabbalat Panim",
          sub: "Greeting the guests",
          when: "Before the ceremony",
          body: "Two receptions held in parallel — one for the bride, one for the groom. The ketubah is reviewed and the families gather before the couple are brought together.",
        },
        {
          numeral: "II",
          name: "Bedeken",
          sub: "The veiling",
          when: "Just before",
          body: "The groom is led to the bride to lower her veil, recalling the matriarchs. A brief, charged moment that often carries the whole day's emotion.",
        },
        {
          numeral: "III",
          name: "Ketubah",
          sub: "Signing the contract",
          when: "Before the chuppah",
          body: "The marriage contract is signed by the witnesses required under the officiating rabbi's tradition, then carried to the chuppah to be read aloud.",
        },
        {
          numeral: "IV",
          name: "Chuppah",
          sub: "Under the canopy",
          when: "The ceremony",
          body: "Vows beneath the open canopy: the ring given before witnesses, the ketubah read, and the sheva brachot — seven blessings — sung over a cup of wine.",
        },
        {
          numeral: "V",
          name: "Breaking of the glass",
          sub: "Shevirat ha-kos",
          when: "Close of ceremony",
          body: 'The groom breaks a glass underfoot, a remembrance held even in joy. The guests call out "Mazel tov" and the celebration begins.',
        },
        {
          numeral: "VI",
          name: "Yichud",
          ...
          body: "The newly married couple withdraw alone for a private interval — the first quiet minutes of marriage, before the room is given to the guests.",
        },
        {
          numeral: "VII",
          name: "Hora & reception",
          sub: "Celebration",
          when: "Evening",
          body: "The couple lifted on chairs to the hora, then dinner, sheva brachot repeated over the meal, speeches, and dancing that does not stop early.",
        },
      ],
    },
    designConcepts: {
    ...
    protocols: {
      ...
      items: [
        {
          title: "Never on Shabbat",
          body: "Jewish weddings are not held on Shabbat. Ceremonies begin after sundown on Saturday, or on Sunday — we build the entire weekend calendar around the actual local sunset time, not an approximation.",
        },
        {
          title: "The ketubah is witnessed properly",
          body: "The ketubah is signed by the witnesses the officiating rabbi requires for your tradition. We confirm the text, the witnesses and the language with the rabbi well before the day — never on it.",
        },
        {
          title: "The kosher kitchen is sealed and briefed",
          body: "Kosher catering is not a menu choice; it is a kitchen protocol. We agree a sealed-kitchen arrangement with the resort months ahead, fly in our caterer where needed, and brief every member of the resort team.",
        },
        {
          title: "The glass is broken safely",
          body: "The breaking of the glass is staged with a wrapped, pre-scored glass on a protected surface, so the moment is whole and no one is hurt. Ritual and safety are not in tension.",
        },
        {
          title: "The rabbi sets the order",
          body: "Where Orthodox, Conservative and Reform practice differ — the mechitza, the circling, the wording of the blessings — we follow the officiating rabbi's guidance, and we brief the venue accordingly.",
        },
        {
          title: "Customs are honoured, not flattened",
          body: "Mechitza and separate dancing for observant families; egalitarian customs for others. We ask, in private, what your family keeps, and we do not treat one Jewish wedding as a template for the next.",
        },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            ...
            {
              time: "Afternoon",
              body: "Free time · welcome amenities in every room",
            },
            {
              time: "Before sunset",
              body: "Candle-lighting · Shabbat begins (timing by local sunset)",
            },
            {
              time: "Evening",
              body: "Shabbat dinner · kiddush · hosted long-table meal",
            },
          ],
        },
        {
          ...
          events: [
            ...
            {
              time: "16:45",
              body: "Chuppah · ring · sheva brachot · breaking of the glass",
            },
            { time: "17:15", body: "Yichud · the couple's private interval" },
            { time: "18:00", body: "Reception cocktails" },
            {
              time: "19:30",
              body: "Hora · dinner · sheva brachot · speeches · dancing",
            },
          ],
        },
        {
          ...
          events: [
            ...
            {
              time: "12:30",
              body: "Optional sheva brachot · seven blessings repeated",
            },
    ...
    compatibility: {
      ...
      cards: [
        ...
        },
        {
          rating: 5,
          name: "The Hamptons",
          sub: "United States · May – September",
    ...
    guest: {
      ...
      cells: [
        {
          title: "Kosher dietary protocol",
          body: "A sealed kosher kitchen agreed with the resort, our own caterer where needed, and clearly labelled meals across the weekend. Kosher, vegetarian, vegan and allergen-free options at every service.",
        },
        {
          title: "Shabbat-observant guests",
          body: "Rooms close to the venue so no driving is needed, pre-cut key-cards and lighting arranged, meals timed to candle-lighting, and a Shabbat-friendly schedule for guests who keep it.",
        },
        {
          title: "Elders & mobility",
          body: "Dedicated seating, separate transport, ground-floor rooms reserved for older guests, and a studio liaison through the weekend. Medical-on-call for the duration.",
        },
        {
          title: "Travel & room blocks",
          body: "Group room blocks at three tiers, airport transfers across the arrival days, and welcome packages in every room with the schedule, dress code per event and key contacts.",
        },
        {
          title: "Attire & kippot",
          body: "Kippot provided for guests at the chuppah, a tallit on hand where the ceremony calls for one, and pressing service at the hotel for arrival and the wedding morning.",
        },
        {
          title: "Communications",
          body: "A guest group three weeks ahead, a wedding website with the schedule, dress codes and venue maps, and printed guides — including a short note for guests new to a Jewish wedding.",
        },
      ],
    },
    related: {
      ...
      articles: [
        {
          category: "Jewish Weddings · Kosher",
          title: "How Kosher Catering Actually Works Abroad",
          body: "On sealed kitchens, flown-in caterers, and the resort conversations that have to happen months ahead.",
          imageKey: "culture-related-1",
        },
        {
          category: "Tradition",
          title: "The Chuppah, in Detail",
          body: "Open on all sides, held over the couple — a short field guide to the canopy and what it means.",
          imageKey: "culture-related-2",
        },
        {
          category: "Planning · Shabbat",
          title: "Planning a Destination Wedding Around Shabbat",
          body: "Why the local sunset, not the calendar, sets the weekend — and how we build around it.",
          imageKey: "culture-related-3",
        },
        {
          category: "Interfaith",
          title: "Interfaith Jewish Weddings, Held Whole",
          body: "Two clergy, two traditions, one cohesive day — without diluting either side.",
          imageKey: "culture-related-4",
        },
        {
          category: "Cost · Jewish",
          title: "What a Luxury Jewish Wedding Actually Costs",
          body: "Frank 2026 budgets by guest count, including the cost of bringing the kitchen with you.",
  ...
  es: {
    ...
    cardEyebrow: "Judía",
    cardBlurb:
      "Chupá, ketubá, sheva brajot — ortodoxa, conservadora, reformista.",
    cardMeta: "Descubrir",
    intro:
    ...
    factStrip: [
      ...
      { label: "Invitados", value: "50 – 300", sub: "De íntima a grandiosa" },
      {
        label: "Antelación",
        value: "12 – 18 meses",
        sub: "El rabino reserva pronto",
      },
      {
        label: "Corrientes",
        value: "Ortodoxa · Conservadora",
        sub: "Reformista · Laica",
      },
      {
        label: "Catering",
        value: "Coordinación kosher",
        sub: "Cocina trasladada",
      },
      ...
      steps: [
        {
          numeral: "I",
          name: "Kabbalat Panim",
          sub: "Recibir a los invitados",
          when: "Antes de la ceremonia",
          body: "Dos recepciones en paralelo, una para la novia y otra para el novio. Se revisa la ketubah y las familias se reúnen antes de que la pareja se encuentre.",
        },
        {
          numeral: "II",
          name: "Bedeken",
          sub: "El velado",
          when: "Justo antes",
          body: "Se conduce al novio hasta la novia para bajarle el velo, en recuerdo de las matriarcas. Un instante breve e intenso que a menudo concentra toda la emoción del día.",
        },
        {
          numeral: "III",
          name: "Ketubah",
          sub: "Firma del contrato",
          when: "Antes de la chuppah",
          body: "El contrato matrimonial es firmado por los testigos que exige la tradición del rabino oficiante y luego se lleva a la chuppah para leerlo en voz alta.",
        },
        {
          numeral: "IV",
          name: "Chuppah",
          sub: "Bajo el palio",
          when: "La ceremonia",
          body: "Los votos bajo el palio abierto: el anillo entregado ante testigos, la lectura de la ketubah y las sheva brachot —siete bendiciones— cantadas sobre una copa de vino.",
        },
        {
          numeral: "V",
          name: "Rotura del cristal",
          sub: "Shevirat ha-kos",
          when: "Cierre de la ceremonia",
          body: "El novio rompe un cristal con el pie, un recuerdo que se sostiene incluso en la alegría. Los invitados gritan «Mazel tov» y comienza la celebración.",
        },
        {
          numeral: "VI",
          name: "Yichud",
          sub: "Reclusión",
          when: "Justo después",
          body: "Los recién casados se retiran a solas un breve intervalo: los primeros minutos de silencio del matrimonio, antes de entregar la sala a los invitados.",
        },
        {
          numeral: "VII",
          name: "Hora y recepción",
          sub: "Celebración",
          when: "Por la noche",
          body: "La pareja en alto sobre las sillas en la hora, luego la cena, las sheva brachot repetidas durante la comida, los discursos y un baile que no termina pronto.",
        },
      ],
    },
    designConcepts: {
    ...
    protocols: {
      ...
      items: [
        {
          title: "Nunca en Shabat",
          body: "Las bodas judías no se celebran en Shabat. Las ceremonias comienzan tras la puesta de sol del sábado, o el domingo. Construimos todo el calendario del fin de semana en torno a la hora real del ocaso local, no a una aproximación.",
        },
        {
          title: "La ketubah se atestigua como corresponde",
          body: "La ketubah la firman los testigos que el rabino oficiante exige para su tradición. Confirmamos el texto, los testigos y el idioma con el rabino mucho antes del día, nunca en él.",
        },
        {
          title: "La cocina kosher, sellada e instruida",
          body: "El catering kosher no es una elección de menú; es un protocolo de cocina. Acordamos una cocina sellada con el hotel meses antes, trasladamos a nuestro catering cuando hace falta e instruimos a todo el equipo del hotel.",
        },
        {
          title: "El cristal se rompe con seguridad",
          body: "La rotura del cristal se prepara con un vaso envuelto y previamente marcado sobre una superficie protegida, para que el instante sea entero y nadie se lastime. Rito y seguridad no están reñidos.",
        },
        {
          title: "El rabino fija el orden",
          body: "Donde difieren las prácticas ortodoxa, conservadora y reformista —la mechitza, las vueltas, el texto de las bendiciones— seguimos la guía del rabino oficiante e instruimos al lugar en consecuencia.",
        },
        {
          title: "Las costumbres se honran, no se allanan",
          body: "Mechitza y baile separado para las familias observantes; costumbres igualitarias para otras. Preguntamos, en privado, qué guarda su familia, y no tratamos una boda judía como plantilla de la siguiente.",
        },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            {
              time: "Mañana",
              body: "Llegadas · traslados al aeropuerto · check-in en el hotel",
            },
            {
              time: "Tarde",
              body: "Tiempo libre · detalles de bienvenida en cada habitación",
            },
            {
              time: "Antes del ocaso",
              body: "Encendido de velas · comienza el Shabat (según el ocaso local)",
            },
            {
              time: "Noche",
              body: "Cena de Shabat · kidush · comida atendida en mesa larga",
            },
          ],
        },
        {
          ...
          events: [
            {
              time: "15:00",
              body: "Kabbalat Panim · dos recepciones en paralelo",
            },
            { time: "16:00", body: "Firma de la ketubah · testigos · bedeken" },
            {
              time: "16:45",
              body: "Chuppah · anillo · sheva brachot · rotura del cristal",
            },
            {
              time: "17:15",
              body: "Yichud · el intervalo privado de la pareja",
            },
            { time: "18:00", body: "Cóctel de recepción" },
            {
              time: "19:30",
              body: "Hora · cena · sheva brachot · discursos · baile",
            },
          ],
        },
        {
          ...
          events: [
            ...
            {
              time: "12:30",
              body: "Sheva brachot opcional · siete bendiciones repetidas",
            },
    ...
    compatibility: {
      ...
      cards: [
        ...
        },
        {
          rating: 5,
          name: "Los Hamptons",
          sub: "Estados Unidos · mayo – septiembre",
          destinationSlug: "the-hamptons",
        },
        {
          rating: 5,
        ...
        },
        {
          rating: 3,
          name: "Aspen y Napa",
          sub: "Estados Unidos · por temporada",
          destinationSlug: "aspen-napa",
        },
      ],
    },
    guest: {
      ...
      cells: [
        {
          title: "Protocolo dietético kosher",
          body: "Una cocina kosher sellada acordada con el hotel, nuestro propio catering cuando hace falta y comidas claramente señaladas durante el fin de semana. Opciones kosher, vegetarianas, veganas y sin alérgenos en cada servicio.",
        },
        {
          title: "Invitados observantes del Shabat",
          body: "Habitaciones cercanas al lugar para que nadie tenga que conducir, tarjetas-llave y luces preparadas de antemano, comidas ajustadas al encendido de velas y un programa compatible con el Shabat para quienes lo guardan.",
        },
        {
          title: "Mayores y movilidad",
          body: "Asientos reservados, transporte aparte, habitaciones en planta baja para los invitados de más edad y un enlace del atelier durante todo el fin de semana. Atención médica de guardia durante el evento.",
        },
        {
          title: "Viajes y bloques de habitaciones",
          body: "Bloques de habitaciones en tres categorías, traslados al aeropuerto en los días de llegada y paquetes de bienvenida en cada habitación con el programa, el código de vestimenta por evento y los contactos clave.",
        },
        {
          title: "Vestimenta y kippot",
          body: "Kippot a disposición de los invitados en la chuppah, un talit preparado cuando la ceremonia lo requiere y servicio de planchado en el hotel para la llegada y la mañana de la boda.",
        },
        {
          title: "Comunicaciones",
          body: "Un grupo de invitados tres semanas antes, una web de boda con el programa, los códigos de vestimenta y los mapas del lugar, y guías impresas, incluida una nota breve para quienes asisten por primera vez a una boda judía.",
        },
      ],
    },
    related: {
      ...
      articles: [
        {
          category: "Bodas Judías · Kosher",
          title:
            "Cómo funciona en realidad el catering kosher en el extranjero",
          body: "Sobre cocinas selladas, catering trasladado y las conversaciones con el hotel que han de ocurrir meses antes.",
          imageKey: "culture-related-1",
        },
        {
          category: "Tradición",
          title: "La chuppah, en detalle",
          body: "Abierta por sus cuatro lados, sostenida sobre la pareja: una breve guía del palio y de su significado.",
          imageKey: "culture-related-2",
        },
        {
          category: "Planificación · Shabat",
          title: "Planificar una boda de destino en torno al Shabat",
          body: "Por qué es el ocaso local, y no el calendario, quien fija el fin de semana, y cómo construimos a partir de ahí.",
          imageKey: "culture-related-3",
        },
        {
          category: "Interreligiosa",
          title: "Bodas judías interreligiosas, sostenidas enteras",
          body: "Dos oficiantes, dos tradiciones, un día cohesivo, sin diluir a ninguna de las partes.",
          imageKey: "culture-related-4",
        },
        {
          category: "Coste · Judía",
          title: "Cuánto cuesta realmente una boda judía de lujo",
          body: "Presupuestos francos de 2026 por número de invitados, incluido el coste de llevarse la cocina.",
          imageKey: "culture-related-5",
        },
      ],
      sidebarDestinations: [
  ...
  fr: {
    ...
    factStrip: [
      ...
      { label: "Invités", value: "50 – 300", sub: "De l'intime au grand" },
      {
        label: "Anticipation",
        value: "12 – 18 mois",
        sub: "Le rabbin réserve tôt",
      },
      {
        label: "Courants",
        value: "Orthodoxe · Massorti",
        sub: "Libéral · Laïque",
      },
      {
        label: "Traiteur",
        value: "Coordination casher",
        sub: "Cuisine acheminée",
      },
      ...
      steps: [
        {
          ...
          when: "Avant la cérémonie",
          body: "Deux réceptions en parallèle, l'une pour la mariée, l'autre pour le marié. La ketubah est relue et les familles se rassemblent avant que le couple soit réuni.",
        },
        {
          numeral: "II",
          name: "Bedeken",
          sub: "Le voilage",
          when: "Juste avant",
          body: "Le marié est conduit jusqu'à la mariée pour abaisser son voile, en souvenir des matriarches. Un instant bref et intense qui porte souvent toute l'émotion de la journée.",
        },
        {
          numeral: "III",
          name: "Ketubah",
          sub: "Signature du contrat",
          when: "Avant la chuppah",
          body: "Le contrat de mariage est signé par les témoins requis selon la tradition du rabbin officiant, puis porté à la chuppah pour y être lu à voix haute.",
        },
        {
          numeral: "IV",
          name: "Chuppah",
          sub: "Sous le dais",
          when: "La cérémonie",
          body: "Les vœux sous le dais ouvert : l'anneau donné devant témoins, la lecture de la ketubah et les sheva brachot — sept bénédictions — chantées sur une coupe de vin.",
        },
        {
          numeral: "V",
          name: "Bris du verre",
          sub: "Shevirat ha-kos",
          when: "Clôture de la cérémonie",
          body: "Le marié brise un verre sous son pied, mémoire tenue jusque dans la joie. Les invités lancent « Mazel tov » et la fête commence.",
        },
        {
          numeral: "VI",
          name: "Yichud",
          sub: "Retrait à deux",
          when: "Aussitôt après",
          body: "Les jeunes mariés se retirent seuls un bref instant : les premières minutes de silence du mariage, avant que la salle soit rendue aux invités.",
        },
        {
          numeral: "VII",
          name: "Hora & réception",
          sub: "Célébration",
          when: "En soirée",
          body: "Le couple hissé sur des chaises pour la hora, puis le dîner, les sheva brachot reprises pendant le repas, les discours et une danse qui ne s'arrête pas tôt.",
        },
      ],
    },
    designConcepts: {
    ...
    protocols: {
      ...
      items: [
        {
          title: "Jamais pendant Shabbat",
          body: "Les mariages juifs ne se tiennent pas pendant Shabbat. Les cérémonies commencent après le coucher du soleil le samedi, ou le dimanche. Nous bâtissons tout le calendrier du week-end autour de l'heure réelle du coucher du soleil local, non d'une approximation.",
        },
        {
          title: "La ketubah attestée comme il se doit",
          body: "La ketubah est signée par les témoins que le rabbin officiant exige pour votre tradition. Nous confirmons le texte, les témoins et la langue avec le rabbin bien avant le jour, jamais le jour même.",
        },
        {
          title: "La cuisine casher, scellée et briefée",
          body: "Le casher n'est pas un choix de menu ; c'est un protocole de cuisine. Nous convenons d'une cuisine scellée avec l'établissement des mois à l'avance, acheminons notre traiteur au besoin et briefons chaque membre de l'équipe sur place.",
        },
        {
          title: "Le verre brisé en sécurité",
          body: "Le bris du verre est préparé avec un verre enveloppé et pré-entaillé sur une surface protégée, afin que l'instant soit entier et que personne ne se blesse. Le rite et la sécurité ne s'opposent pas.",
        },
        {
          title: "Le rabbin fixe l'ordre",
          body: "Là où les pratiques orthodoxe, massorti et libérale diffèrent — la mechitza, les tours, le texte des bénédictions — nous suivons les indications du rabbin officiant et briefons le lieu en conséquence.",
        },
        {
          title: "Les coutumes honorées, non aplanies",
          body: "Mechitza et danse séparée pour les familles pratiquantes ; coutumes égalitaires pour d'autres. Nous demandons, en privé, ce que votre famille garde, et nous ne traitons pas un mariage juif comme le modèle du suivant.",
        },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            ...
            {
              time: "Après-midi",
              body: "Temps libre · attentions de bienvenue dans chaque chambre",
            },
            {
              time: "Avant le coucher du soleil",
              body: "Allumage des bougies · début de Shabbat (selon le coucher local)",
            },
            {
              time: "Soir",
              body: "Dîner de Shabbat · kiddoush · repas accompagné à grande table",
            },
          ],
        },
        {
          ...
          events: [
            {
              time: "15h00",
              body: "Kabbalat Panim · deux réceptions en parallèle",
            },
            {
              time: "16h00",
              body: "Signature de la ketubah · témoins · bedeken",
            },
            {
              time: "16h45",
              body: "Chuppah · anneau · sheva brachot · bris du verre",
            },
            { time: "17h15", body: "Yichud · l'intervalle privé du couple" },
            { time: "18h00", body: "Cocktail de réception" },
            {
              time: "19h30",
              body: "Hora · dîner · sheva brachot · discours · danse",
            },
          ],
        },
        {
          ...
          events: [
            ...
            {
              time: "12h30",
              body: "Sheva brachot facultatives · sept bénédictions reprises",
            },
    ...
    compatibility: {
      ...
      cards: [
        ...
        },
        {
          rating: 3,
          name: "Aspen & Napa",
          sub: "États-Unis · selon la saison",
          destinationSlug: "aspen-napa",
        },
      ],
    },
    guest: {
      ...
      cells: [
        {
          title: "Protocole alimentaire casher",
          body: "Une cuisine casher scellée convenue avec l'établissement, notre propre traiteur au besoin et des repas clairement signalés tout le week-end. Options casher, végétariennes, véganes et sans allergènes à chaque service.",
        },
        {
          title: "Invités observant le Shabbat",
          body: "Des chambres proches du lieu pour qu'aucun trajet ne soit nécessaire, cartes-clés et éclairages préparés à l'avance, repas calés sur l'allumage des bougies et un programme compatible avec le Shabbat pour ceux qui le gardent.",
        },
        {
          title: "Aînés & mobilité",
          body: "Places réservées, transport séparé, chambres en rez-de-chaussée pour les invités les plus âgés et un référent de l'atelier tout le week-end. Médecin de garde pendant toute la durée.",
        },
        {
          title: "Voyages & blocs de chambres",
          body: "Blocs de chambres sur trois niveaux, transferts aéroport sur les jours d'arrivée et pochettes de bienvenue dans chaque chambre avec le programme, le code vestimentaire par événement et les contacts clés.",
        },
        {
          title: "Tenue & kippot",
          body: "Kippot mises à disposition des invités à la chuppah, un tallit prêt quand la cérémonie l'exige et un service de repassage à l'hôtel pour l'arrivée et le matin du mariage.",
        },
        {
          title: "Communications",
          body: "Un groupe d'invités trois semaines à l'avance, un site de mariage avec le programme, les codes vestimentaires et les plans du lieu, et des guides imprimés — dont une courte note pour ceux qui assistent à leur premier mariage juif.",
        },
      ],
    },
    related: {
      ...
      articles: [
        {
          category: "Mariages Juifs · Casher",
          title:
            "Comment fonctionne réellement le traiteur casher à l'étranger",
          body: "Sur les cuisines scellées, les traiteurs acheminés et les échanges avec l'établissement qui doivent avoir lieu des mois à l'avance.",
          imageKey: "culture-related-1",
        },
        {
          category: "Tradition",
          title: "La chuppah, en détail",
          body: "Ouverte de tous côtés, tenue au-dessus du couple : un bref guide du dais et de son sens.",
          imageKey: "culture-related-2",
        },
        {
          category: "Planification · Shabbat",
          title: "Organiser un mariage de destination autour de Shabbat",
          body: "Pourquoi c'est le coucher du soleil local, et non le calendrier, qui fixe le week-end — et comment nous bâtissons à partir de là.",
          imageKey: "culture-related-3",
        },
        {
          category: "Interconfessionnel",
          title: "Mariages juifs interconfessionnels, tenus entiers",
          body: "Deux officiants, deux traditions, une journée cohérente, sans diluer aucun des deux côtés.",
          imageKey: "culture-related-4",
        },
        {
          category: "Coût · Juif",
          title: "Ce que coûte vraiment un mariage juif de luxe",
          body: "Budgets francs 2026 par nombre d'invités, coût d'acheminement de la cuisine compris.",
          imageKey: "culture-related-5",
        },
      ],
      sidebarDestinations: [
    ...
    faq: {
      ...
      items: [
        ...
        {
          question:
            "Comment le traiteur casher fonctionne-t-il dans un établissement ?",
          answer: [
        ...
        {
          question:
            "Quel est le coût habituel d'un mariage juif de destination ?",
          answer: [
  ...
  pt: {
    ...
    cardEyebrow: "Judaico",
    cardBlurb:
      "Chupá, ketubá, sheva brachot — ortodoxo, conservador, reformista.",
    cardMeta: "Descobrir",
    intro:
    ...
    factStrip: [
      ...
      {
        label: "Catering",
        value: "Coordenação kosher",
        sub: "Cozinha deslocada",
      },
      ...
      steps: [
        {
          numeral: "I",
          name: "Kabbalat Panim",
          sub: "Receber os convidados",
          when: "Antes da cerimónia",
          body: "Duas receções em paralelo, uma para a noiva e outra para o noivo. A ketubah é revista e as famílias reúnem-se antes de o casal se encontrar.",
        },
        {
          numeral: "II",
          name: "Bedeken",
          sub: "O velar",
          when: "Mesmo antes",
          body: "O noivo é conduzido até à noiva para baixar o seu véu, em memória das matriarcas. Um instante breve e intenso que muitas vezes concentra toda a emoção do dia.",
        },
        {
          numeral: "III",
          name: "Ketubah",
          sub: "Assinatura do contrato",
          when: "Antes da chuppah",
          body: "O contrato de casamento é assinado pelas testemunhas exigidas pela tradição do rabino oficiante e depois levado à chuppah para ser lido em voz alta.",
        },
        {
          numeral: "IV",
          name: "Chuppah",
          sub: "Sob o pálio",
          when: "A cerimónia",
          body: "Os votos sob o pálio aberto: o anel dado perante testemunhas, a leitura da ketubah e as sheva brachot — sete bênçãos — cantadas sobre um cálice de vinho.",
        },
        {
          numeral: "V",
          name: "Quebra do copo",
          sub: "Shevirat ha-kos",
          when: "Encerramento da cerimónia",
          body: "O noivo parte um copo com o pé, memória mantida mesmo na alegria. Os convidados gritam «Mazel tov» e começa a festa.",
        },
        {
          numeral: "VI",
          name: "Yichud",
          sub: "Recolhimento",
          when: "Logo a seguir",
          body: "Os recém-casados retiram-se a sós por um breve intervalo: os primeiros minutos de silêncio do casamento, antes de a sala ser entregue aos convidados.",
        },
        {
          numeral: "VII",
          name: "Hora e receção",
          sub: "Celebração",
          when: "À noite",
          body: "O casal erguido em cadeiras na hora, depois o jantar, as sheva brachot repetidas durante a refeição, os discursos e uma dança que não termina cedo.",
        },
      ],
    },
    designConcepts: {
      ...
      cards: [
        ...
        },
        {
          ...
          rows: [
            ...
            {
              label: "Ideal para",
              value: "Cobertura · galeria · villa moderna",
            },
          ],
        },
      ],
    ...
    protocols: {
      ...
      items: [
        {
          title: "Nunca no Shabat",
          body: "Os casamentos judaicos não se realizam no Shabat. As cerimónias começam após o pôr do sol de sábado, ou no domingo. Construímos todo o calendário do fim de semana em torno da hora real do ocaso local, não de uma aproximação.",
        },
        {
          title: "A ketubah testemunhada como deve ser",
          body: "A ketubah é assinada pelas testemunhas que o rabino oficiante exige para a sua tradição. Confirmamos o texto, as testemunhas e a língua com o rabino muito antes do dia, nunca no próprio dia.",
        },
        {
          title: "A cozinha kosher, selada e instruída",
          body: "O catering kosher não é uma escolha de menu; é um protocolo de cozinha. Acordamos uma cozinha selada com a unidade meses antes, deslocamos o nosso catering quando necessário e instruímos toda a equipa local.",
        },
        {
          title: "O copo partido em segurança",
          body: "A quebra do copo é preparada com um copo embrulhado e previamente marcado sobre uma superfície protegida, para que o instante seja inteiro e ninguém se magoe. Rito e segurança não estão em conflito.",
        },
        {
          title: "O rabino fixa a ordem",
          body: "Onde as práticas ortodoxa, conservadora e reformista diferem — a mechitza, as voltas, o texto das bênçãos — seguimos a orientação do rabino oficiante e instruímos o local em conformidade.",
        },
        {
          title: "Os costumes honrados, não nivelados",
          body: "Mechitza e dança separada para as famílias praticantes; costumes igualitários para outras. Perguntamos, em privado, o que a sua família guarda, e não tratamos um casamento judaico como modelo do seguinte.",
        },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            ...
            {
              time: "Tarde",
              body: "Tempo livre · mimos de boas-vindas em cada quarto",
            },
            {
              time: "Antes do ocaso",
              body: "Acender das velas · começa o Shabat (segundo o ocaso local)",
            },
            {
              time: "Noite",
              body: "Jantar de Shabat · kidush · refeição acompanhada em mesa comprida",
            },
          ],
        },
        {
          ...
          events: [
            {
              time: "15:00",
              body: "Kabbalat Panim · duas receções em paralelo",
            },
            {
              time: "16:00",
              body: "Assinatura da ketubah · testemunhas · bedeken",
            },
            {
              time: "16:45",
              body: "Chuppah · anel · sheva brachot · quebra do copo",
            },
            { time: "17:15", body: "Yichud · o intervalo privado do casal" },
            { time: "18:00", body: "Cocktail de receção" },
            {
              time: "19:30",
              body: "Hora · jantar · sheva brachot · discursos · dança",
            },
          ],
        },
        {
          ...
          events: [
            ...
            {
              time: "12:30",
              body: "Sheva brachot opcional · sete bênçãos repetidas",
            },
    ...
    compatibility: {
      ...
      cards: [
        ...
        },
        {
          rating: 5,
          name: "Os Hamptons",
          sub: "Estados Unidos · maio – setembro",
          destinationSlug: "the-hamptons",
        },
        {
          rating: 5,
    ...
    guest: {
      ...
      cells: [
        {
          title: "Protocolo alimentar kosher",
          body: "Uma cozinha kosher selada acordada com a unidade, o nosso próprio catering quando necessário e refeições claramente assinaladas durante o fim de semana. Opções kosher, vegetarianas, veganas e sem alergénios em cada serviço.",
        },
        {
          title: "Convidados observantes do Shabat",
          body: "Quartos próximos do local para que ninguém tenha de conduzir, cartões-chave e iluminação preparados de antemão, refeições ajustadas ao acender das velas e um programa compatível com o Shabat para quem o guarda.",
        },
        {
          title: "Idosos & mobilidade",
          body: "Lugares reservados, transporte à parte, quartos no piso térreo para os convidados mais idosos e um elo do ateliê durante todo o fim de semana. Médico de prevenção durante todo o evento.",
        },
        {
          title: "Viagens & blocos de quartos",
          body: "Blocos de quartos em três níveis, transferes do aeroporto nos dias de chegada e pacotes de boas-vindas em cada quarto com o programa, o código de vestuário por evento e os contactos essenciais.",
        },
        {
          title: "Traje & kippot",
          body: "Kippot à disposição dos convidados na chuppah, um talit a postos quando a cerimónia o exige e serviço de passar a ferro no hotel para a chegada e a manhã do casamento.",
        },
        {
          title: "Comunicações",
          body: "Um grupo de convidados três semanas antes, um site de casamento com o programa, os códigos de vestuário e os mapas do local, e guias impressos — incluindo uma breve nota para quem assiste pela primeira vez a um casamento judaico.",
        },
      ],
    },
    related: {
      ...
      articles: [
        {
          category: "Casamentos Judaicos · Kosher",
          title: "Como funciona na realidade o catering kosher no estrangeiro",
          body: "Sobre cozinhas seladas, catering deslocado e as conversas com a unidade que têm de acontecer meses antes.",
          imageKey: "culture-related-1",
        },
        {
          category: "Tradição",
          title: "A chuppah, em detalhe",
          body: "Aberta dos quatro lados, sustentada sobre o casal: um breve guia do pálio e do seu sentido.",
          imageKey: "culture-related-2",
        },
        {
          category: "Planeamento · Shabat",
          title: "Planear um casamento de destino em torno do Shabat",
          body: "Por que é o ocaso local, e não o calendário, que fixa o fim de semana — e como construímos a partir daí.",
          imageKey: "culture-related-3",
        },
        {
          category: "Inter-religioso",
          title: "Casamentos judaicos inter-religiosos, sustentados inteiros",
          body: "Dois celebrantes, duas tradições, um dia coeso, sem diluir nenhum dos lados.",
          imageKey: "culture-related-4",
        },
        {
          category: "Custo · Judaico",
          title: "Quanto custa realmente um casamento judaico de luxo",
          body: "Orçamentos francos de 2026 por número de convidados, incluindo o custo de levar a cozinha consigo.",
          imageKey: "culture-related-5",
        },
      ],
      sidebarDestinations: [
    ...
    faq: {
      ...
      items: [
        ...
        {
          question:
            "Qual é o custo habitual de um casamento judaico de destino?",
          answer: [
  ...
  de: {
    ...
    cardEyebrow: "Jüdisch",
    cardBlurb:
      "Chuppa, Ketubba, Sheva Brachot — orthodox, konservativ, liberal.",
    cardMeta: "Entdecken",
    intro:
    ...
    factStrip: [
      ...
      { label: "Gäste", value: "50 – 300", sub: "Intim bis groß" },
      {
        label: "Vorlaufzeit",
        value: "12 – 18 Monate",
        sub: "Rabbiner bucht früh",
      },
      {
        label: "Strömungen",
        value: "Orthodox · Konservativ",
        sub: "Liberal · Säkular",
      },
      {
        label: "Catering",
        value: "Koschere Koordination",
        sub: "Küche eingeflogen",
      },
      ...
      steps: [
        {
          numeral: "I",
          name: "Kabbalat Panim",
          sub: "Empfang der Gäste",
          when: "Vor der Zeremonie",
          body: "Zwei Empfänge parallel — einer für die Braut, einer für den Bräutigam. Die ketubah wird durchgesehen und die Familien versammeln sich, bevor das Paar zusammengeführt wird.",
        },
        {
          numeral: "II",
          name: "Bedeken",
          sub: "Das Verschleiern",
          when: "Kurz davor",
          body: "Der Bräutigam wird zur Braut geführt, um ihren Schleier zu senken, im Gedenken an die Stammmütter. Ein kurzer, dichter Moment, der oft die ganze Emotion des Tages trägt.",
        },
        {
          numeral: "III",
          name: "Ketubah",
          sub: "Unterzeichnung des Vertrags",
          when: "Vor der chuppah",
          body: "Der Ehevertrag wird von den Zeugen unterzeichnet, die die Tradition des amtierenden Rabbiners verlangt, und dann zur chuppah getragen, um laut verlesen zu werden.",
        },
        {
          numeral: "IV",
          name: "Chuppah",
          sub: "Unter dem Baldachin",
          when: "Die Zeremonie",
          body: "Die Gelübde unter dem offenen Baldachin: der Ring vor Zeugen gegeben, die ketubah verlesen und die sheva brachot — sieben Segenssprüche — über einem Becher Wein gesungen.",
        },
        {
          numeral: "V",
          name: "Zerbrechen des Glases",
          sub: "Shevirat ha-kos",
          when: "Abschluss der Zeremonie",
          body: "Der Bräutigam zertritt ein Glas, eine Erinnerung, die selbst in der Freude gehalten wird. Die Gäste rufen „Mazel tov“ und das Fest beginnt.",
        },
        {
          numeral: "VI",
          name: "Yichud",
          sub: "Zurückgezogenheit",
          when: "Unmittelbar danach",
          body: "Das frisch vermählte Paar zieht sich für einen kurzen Augenblick allein zurück — die ersten stillen Minuten der Ehe, bevor der Saal den Gästen überlassen wird.",
        },
        {
          numeral: "VII",
          name: "Hora & Empfang",
          sub: "Feier",
          when: "Am Abend",
          body: "Das Paar auf Stühlen zur hora emporgehoben, dann das Dinner, die sheva brachot über dem Mahl wiederholt, die Reden und ein Tanz, der nicht früh endet.",
        },
      ],
    },
    designConcepts: {
      ...
      cards: [
        ...
        },
        {
          ...
          rows: [
            ...
            {
              label: "Am besten für",
              value: "Dachterrasse · Galerie · moderne Villa",
            },
          ],
        },
      ],
    ...
    protocols: {
      ...
      items: [
        {
          title: "Niemals am Schabbat",
          body: "Jüdische Hochzeiten finden nicht am Schabbat statt. Zeremonien beginnen nach Sonnenuntergang am Samstag oder am Sonntag. Wir bauen den gesamten Wochenendkalender um die tatsächliche örtliche Sonnenuntergangszeit, nicht um eine Näherung.",
        },
        {
          title: "Die ketubah wird ordentlich bezeugt",
          body: "Die ketubah wird von den Zeugen unterzeichnet, die der amtierende Rabbiner für Ihre Tradition verlangt. Wir bestätigen Text, Zeugen und Sprache mit dem Rabbiner lange vor dem Tag, nie am Tag selbst.",
        },
        {
          title: "Die koschere Küche ist versiegelt und eingewiesen",
          body: "Koscheres Catering ist keine Menüwahl; es ist ein Küchenprotokoll. Wir vereinbaren Monate im Voraus eine versiegelte Küche mit dem Haus, fliegen bei Bedarf unseren Caterer ein und weisen jedes Mitglied des Hausteams ein.",
        },
        {
          title: "Das Glas wird sicher zerbrochen",
          body: "Das Zerbrechen des Glases wird mit einem umwickelten, vorgeritzten Glas auf geschützter Fläche vorbereitet, damit der Moment ganz bleibt und niemand sich verletzt. Ritus und Sicherheit stehen nicht im Widerspruch.",
        },
        {
          title: "Der Rabbiner legt die Ordnung fest",
          body: "Wo orthodoxe, konservative und liberale Praxis sich unterscheiden — die mechitza, die Umkreisungen, der Wortlaut der Segenssprüche — folgen wir der Weisung des amtierenden Rabbiners und weisen das Haus entsprechend ein.",
        },
        {
          title: "Bräuche werden geehrt, nicht eingeebnet",
          body: "Mechitza und getrenntes Tanzen für praktizierende Familien; egalitäre Bräuche für andere. Wir fragen, im Vertrauen, was Ihre Familie hält, und behandeln eine jüdische Hochzeit nicht als Vorlage für die nächste.",
        },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            {
              time: "Morgen",
              body: "Ankünfte · Flughafentransfers · Check-in im Hotel",
            },
            {
              time: "Nachmittag",
              body: "Freie Zeit · Willkommensaufmerksamkeiten in jedem Zimmer",
            },
            {
              time: "Vor Sonnenuntergang",
              body: "Lichterzünden · Schabbat beginnt (nach örtlichem Sonnenuntergang)",
            },
            {
              time: "Abend",
              body: "Schabbat-Dinner · Kiddusch · betreutes Mahl an der langen Tafel",
            },
          ],
        },
        {
          ...
          events: [
            ...
            {
              time: "16:00",
              body: "Unterzeichnung der ketubah · Zeugen · bedeken",
            },
            {
              time: "16:45",
              body: "Chuppah · Ring · sheva brachot · Zerbrechen des Glases",
            },
            {
              time: "17:15",
              body: "Yichud · das private Intervall des Paares",
            },
            { time: "18:00", body: "Empfangs-Cocktail" },
            {
              time: "19:30",
              body: "Hora · Dinner · sheva brachot · Reden · Tanz",
            },
          ],
        },
        {
          ...
          events: [
            ...
            {
              time: "12:30",
              body: "Optionale sheva brachot · sieben Segenssprüche wiederholt",
            },
    ...
    guest: {
      ...
      cells: [
        {
          title: "Koscheres Speiseprotokoll",
          body: "Eine mit dem Haus vereinbarte, versiegelte koschere Küche, unser eigener Caterer bei Bedarf und klar gekennzeichnete Mahlzeiten über das Wochenende. Koschere, vegetarische, vegane und allergenfreie Optionen bei jedem Service.",
        },
        {
          title: "Schabbat-treue Gäste",
          body: "Zimmer nahe am Ort, damit niemand fahren muss, vorbereitete Schlüsselkarten und Beleuchtung, auf das Lichterzünden abgestimmte Mahlzeiten und ein Schabbat-gerechter Ablauf für jene, die ihn halten.",
        },
        {
          title: "Ältere & Mobilität",
          body: "Reservierte Plätze, separater Transport, im Erdgeschoss reservierte Zimmer für ältere Gäste und eine Ansprechperson des Ateliers über das ganze Wochenende. Arzt auf Abruf für die Dauer.",
        },
        {
          title: "Anreise & Zimmerkontingente",
          body: "Zimmerkontingente in drei Stufen, Flughafentransfers an den Anreisetagen und Willkommenspakete in jedem Zimmer mit Ablauf, Kleiderordnung je Anlass und wichtigen Kontakten.",
        },
        {
          title: "Kleidung & kippot",
          body: "Kippot für die Gäste an der chuppah bereitgestellt, ein Tallit zur Hand, wenn die Zeremonie es verlangt, und Bügelservice im Hotel zur Anreise und am Hochzeitsmorgen.",
        },
        {
          title: "Kommunikation",
          body: "Eine Gästegruppe drei Wochen vorab, eine Hochzeitswebsite mit Ablauf, Kleiderordnungen und Lageplänen sowie gedruckte Leitfäden — samt einer kurzen Notiz für Gäste, die zum ersten Mal eine jüdische Hochzeit erleben.",
        },
      ],
    },
    related: {
      ...
      articles: [
        {
          category: "Jüdische Hochzeiten · Koscher",
          title: "Wie koscheres Catering im Ausland wirklich funktioniert",
          body: "Über versiegelte Küchen, eingeflogene Caterer und die Gespräche mit dem Haus, die Monate vorher stattfinden müssen.",
          imageKey: "culture-related-1",
        },
        {
          category: "Tradition",
          title: "Die chuppah, im Detail",
          body: "An allen Seiten offen, über dem Paar gehalten: ein kurzer Leitfaden zum Baldachin und seiner Bedeutung.",
          imageKey: "culture-related-2",
        },
        {
          category: "Planung · Schabbat",
          title: "Eine Destinationshochzeit rund um den Schabbat planen",
          body: "Warum der örtliche Sonnenuntergang, nicht der Kalender, das Wochenende bestimmt — und wie wir darum herum bauen.",
          imageKey: "culture-related-3",
        },
        {
          category: "Interreligiös",
          title: "Interreligiöse jüdische Hochzeiten, ganz gehalten",
          body: "Zwei Geistliche, zwei Traditionen, ein stimmiger Tag, ohne eine Seite zu verwässern.",
          imageKey: "culture-related-4",
        },
        {
          category: "Kosten · Jüdisch",
          title: "Was eine luxuriöse jüdische Hochzeit wirklich kostet",
          body: "Offene 2026er Budgets nach Gästezahl, einschließlich der Kosten, die Küche mitzubringen.",
          imageKey: "culture-related-5",
        },
      ],
      sidebarDestinations: [
    ...
    faq: {
      ...
      items: [
        ...
        {
          question:
            "Was kostet eine jüdische Destinationshochzeit üblicherweise?",
          answer: [
  ...
  it: {
    ...
    cardEyebrow: "Ebraico",
    cardBlurb:
      "Chuppah, ketubah, sheva brachot — ortodosso, conservatore, riformato.",
    cardMeta: "Scopri",
    intro:
    ...
    factStrip: [
      ...
      { label: "Invitati", value: "50 – 300", sub: "Dall'intimo al grande" },
      {
        label: "Anticipo",
        value: "12 – 18 mesi",
        sub: "Il rabbino prenota presto",
      },
      {
        label: "Correnti",
        value: "Ortodossa · Conservatrice",
        sub: "Riformata · Laica",
      },
      {
        label: "Catering",
        value: "Coordinamento kosher",
        sub: "Cucina trasferita",
      },
      ...
      steps: [
        {
          numeral: "I",
          name: "Kabbalat Panim",
          sub: "Accogliere gli invitati",
          when: "Prima della cerimonia",
          body: "Due ricevimenti in parallelo, uno per la sposa e uno per lo sposo. La ketubah viene riletta e le famiglie si riuniscono prima che la coppia sia ricongiunta.",
        },
        {
          numeral: "II",
          name: "Bedeken",
          sub: "Il velare",
          when: "Subito prima",
          body: "Lo sposo è condotto dalla sposa per abbassarle il velo, in memoria delle matriarche. Un istante breve e intenso che spesso porta tutta l'emozione della giornata.",
        },
        {
          numeral: "III",
          name: "Ketubah",
          sub: "Firma del contratto",
          when: "Prima della chuppah",
          body: "Il contratto di matrimonio è firmato dai testimoni richiesti dalla tradizione del rabbino officiante, poi portato alla chuppah per essere letto ad alta voce.",
        },
        {
          numeral: "IV",
          name: "Chuppah",
          sub: "Sotto il baldacchino",
          when: "La cerimonia",
          body: "I voti sotto il baldacchino aperto: l'anello dato davanti ai testimoni, la lettura della ketubah e le sheva brachot — sette benedizioni — cantate su un calice di vino.",
        },
        {
          numeral: "V",
          name: "Rottura del bicchiere",
          sub: "Shevirat ha-kos",
          when: "Chiusura della cerimonia",
          body: "Lo sposo rompe un bicchiere con il piede, memoria mantenuta anche nella gioia. Gli invitati gridano «Mazel tov» e comincia la festa.",
        },
        {
          numeral: "VI",
          name: "Yichud",
          sub: "Ritiro",
          when: "Subito dopo",
          body: "Gli sposi novelli si ritirano da soli per un breve intervallo: i primi minuti di silenzio del matrimonio, prima che la sala sia affidata agli invitati.",
        },
        {
          numeral: "VII",
          name: "Hora e ricevimento",
          sub: "Celebrazione",
          when: "Di sera",
          body: "La coppia sollevata sulle sedie nella hora, poi la cena, le sheva brachot ripetute durante il pasto, i discorsi e un ballo che non finisce presto.",
        },
      ],
    },
    designConcepts: {
      ...
      cards: [
        ...
        },
        {
          ...
          rows: [
            ...
            {
              label: "Ideale per",
              value: "Rooftop · galleria · villa moderna",
            },
          ],
        },
      ],
    ...
    protocols: {
      ...
      items: [
        {
          title: "Mai di Shabbat",
          body: "I matrimoni ebraici non si tengono di Shabbat. Le cerimonie iniziano dopo il tramonto di sabato, oppure di domenica. Costruiamo l'intero calendario del fine settimana attorno all'ora reale del tramonto locale, non a un'approssimazione.",
        },
        {
          title: "La ketubah testimoniata come si deve",
          body: "La ketubah è firmata dai testimoni che il rabbino officiante richiede per la vostra tradizione. Confermiamo il testo, i testimoni e la lingua con il rabbino molto prima del giorno, mai il giorno stesso.",
        },
        {
          title: "La cucina kosher, sigillata e istruita",
          body: "Il catering kosher non è una scelta di menu; è un protocollo di cucina. Concordiamo una cucina sigillata con la struttura mesi prima, trasferiamo il nostro catering quando serve e istruiamo ogni membro del team della struttura.",
        },
        {
          title: "Il bicchiere rotto in sicurezza",
          body: "La rottura del bicchiere si prepara con un bicchiere avvolto e pre-inciso su una superficie protetta, perché l'istante sia intero e nessuno si faccia male. Rito e sicurezza non sono in contrasto.",
        },
        {
          title: "Il rabbino fissa l'ordine",
          body: "Dove le prassi ortodossa, conservatrice e riformata differiscono — la mechitza, i giri, il testo delle benedizioni — seguiamo l'indicazione del rabbino officiante e istruiamo la location di conseguenza.",
        },
        {
          title: "Le usanze si onorano, non si appiattiscono",
          body: "Mechitza e ballo separato per le famiglie osservanti; usanze egualitarie per altre. Chiediamo, in privato, ciò che la vostra famiglia custodisce, e non trattiamo un matrimonio ebraico come modello del successivo.",
        },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            ...
            {
              time: "Pomeriggio",
              body: "Tempo libero · attenzioni di benvenuto in ogni camera",
            },
            {
              time: "Prima del tramonto",
              body: "Accensione delle candele · inizia lo Shabbat (secondo il tramonto locale)",
            },
            {
              time: "Sera",
              body: "Cena di Shabbat · kiddush · pasto assistito al tavolo lungo",
            },
          ],
        },
        {
          ...
          events: [
            {
              time: "15:00",
              body: "Kabbalat Panim · due ricevimenti in parallelo",
            },
            {
              time: "16:00",
              body: "Firma della ketubah · testimoni · bedeken",
            },
            {
              time: "16:45",
              body: "Chuppah · anello · sheva brachot · rottura del bicchiere",
            },
            {
              time: "17:15",
              body: "Yichud · l'intervallo privato della coppia",
            },
            { time: "18:00", body: "Cocktail di ricevimento" },
            {
              time: "19:30",
              body: "Hora · cena · sheva brachot · discorsi · ballo",
            },
          ],
        },
        {
          ...
          events: [
            ...
            {
              time: "12:30",
              body: "Sheva brachot facoltative · sette benedizioni ripetute",
            },
    ...
    compatibility: {
      ...
      cards: [
        ...
        },
        {
          rating: 5,
          name: "Gli Hamptons",
          sub: "Stati Uniti · maggio – settembre",
          destinationSlug: "the-hamptons",
        },
        {
          rating: 5,
    ...
    guest: {
      ...
      cells: [
        {
          title: "Protocollo alimentare kosher",
          body: "Una cucina kosher sigillata concordata con la struttura, il nostro catering quando serve e pasti chiaramente segnalati durante il fine settimana. Opzioni kosher, vegetariane, vegane e senza allergeni a ogni servizio.",
        },
        {
          title: "Invitati osservanti dello Shabbat",
          body: "Camere vicine alla location perché nessuno debba guidare, schede magnetiche e illuminazione predisposte in anticipo, pasti calibrati sull'accensione delle candele e un programma compatibile con lo Shabbat per chi lo osserva.",
        },
        {
          title: "Anziani & mobilità",
          body: "Posti riservati, trasporto a parte, camere al piano terra per gli invitati più anziani e un referente dell'atelier per tutto il fine settimana. Medico reperibile per l'intera durata.",
        },
        {
          title: "Viaggi & blocchi di camere",
          body: "Blocchi di camere su tre livelli, transfer aeroportuali nei giorni di arrivo e pacchetti di benvenuto in ogni camera con il programma, il dress code per evento e i contatti chiave.",
        },
        {
          title: "Abbigliamento & kippot",
          body: "Kippot a disposizione degli invitati alla chuppah, un tallit pronto quando la cerimonia lo richiede e servizio di stiratura in hotel per l'arrivo e la mattina del matrimonio.",
        },
        {
          title: "Comunicazioni",
          body: "Un gruppo invitati tre settimane prima, un sito del matrimonio con il programma, i dress code e le mappe della location, e guide stampate — inclusa una breve nota per chi assiste per la prima volta a un matrimonio ebraico.",
        },
      ],
    },
    related: {
      ...
      articles: [
        {
          category: "Matrimoni Ebraici · Kosher",
          title: "Come funziona davvero il catering kosher all'estero",
          body: "Su cucine sigillate, catering trasferito e le conversazioni con la struttura che devono avvenire mesi prima.",
          imageKey: "culture-related-1",
        },
        {
          category: "Tradizione",
          title: "La chuppah, nel dettaglio",
          body: "Aperta su tutti i lati, tenuta sopra la coppia: una breve guida al baldacchino e al suo significato.",
          imageKey: "culture-related-2",
        },
        {
          category: "Pianificazione · Shabbat",
          title:
            "Pianificare un matrimonio di destinazione attorno allo Shabbat",
          body: "Perché è il tramonto locale, non il calendario, a fissare il fine settimana — e come costruiamo a partire da lì.",
          imageKey: "culture-related-3",
        },
        {
          category: "Interreligioso",
          title: "Matrimoni ebraici interreligiosi, tenuti interi",
          body: "Due celebranti, due tradizioni, una giornata coesa, senza diluire nessuna delle due parti.",
          imageKey: "culture-related-4",
        },
        {
          category: "Costo · Ebraico",
          title: "Quanto costa davvero un matrimonio ebraico di lusso",
          body: "Budget franchi 2026 per numero di invitati, incluso il costo di portarsi la cucina.",
          imageKey: "culture-related-5",
        },
      ],
      sidebarDestinations: [
    ...
    faq: {
      ...
      items: [
        ...
        {
          question:
            "Qual è il costo tipico di un matrimonio ebraico di destinazione?",
          answer: [
