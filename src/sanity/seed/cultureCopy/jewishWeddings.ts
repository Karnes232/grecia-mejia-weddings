...
export const jewishWeddings: Record<Locale, CultureCopy> = {
  en: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "St. Barths", sub: "Caribbean · November – April", imageKey: "compat-1", destinationHref: destinationPath("en", "st-barths") },
        { rating: 5, name: "The Hamptons", sub: "United States · May – September", imageKey: "compat-2", destinationHref: destinationPath("en", "the-hamptons") },
        { rating: 5, name: "Lake Como", sub: "Italy · June – September", imageKey: "compat-3", destinationHref: destinationPath("en", "lake-como") },
        { rating: 4, name: "Amalfi", sub: "Italy · May – October", imageKey: "compat-4", destinationHref: destinationPath("en", "amalfi") },
        ...
        { rating: 4, name: "Mustique", sub: "Caribbean · November – April", imageKey: "compat-7", destinationHref: destinationPath("en", "mustique") },
        { rating: 3, name: "Aspen & Napa", sub: "United States · seasonal", imageKey: "compat-8", destinationHref: destinationPath("en", "aspen-napa") },
      ],
    },
    guest: {
  ...
  es: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "St. Barths", sub: "Caribe · noviembre – abril", imageKey: "compat-1", destinationHref: destinationPath("es", "st-barths") },
        { rating: 5, name: "Los Hamptons", sub: "Estados Unidos · mayo – septiembre", imageKey: "compat-2", destinationHref: destinationPath("es", "the-hamptons") },
        { rating: 5, name: "Lago de Como", sub: "Italia · junio – septiembre", imageKey: "compat-3", destinationHref: destinationPath("es", "lake-como") },
        { rating: 4, name: "Amalfi", sub: "Italia · mayo – octubre", imageKey: "compat-4", destinationHref: destinationPath("es", "amalfi") },
        ...
        { rating: 4, name: "Mustique", sub: "Caribe · noviembre – abril", imageKey: "compat-7", destinationHref: destinationPath("es", "mustique") },
        { rating: 3, name: "Aspen y Napa", sub: "Estados Unidos · por temporada", imageKey: "compat-8", destinationHref: destinationPath("es", "aspen-napa") },
      ],
    },
    guest: {
  ...
  fr: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "St. Barths", sub: "Caraïbes · novembre – avril", imageKey: "compat-1", destinationHref: destinationPath("fr", "st-barths") },
        { rating: 5, name: "Les Hamptons", sub: "États-Unis · mai – septembre", imageKey: "compat-2", destinationHref: destinationPath("fr", "the-hamptons") },
        { rating: 5, name: "Lac de Côme", sub: "Italie · juin – septembre", imageKey: "compat-3", destinationHref: destinationPath("fr", "lake-como") },
        { rating: 4, name: "Amalfi", sub: "Italie · mai – octobre", imageKey: "compat-4", destinationHref: destinationPath("fr", "amalfi") },
        ...
        { rating: 4, name: "Mustique", sub: "Caraïbes · novembre – avril", imageKey: "compat-7", destinationHref: destinationPath("fr", "mustique") },
        { rating: 3, name: "Aspen & Napa", sub: "États-Unis · selon la saison", imageKey: "compat-8", destinationHref: destinationPath("fr", "aspen-napa") },
      ],
    },
    guest: {
  ...
  pt: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "St. Barths", sub: "Caraíbas · novembro – abril", imageKey: "compat-1", destinationHref: destinationPath("pt", "st-barths") },
        { rating: 5, name: "Os Hamptons", sub: "Estados Unidos · maio – setembro", imageKey: "compat-2", destinationHref: destinationPath("pt", "the-hamptons") },
        { rating: 5, name: "Lago de Como", sub: "Itália · junho – setembro", imageKey: "compat-3", destinationHref: destinationPath("pt", "lake-como") },
        { rating: 4, name: "Amalfi", sub: "Itália · maio – outubro", imageKey: "compat-4", destinationHref: destinationPath("pt", "amalfi") },
        { rating: 4, name: "Toscana", sub: "Itália · maio – outubro", imageKey: "compat-5", destinationHref: destinationPath("pt", "tuscany") },
        { rating: 4, name: "Costa Azul", sub: "França · junho – setembro", imageKey: "compat-6", destinationHref: destinationPath("pt", "cote-dazur") },
        { rating: 4, name: "Mustique", sub: "Caraíbas · novembro – abril", imageKey: "compat-7", destinationHref: destinationPath("pt", "mustique") },
        { rating: 3, name: "Aspen & Napa", sub: "Estados Unidos · sazonal", imageKey: "compat-8", destinationHref: destinationPath("pt", "aspen-napa") },
      ],
    },
    guest: {
  ...
  de: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "St. Barths", sub: "Karibik · November – April", imageKey: "compat-1", destinationHref: destinationPath("de", "st-barths") },
        { rating: 5, name: "Die Hamptons", sub: "USA · Mai – September", imageKey: "compat-2", destinationHref: destinationPath("de", "the-hamptons") },
        { rating: 5, name: "Comer See", sub: "Italien · Juni – September", imageKey: "compat-3", destinationHref: destinationPath("de", "lake-como") },
        { rating: 4, name: "Amalfi", sub: "Italien · Mai – Oktober", imageKey: "compat-4", destinationHref: destinationPath("de", "amalfi") },
        ...
        { rating: 4, name: "Mustique", sub: "Karibik · November – April", imageKey: "compat-7", destinationHref: destinationPath("de", "mustique") },
        { rating: 3, name: "Aspen & Napa", sub: "USA · saisonal", imageKey: "compat-8", destinationHref: destinationPath("de", "aspen-napa") },
      ],
    },
    guest: {
  ...
  it: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "St. Barths", sub: "Caraibi · novembre – aprile", imageKey: "compat-1", destinationHref: destinationPath("it", "st-barths") },
        { rating: 5, name: "Gli Hamptons", sub: "Stati Uniti · maggio – settembre", imageKey: "compat-2", destinationHref: destinationPath("it", "the-hamptons") },
        { rating: 5, name: "Lago di Como", sub: "Italia · giugno – settembre", imageKey: "compat-3", destinationHref: destinationPath("it", "lake-como") },
        { rating: 4, name: "Amalfi", sub: "Italia · maggio – ottobre", imageKey: "compat-4", destinationHref: destinationPath("it", "amalfi") },
        ...
        { rating: 4, name: "Mustique", sub: "Caraibi · novembre – aprile", imageKey: "compat-7", destinationHref: destinationPath("it", "mustique") },
        { rating: 3, name: "Aspen & Napa", sub: "Stati Uniti · stagionale", imageKey: "compat-8", destinationHref: destinationPath("it", "aspen-napa") },
      ],
    },
    guest: {
