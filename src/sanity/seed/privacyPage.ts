...
const COPY: Record<Locale, Copy> = {
  en: {
    ...
    sections: [
      section("Who we are", [
        p("Grecia Mejía Weddings (\"the studio,\" \"we,\" \"us\") is a luxury wedding planning practice registered in the Dominican Republic, with studios in Punta Cana and Milan. We curate destination and multicultural weddings worldwide."),
        p("This policy explains what personal information we collect when you contact us or use **greciamejia.com**, how we use it, and the rights you hold over it. We are the data controller responsible for your information."),
      ]),
      section("Information we collect", [
        p("We collect only what we need to respond to an enquiry and, where you become a client, to plan your wedding. This includes:"),
        ...bullets([
        ...
        p("We do not knowingly collect information from anyone under the age of eighteen, and we never purchase or rent contact lists."),
      ]),
      section("How we use your information", [
        ...
        p("We will never use your wedding details, photographs or story for marketing or press without your explicit, written permission."),
      ]),
      section("The legal basis", [
        p("We process your information on the following bases: **consent** (when you submit an enquiry), **contract** (when you engage the studio to plan your wedding), and **legitimate interest** (to operate the studio and respond to you). You may withdraw consent at any time."),
      ]),
      section("Who we share it with", [
        p("We are a small studio and we treat your information as privately as we treat your wedding. We share it only where necessary:"),
        ...bullets([
        ...
        callout("We never sell your personal information. We never share it with advertisers. Your wedding is not content unless you decide it is."),
      ]),
      section("International transfers", [
        p("Because we plan weddings across continents, your information may be processed in the Dominican Republic, the European Union, and the country of your wedding. Wherever it travels, we apply the same standard of care described in this policy and use appropriate safeguards for any transfer."),
      ]),
      section("How long we keep it", [
        p("If you enquire but do not become a client, we keep your correspondence for up to **twenty-four months**, then delete it. If you become a client, we keep your records for the duration of the engagement and for up to **seven years** afterward, to meet legal and accounting obligations. You may ask us to delete your information sooner, subject to those obligations."),
      ]),
      section("Your rights", [
        p("You hold the following rights over your personal information, and we will honour any request within thirty days:"),
        ...bullets([
        ...
        p("To exercise any of these, write to [privacy@greciamejia.com](mailto:privacy@greciamejia.com)."),
      ]),
      section("Cookies & analytics", [
        p("Our website uses a minimal set of cookies — those strictly necessary for the site to function, and anonymised analytics to understand how the site is used. We do not use advertising or tracking cookies. You can disable cookies in your browser settings without losing access to the site."),
      ]),
      section("Security", [
        p("We protect your information with encrypted storage, access controls limited to the studio team, and secure communication tools. No system is perfectly secure, but we treat your details with the same discretion we bring to every wedding, and we will notify you promptly of any breach that affects you."),
      ]),
      section("Changes & contact", [
        p("We may update this policy from time to time. The \"last updated\" date at the top of this page always reflects the current version. Material changes will be communicated to active clients directly."),
        p("For any question about your privacy, write to [privacy@greciamejia.com](mailto:privacy@greciamejia.com) or reach the studio through our [contact page](/contact). Grecia or a member of the team will respond personally."),
      ]),
    ],
  },
  ...
  es: {
    ...
    sections: [
      section("Quiénes somos", [
        p("Grecia Mejía Weddings («el estudio», «nosotros») es una práctica de planificación de bodas de lujo registrada en la República Dominicana, con estudios en Punta Cana y Milán. Curamos bodas de destino y multiculturales en todo el mundo."),
        p("Esta política explica qué información personal recopilamos cuando nos contactas o usas **greciamejia.com**, cómo la utilizamos y los derechos que tienes sobre ella. Somos el responsable del tratamiento de tu información."),
      ]),
      section("Información que recopilamos", [
        p("Recopilamos solo lo que necesitamos para responder a una solicitud y, cuando te conviertes en cliente, para planificar tu boda. Esto incluye:"),
        ...bullets([
        ...
        p("No recopilamos a sabiendas información de personas menores de dieciocho años, y nunca compramos ni alquilamos listas de contactos."),
      ]),
      section("Cómo usamos tu información", [
        p("Tu información se utiliza para un conjunto pequeño y definido de fines:"),
        ...bullets([
        ...
        p("Nunca usaremos los detalles, las fotografías o la historia de tu boda con fines de marketing o prensa sin tu permiso explícito por escrito."),
      ]),
      section("La base jurídica", [
        p("Tratamos tu información sobre las siguientes bases: **consentimiento** (cuando envías una solicitud), **contrato** (cuando contratas al estudio para planificar tu boda) e **interés legítimo** (para operar el estudio y responderte). Puedes retirar el consentimiento en cualquier momento."),
      ]),
      section("Con quién la compartimos", [
        p("Somos un estudio pequeño y tratamos tu información con la misma privacidad con la que tratamos tu boda. Solo la compartimos cuando es necesario:"),
        ...bullets([
        ...
        callout("Nunca vendemos tu información personal. Nunca la compartimos con anunciantes. Tu boda no es contenido, a menos que tú lo decidas."),
      ]),
      section("Transferencias internacionales", [
        p("Como planificamos bodas en distintos continentes, tu información puede tratarse en la República Dominicana, la Unión Europea y el país de tu boda. Dondequiera que viaje, aplicamos el mismo estándar de cuidado descrito en esta política y usamos las garantías adecuadas para cualquier transferencia."),
      ]),
      section("Cuánto tiempo la conservamos", [
        p("Si nos escribes pero no te conviertes en cliente, conservamos tu correspondencia hasta **veinticuatro meses** y luego la eliminamos. Si te conviertes en cliente, conservamos tus registros durante el encargo y hasta **siete años** después, para cumplir obligaciones legales y contables. Puedes pedirnos que eliminemos tu información antes, con sujeción a esas obligaciones."),
      ]),
      section("Tus derechos", [
        p("Tienes los siguientes derechos sobre tu información personal, y atenderemos cualquier solicitud en un plazo de treinta días:"),
        ...bullets([
      ...
      section("Cambios y contacto", [
        p("Podemos actualizar esta política de vez en cuando. La fecha de «última actualización» en la parte superior de esta página siempre refleja la versión vigente. Los cambios sustanciales se comunicarán directamente a los clientes activos."),
        p("Para cualquier pregunta sobre tu privacidad, escribe a [privacy@greciamejia.com](mailto:privacy@greciamejia.com) o contacta con el estudio a través de nuestra [página de contacto](/contact). Grecia o un miembro del equipo te responderá personalmente."),
      ]),
    ],
  },
  ...
  fr: {
    ...
    sections: [
      section("Qui nous sommes", [
        p("Grecia Mejía Weddings (« le studio », « nous ») est une maison de planification de mariages de luxe enregistrée en République dominicaine, avec des studios à Punta Cana et à Milan. Nous concevons des mariages de destination et multiculturels dans le monde entier."),
        p("Cette politique explique quelles informations personnelles nous collectons lorsque vous nous contactez ou utilisez **greciamejia.com**, comment nous les utilisons et les droits que vous détenez sur elles. Nous sommes le responsable du traitement de vos informations."),
      ]),
      section("Les informations que nous collectons", [
        p("Nous ne collectons que ce dont nous avons besoin pour répondre à une demande et, lorsque vous devenez client, pour organiser votre mariage. Cela comprend :"),
        ...bullets([
        ...
        p("Nous ne collectons pas sciemment d'informations auprès de personnes de moins de dix-huit ans, et nous n'achetons ni ne louons jamais de listes de contacts."),
      ]),
      section("Comment nous utilisons vos informations", [
        p("Vos informations sont utilisées à un petit ensemble de fins définies :"),
        ...bullets([
        ...
        p("Nous n'utiliserons jamais les détails, les photographies ou l'histoire de votre mariage à des fins de marketing ou de presse sans votre autorisation écrite explicite."),
      ]),
      section("La base légale", [
        p("Nous traitons vos informations sur les bases suivantes : **consentement** (lorsque vous soumettez une demande), **contrat** (lorsque vous engagez le studio pour organiser votre mariage) et **intérêt légitime** (pour exploiter le studio et vous répondre). Vous pouvez retirer votre consentement à tout moment."),
      ]),
      section("Avec qui nous les partageons", [
        p("Nous sommes un petit studio et nous traitons vos informations aussi discrètement que votre mariage. Nous ne les partageons que lorsque c'est nécessaire :"),
        ...bullets([
        ...
        callout("Nous ne vendons jamais vos informations personnelles. Nous ne les partageons jamais avec des annonceurs. Votre mariage n'est pas un contenu, sauf si vous en décidez ainsi."),
      ]),
      section("Transferts internationaux", [
        p("Parce que nous organisons des mariages sur plusieurs continents, vos informations peuvent être traitées en République dominicaine, dans l'Union européenne et dans le pays de votre mariage. Où qu'elles voyagent, nous appliquons le même standard de soin décrit dans cette politique et utilisons des garanties appropriées pour tout transfert."),
      ]),
      section("Combien de temps nous les conservons", [
        p("Si vous nous contactez sans devenir client, nous conservons votre correspondance jusqu'à **vingt-quatre mois**, puis nous la supprimons. Si vous devenez client, nous conservons vos dossiers pendant la durée de l'engagement et jusqu'à **sept ans** après, pour respecter nos obligations légales et comptables. Vous pouvez nous demander de supprimer vos informations plus tôt, sous réserve de ces obligations."),
      ]),
      section("Vos droits", [
        p("Vous détenez les droits suivants sur vos informations personnelles, et nous honorerons toute demande sous trente jours :"),
        ...bullets([
        ...
        p("Pour exercer l'un de ces droits, écrivez à [privacy@greciamejia.com](mailto:privacy@greciamejia.com)."),
      ]),
      ...
      section("Sécurité", [
        p("Nous protégeons vos informations par un stockage chiffré, des contrôles d'accès limités à l'équipe du studio et des outils de communication sécurisés. Aucun système n'est parfaitement sûr, mais nous traitons vos données avec la discrétion que nous apportons à chaque mariage, et nous vous informerons rapidement de toute violation qui vous concerne."),
      ]),
      section("Modifications & contact", [
        p("Nous pouvons mettre à jour cette politique de temps à autre. La date de « dernière mise à jour » en haut de cette page reflète toujours la version actuelle. Les changements importants seront communiqués directement aux clients actifs."),
        p("Pour toute question sur votre confidentialité, écrivez à [privacy@greciamejia.com](mailto:privacy@greciamejia.com) ou contactez le studio via notre [page de contact](/contact). Grecia ou un membre de l'équipe vous répondra personnellement."),
      ]),
    ],
  },
  ...
  pt: {
    ...
    sections: [
      section("Quem somos", [
        p("A Grecia Mejía Weddings («o estúdio», «nós») é uma prática de planeamento de casamentos de luxo registada na República Dominicana, com estúdios em Punta Cana e Milão. Curamos casamentos de destino e multiculturais em todo o mundo."),
        p("Esta política explica que informações pessoais recolhemos quando nos contacta ou utiliza **greciamejia.com**, como as utilizamos e os direitos que tem sobre elas. Somos o responsável pelo tratamento das suas informações."),
      ]),
      section("Informações que recolhemos", [
        p("Recolhemos apenas o que precisamos para responder a um pedido e, quando se torna cliente, para planear o seu casamento. Isto inclui:"),
        ...bullets([
        ...
        p("Não recolhemos conscientemente informações de pessoas com menos de dezoito anos, e nunca compramos nem alugamos listas de contactos."),
      ]),
      section("Como utilizamos as suas informações", [
        p("As suas informações são utilizadas para um conjunto pequeno e definido de finalidades:"),
        ...bullets([
        ...
        p("Nunca utilizaremos os detalhes, as fotografias ou a história do seu casamento para fins de marketing ou imprensa sem a sua autorização explícita por escrito."),
      ]),
      section("A base jurídica", [
        p("Tratamos as suas informações com as seguintes bases: **consentimento** (quando envia um pedido), **contrato** (quando contrata o estúdio para planear o seu casamento) e **interesse legítimo** (para operar o estúdio e responder-lhe). Pode retirar o consentimento a qualquer momento."),
      ]),
      section("Com quem as partilhamos", [
        p("Somos um estúdio pequeno e tratamos as suas informações com a mesma privacidade com que tratamos o seu casamento. Só as partilhamos quando necessário:"),
        ...bullets([
      ...
      section("Os seus direitos", [
        ...
        p("Para exercer qualquer um destes, escreva para [privacy@greciamejia.com](mailto:privacy@greciamejia.com)."),
      ]),
      section("Cookies e análise", [
        p("O nosso site utiliza um conjunto mínimo de cookies — os estritamente necessários para o funcionamento do site e análises anonimizadas para compreender como é utilizado. Não utilizamos cookies de publicidade ou de rastreio. Pode desativar os cookies nas definições do seu navegador sem perder o acesso ao site."),
      ]),
      section("Segurança", [
        p("Protegemos as suas informações com armazenamento encriptado, controlos de acesso limitados à equipa do estúdio e ferramentas de comunicação seguras. Nenhum sistema é perfeitamente seguro, mas tratamos os seus dados com a mesma discrição que levamos a cada casamento, e notificá-lo-emos prontamente de qualquer violação que o afete."),
      ]),
      section("Alterações e contacto", [
        p("Podemos atualizar esta política de tempos a tempos. A data de «última atualização» no topo desta página reflete sempre a versão atual. As alterações substanciais serão comunicadas diretamente aos clientes ativos."),
        p("Para qualquer questão sobre a sua privacidade, escreva para [privacy@greciamejia.com](mailto:privacy@greciamejia.com) ou contacte o estúdio através da nossa [página de contacto](/contact). A Grecia ou um membro da equipa responderá pessoalmente."),
      ]),
    ],
  },
  ...
  de: {
    ...
    sections: [
      section("Wer wir sind", [
        p("Grecia Mejía Weddings („das Studio“, „wir“, „uns“) ist eine in der Dominikanischen Republik registrierte Praxis für luxuriöse Hochzeitsplanung mit Studios in Punta Cana und Mailand. Wir kuratieren Destination- und multikulturelle Hochzeiten weltweit."),
        p("Diese Erklärung erläutert, welche personenbezogenen Daten wir erheben, wenn Sie uns kontaktieren oder **greciamejia.com** nutzen, wie wir sie verwenden und welche Rechte Sie daran haben. Wir sind der für Ihre Daten Verantwortliche."),
      ]),
      section("Welche Daten wir erheben", [
        p("Wir erheben nur, was wir benötigen, um auf eine Anfrage zu antworten und — wenn Sie Kunde werden — Ihre Hochzeit zu planen. Dazu gehören:"),
        ...bullets([
        ...
        p("Wir erheben nicht wissentlich Daten von Personen unter achtzehn Jahren, und wir kaufen oder mieten niemals Kontaktlisten."),
      ]),
      section("Wie wir Ihre Daten verwenden", [
        p("Ihre Daten werden für eine kleine, klar definierte Reihe von Zwecken verwendet:"),
        ...bullets([
        ...
        p("Wir werden die Details, Fotografien oder die Geschichte Ihrer Hochzeit niemals ohne Ihre ausdrückliche schriftliche Erlaubnis für Marketing oder Presse verwenden."),
      ]),
      section("Die Rechtsgrundlage", [
        p("Wir verarbeiten Ihre Daten auf folgenden Grundlagen: **Einwilligung** (wenn Sie eine Anfrage senden), **Vertrag** (wenn Sie das Studio mit der Planung Ihrer Hochzeit beauftragen) und **berechtigtes Interesse** (um das Studio zu betreiben und Ihnen zu antworten). Sie können Ihre Einwilligung jederzeit widerrufen."),
      ]),
      section("Mit wem wir sie teilen", [
        p("Wir sind ein kleines Studio und behandeln Ihre Daten so privat wie Ihre Hochzeit. Wir teilen sie nur, wenn es notwendig ist:"),
        ...bullets([
      ...
      section("Ihre Rechte", [
        ...
        p("Um eines dieser Rechte auszuüben, schreiben Sie an [privacy@greciamejia.com](mailto:privacy@greciamejia.com)."),
      ]),
      section("Cookies & Statistiken", [
        p("Unsere Website verwendet ein Minimum an Cookies — die für den Betrieb der Website unbedingt erforderlichen und anonymisierte Statistiken, um die Nutzung zu verstehen. Wir verwenden keine Werbe- oder Tracking-Cookies. Sie können Cookies in Ihren Browsereinstellungen deaktivieren, ohne den Zugang zur Website zu verlieren."),
      ]),
      section("Sicherheit", [
      ...
      section("Änderungen & Kontakt", [
        p("Wir können diese Erklärung von Zeit zu Zeit aktualisieren. Das Datum „zuletzt aktualisiert“ oben auf dieser Seite spiegelt stets die aktuelle Fassung wider. Wesentliche Änderungen werden aktiven Kunden direkt mitgeteilt."),
        p("Bei Fragen zu Ihrem Datenschutz schreiben Sie an [privacy@greciamejia.com](mailto:privacy@greciamejia.com) oder erreichen Sie das Studio über unsere [Kontaktseite](/contact). Grecia oder ein Mitglied des Teams antwortet persönlich."),
      ]),
    ],
  },
  ...
  it: {
    ...
    sections: [
      section("Chi siamo", [
        p("Grecia Mejía Weddings («lo studio», «noi») è una pratica di wedding planning di lusso registrata nella Repubblica Dominicana, con studi a Punta Cana e Milano. Curiamo matrimoni di destinazione e multiculturali in tutto il mondo."),
        p("Questa informativa spiega quali informazioni personali raccogliamo quando ci contatti o utilizzi **greciamejia.com**, come le utilizziamo e i diritti che detieni su di esse. Siamo il titolare del trattamento delle tue informazioni."),
      ]),
      section("Le informazioni che raccogliamo", [
        p("Raccogliamo solo ciò di cui abbiamo bisogno per rispondere a una richiesta e, quando diventi cliente, per organizzare il tuo matrimonio. Questo include:"),
        ...bullets([
        ...
        p("Non raccogliamo consapevolmente informazioni da persone di età inferiore ai diciotto anni, e non acquistiamo né noleggiamo mai liste di contatti."),
      ]),
      section("Come utilizziamo le tue informazioni", [
        p("Le tue informazioni sono utilizzate per un insieme ristretto e definito di finalità:"),
        ...bullets([
        ...
        p("Non utilizzeremo mai i dettagli, le fotografie o la storia del tuo matrimonio per marketing o stampa senza il tuo esplicito permesso scritto."),
      ]),
      section("La base giuridica", [
        p("Trattiamo le tue informazioni sulle seguenti basi: **consenso** (quando invii una richiesta), **contratto** (quando incarichi lo studio di organizzare il tuo matrimonio) e **legittimo interesse** (per gestire lo studio e risponderti). Puoi revocare il consenso in qualsiasi momento."),
      ]),
      section("Con chi le condividiamo", [
        p("Siamo uno studio piccolo e trattiamo le tue informazioni con la stessa riservatezza con cui trattiamo il tuo matrimonio. Le condividiamo solo quando necessario:"),
        ...bullets([
        ...
        callout("Non vendiamo mai le tue informazioni personali. Non le condividiamo mai con inserzionisti. Il tuo matrimonio non è contenuto, a meno che non lo decida tu."),
      ]),
      section("Trasferimenti internazionali", [
        p("Poiché organizziamo matrimoni tra continenti, le tue informazioni possono essere trattate nella Repubblica Dominicana, nell'Unione Europea e nel paese del tuo matrimonio. Ovunque viaggino, applichiamo lo stesso standard di cura descritto in questa informativa e utilizziamo garanzie adeguate per ogni trasferimento."),
      ]),
      section("Per quanto tempo le conserviamo", [
        p("Se ci contatti ma non diventi cliente, conserviamo la tua corrispondenza fino a **ventiquattro mesi**, poi la eliminiamo. Se diventi cliente, conserviamo i tuoi dati per la durata dell'incarico e fino a **sette anni** dopo, per adempiere agli obblighi legali e contabili. Puoi chiederci di eliminare le tue informazioni prima, fatti salvi tali obblighi."),
      ]),
      section("I tuoi diritti", [
        p("Detieni i seguenti diritti sulle tue informazioni personali, e onoreremo ogni richiesta entro trenta giorni:"),
        ...bullets([
        ...
        p("Per esercitare uno di questi diritti, scrivi a [privacy@greciamejia.com](mailto:privacy@greciamejia.com)."),
      ]),
      section("Cookie e analisi", [
        p("Il nostro sito utilizza un insieme minimo di cookie — quelli strettamente necessari al funzionamento del sito e analisi anonimizzate per capire come viene utilizzato. Non utilizziamo cookie pubblicitari o di tracciamento. Puoi disattivare i cookie nelle impostazioni del tuo browser senza perdere l'accesso al sito."),
      ]),
      section("Sicurezza", [
        p("Proteggiamo le tue informazioni con archiviazione crittografata, controlli di accesso limitati al team dello studio e strumenti di comunicazione sicuri. Nessun sistema è perfettamente sicuro, ma trattiamo i tuoi dati con la stessa discrezione che portiamo a ogni matrimonio, e ti notificheremo tempestivamente qualsiasi violazione che ti riguardi."),
      ]),
      section("Modifiche e contatto", [
        p("Possiamo aggiornare questa informativa di tanto in tanto. La data di «ultimo aggiornamento» in cima a questa pagina riflette sempre la versione attuale. Le modifiche sostanziali saranno comunicate direttamente ai clienti attivi."),
        p("Per qualsiasi domanda sulla tua privacy, scrivi a [privacy@greciamejia.com](mailto:privacy@greciamejia.com) o contatta lo studio tramite la nostra [pagina di contatto](/contact). Grecia o un membro del team risponderà di persona."),
      ]),
    ],
  },
};
