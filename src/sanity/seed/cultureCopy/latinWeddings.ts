...
export const latinWeddings: Record<Locale, CultureCopy> = {
  ...
  en: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "Punta Cana", sub: "Dominican Republic · year-round", imageKey: "compat-1", destinationHref: destinationPath("en", "punta-cana") },
        ...
        { rating: 4, name: "St. Barths", sub: "Caribbean · November – April", imageKey: "compat-3", destinationHref: destinationPath("en", "st-barths") },
        { rating: 4, name: "Mustique", sub: "Caribbean · December – April", imageKey: "compat-4", destinationHref: destinationPath("en", "mustique") },
        { rating: 4, name: "Tuscany", sub: "Italy · May – October", imageKey: "compat-5", destinationHref: destinationPath("en", "tuscany") },
        { rating: 4, name: "Amalfi Coast", sub: "Italy · May – October", imageKey: "compat-6", destinationHref: destinationPath("en", "amalfi") },
  ...
  es: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "Punta Cana", sub: "República Dominicana · todo el año", imageKey: "compat-1", destinationHref: destinationPath("es", "punta-cana") },
        ...
        { rating: 4, name: "St. Barths", sub: "Caribe · noviembre – abril", imageKey: "compat-3", destinationHref: destinationPath("es", "st-barths") },
        { rating: 4, name: "Mustique", sub: "Caribe · diciembre – abril", imageKey: "compat-4", destinationHref: destinationPath("es", "mustique") },
        { rating: 4, name: "Toscana", sub: "Italia · mayo – octubre", imageKey: "compat-5", destinationHref: destinationPath("es", "tuscany") },
        { rating: 4, name: "Costa de Amalfi", sub: "Italia · mayo – octubre", imageKey: "compat-6", destinationHref: destinationPath("es", "amalfi") },
  ...
  fr: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "Punta Cana", sub: "République dominicaine · toute l'année", imageKey: "compat-1", destinationHref: destinationPath("fr", "punta-cana") },
        ...
        { rating: 4, name: "St. Barths", sub: "Caraïbes · novembre – avril", imageKey: "compat-3", destinationHref: destinationPath("fr", "st-barths") },
        { rating: 4, name: "Mustique", sub: "Caraïbes · décembre – avril", imageKey: "compat-4", destinationHref: destinationPath("fr", "mustique") },
        { rating: 4, name: "Toscane", sub: "Italie · mai – octobre", imageKey: "compat-5", destinationHref: destinationPath("fr", "tuscany") },
        { rating: 4, name: "Côte amalfitaine", sub: "Italie · mai – octobre", imageKey: "compat-6", destinationHref: destinationPath("fr", "amalfi") },
  ...
  pt: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "Punta Cana", sub: "República Dominicana · todo o ano", imageKey: "compat-1", destinationHref: destinationPath("pt", "punta-cana") },
        ...
        { rating: 4, name: "St. Barths", sub: "Caraíbas · novembro – abril", imageKey: "compat-3", destinationHref: destinationPath("pt", "st-barths") },
        { rating: 4, name: "Mustique", sub: "Caraíbas · dezembro – abril", imageKey: "compat-4", destinationHref: destinationPath("pt", "mustique") },
        { rating: 4, name: "Toscana", sub: "Itália · maio – outubro", imageKey: "compat-5", destinationHref: destinationPath("pt", "tuscany") },
        { rating: 4, name: "Costa Amalfitana", sub: "Itália · maio – outubro", imageKey: "compat-6", destinationHref: destinationPath("pt", "amalfi") },
  ...
  de: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "Punta Cana", sub: "Dominikanische Republik · ganzjährig", imageKey: "compat-1", destinationHref: destinationPath("de", "punta-cana") },
        ...
        { rating: 4, name: "St. Barths", sub: "Karibik · November – April", imageKey: "compat-3", destinationHref: destinationPath("de", "st-barths") },
        { rating: 4, name: "Mustique", sub: "Karibik · Dezember – April", imageKey: "compat-4", destinationHref: destinationPath("de", "mustique") },
        { rating: 4, name: "Toskana", sub: "Italien · Mai – Oktober", imageKey: "compat-5", destinationHref: destinationPath("de", "tuscany") },
        { rating: 4, name: "Amalfiküste", sub: "Italien · Mai – Oktober", imageKey: "compat-6", destinationHref: destinationPath("de", "amalfi") },
  ...
  it: {
    ...
    compatibility: {
      ...
      cards: [
        { rating: 5, name: "Punta Cana", sub: "Repubblica Dominicana · tutto l'anno", imageKey: "compat-1", destinationHref: destinationPath("it", "punta-cana") },
        ...
        { rating: 4, name: "St. Barths", sub: "Caraibi · novembre – aprile", imageKey: "compat-3", destinationHref: destinationPath("it", "st-barths") },
        { rating: 4, name: "Mustique", sub: "Caraibi · dicembre – aprile", imageKey: "compat-4", destinationHref: destinationPath("it", "mustique") },
        { rating: 4, name: "Toscana", sub: "Italia · maggio – ottobre", imageKey: "compat-5", destinationHref: destinationPath("it", "tuscany") },
        { rating: 4, name: "Costiera Amalfitana", sub: "Italia · maggio – ottobre", imageKey: "compat-6", destinationHref: destinationPath("it", "amalfi") },
