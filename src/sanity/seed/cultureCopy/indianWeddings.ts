...
export const indianWeddings: Record<Locale, CultureCopy> = {
  en: {
    ...
    factStrip: [
      ...
      { label: "Lead time", value: "18 – 24 months", sub: "Specialists book early" },
      { label: "Common regions", value: "Punjab · Gujarat", sub: "Tamil · Bengali · Sikh" },
    ...
    ceremonyArc: {
      ...
      steps: [
        { numeral: "I", name: "Mehndi", sub: "Henna night", when: "Day 1 evening", body: "Hands and feet decorated with intricate henna. Music, dancing, an informal gathering of the women." },
        { numeral: "II", name: "Haldi", sub: "Turmeric ceremony", when: "Day 2 morning", body: "Bride and groom anointed with turmeric paste by family. Often held separately, in white." },
        { numeral: "III", name: "Sangeet", sub: "Music & performances", when: "Day 2 evening", body: "Choreographed performances by both families. The most theatrical evening of the week." },
        { numeral: "IV", name: "Baraat", sub: "Groom's procession", when: "Day 3 morning", body: "The groom arrives on horseback or in a vintage car, accompanied by dhol drummers and dancing family." },
        { numeral: "V", name: "Varmala", sub: "Garland exchange", when: "Day 3 morning", body: "Bride and groom exchange floral garlands at the mandap to accept each other." },
        { numeral: "VI", name: "Pheras", sub: "Seven sacred steps", when: "Day 3 morning", body: "The couple circles the sacred fire seven times, each circle a vow. The legal Hindu wedding." },
        { numeral: "VII", name: "Reception", sub: "Celebration dinner", when: "Day 3 evening", body: "Black-tie reception, long-table dinner, the final speeches and the first dance." },
      ],
    },
    designConcepts: {
    ...
    protocols: {
      ...
      items: [
        { title: "Ritual order is not negotiable", body: "The pheras come before the reception. The baraat does not begin without the bride's family welcoming the groom. We do not reorder ceremonies for venue convenience or pacing concerns." },
        { title: "The pandit chooses the timings", body: "Sacred timings (muhurat) are calculated by the pandit using the couple's charts. We schedule the wedding around them — not the other way around." },
        { title: "Elders eat first", body: "Vegetarian and Jain dietary requirements are accommodated for elders before any wedding party menu is finalised. Food is not styled before it is honest." },
        { title: "Caste and region are quiet but real", body: "We ask, in private, about caste, region, and family customs. We do not treat the wedding as a generic \"Indian\" celebration — Punjabi, Gujarati, Tamil and Bengali traditions differ." },
        { title: "Music must be live where possible", body: "Dhol drummers for the baraat, classical musicians for the pheras. Recorded music is permitted at the sangeet and reception, but not at sacred moments." },
        { title: "The mandap is structural, not decorative", body: "The mandap holds the sacred fire and the seven steps. It is built to last the ceremony — we use load-rated structures, fire-safe drapery, and traditional pillar construction." },
      ],
    },
    planning: {
      ...
      days: [
        ...
        },
        {
          ...
          events: [
            ...
            { time: "19:30", body: "Sangeet · stage performances · cocktail dinner · dancing till midnight" },
          ],
        },
        {
          numeral: "III",
          ...
          events: [
            ...
            { time: "10:30", body: "Baraat procession · dhol · horse · 30 minutes" },
            { time: "11:00", body: "Varmala · garland exchange" },
            { time: "11:30", body: "Pheras at the mandap · 90 minutes" },
            { time: "13:30", body: "Traditional Indian lunch · banana leaf service" },
            { time: "19:00", body: "Reception cocktails" },
            { time: "20:30", body: "Reception dinner · long-table · first dance · speeches" },
          ],
        },
        {
          numeral: "IV",
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Amalfi Coast", sub: "Italy · May – October", imageKey: "compat-2", destinationHref: destinationPath("en", "amalfi") },
        { rating: 4, name: "Lake Como", sub: "Italy · June – September", imageKey: "compat-3", destinationHref: destinationPath("en", "lake-como") },
        { rating: 4, name: "Côte d'Azur", sub: "France · June – September", imageKey: "compat-4", destinationHref: destinationPath("en", "cote-dazur") },
        { rating: 4, name: "Tuscany", sub: "Italy · May – October", imageKey: "compat-5", destinationHref: destinationPath("en", "tuscany") },
        { rating: 3, name: "St. Barths", sub: "Caribbean · November – April", imageKey: "compat-6", destinationHref: destinationPath("en", "st-barths") },
        { rating: 3, name: "Provence", sub: "France · May – September", imageKey: "compat-7", destinationHref: destinationPath("en", "provence") },
        { rating: 3, name: "Aspen & Napa", sub: "United States · December – March", imageKey: "compat-8", destinationHref: destinationPath("en", "aspen-napa") },
      ],
    },
    guest: {
      ...
      cells: [
        { title: "Travel & accommodations", body: "Group room blocks at three hotel tiers — premium, standard, and family. Airport transfers coordinated across three days of arrivals. Welcome packages in every room with the schedule, dress code per event, and emergency contacts." },
        { title: "Elders & mobility", body: "Dedicated seating, separate transport, an elders' liaison from the studio team. Ground-floor rooms reserved for guests over seventy-five. Medical-on-call for the duration of the weekend." },
        { title: "Children & childcare", body: "Multilingual childcare team for ages 0-12, on-site for the sangeet and reception. Children's menus at every meal. Quiet rooms for naps during day ceremonies." },
        { title: "Dietary protocol", body: "Vegetarian, vegan, Jain, gluten-free, allergen-free menus for every meal. Religious dietary requirements (kosher, halal) coordinated where overlapping families require it. Three meals daily across the weekend." },
        { title: "Attire logistics", body: "Pressing service at the hotel for arrival, mid-week, and reception morning. Saree-tying and turban-tying assistance available on call. Lehengas pressed and prepared the morning of the pheras." },
        { title: "Communications", body: "WhatsApp group for every guest, three weeks before. Dedicated wedding website with daily schedule, dress codes, and venue maps. Printed guides in each welcome package." },
      ],
    },
    related: {
      ...
      articles: [
        { category: "Indian Weddings · Punta Cana", title: "Best Indian Wedding Venues in Punta Cana", body: "A working register of the resorts that hold a 300-guest baraat with grace.", imageKey: "culture-related-1" },
        { category: "Multi-day · Planning", title: "The Sangeet: Why the Night Before Matters More", body: "On the rehearsal that is no longer a rehearsal.", imageKey: "culture-related-2" },
        { category: "Design · Indian", title: "A Field Guide to Mandap Styles", body: "Punjabi, Gujarati, Tamil and Bengali design notes — and how they differ.", imageKey: "culture-related-3" },
        { category: "Cost · Indian", title: "What a Luxury Indian Wedding Actually Costs", body: "Frank 2026 budgets by guest count.", imageKey: "culture-related-4" },
        { category: "Tradition", title: "Mehndi, in Detail", body: "On the henna night that has become the most-photographed event of the weekend.", imageKey: "culture-related-5" },
      ],
      sidebarDestinations: [
      ...
      sidebarCultures: [
        ...
        { label: "South Asian weddings", href: culturePath("en", "south-asian-weddings") },
      ],
    },
    faq: {
      ...
      items: [
        {
          question: "How far in advance should we plan a destination Indian wedding?",
          answer: [
        ...
        {
          question: "Do you bring your own pandit and specialists, or use local ones?",
          answer: [
        ...
        {
          question: "Can you accommodate vegetarian, Jain or Gujarati dietary requirements?",
          answer: [
        ...
        {
          question: "Can you host Punjabi, Gujarati and South Indian traditions equally well?",
          answer: [
        ...
        {
          question: "How do interfaith Indian weddings work — Hindu-Christian, Hindu-Jewish, Sikh-Hindu?",
          answer: [
        ...
        {
          question: "What about guests who have never attended an Indian wedding?",
          answer: [
  ...
  es: {
    ...
    factStrip: [
      { label: "Duración de la boda", value: "3 – 5 días", sub: "5 – 8 ceremonias" },
      { label: "Número de invitados", value: "200 – 800", sub: "Más por encargo" },
      { label: "Antelación", value: "18 – 24 meses", sub: "Los especialistas se reservan pronto" },
      { label: "Regiones habituales", value: "Punjab · Gujarat", sub: "Tamil · Bengalí · Sij" },
    ...
    ceremonyArc: {
      ...
      steps: [
        { numeral: "I", name: "Mehndi", sub: "Noche de henna", when: "Noche del día 1", body: "Manos y pies decorados con henna intrincada. Música, baile, una reunión informal de las mujeres." },
        { numeral: "II", name: "Haldi", sub: "Ceremonia de la cúrcuma", when: "Mañana del día 2", body: "La novia y el novio son ungidos con pasta de cúrcuma por la familia. A menudo se celebra por separado, de blanco." },
        { numeral: "III", name: "Sangeet", sub: "Música y actuaciones", when: "Noche del día 2", body: "Actuaciones coreografiadas por ambas familias. La velada más teatral de la semana." },
        { numeral: "IV", name: "Baraat", sub: "Procesión del novio", when: "Mañana del día 3", body: "El novio llega a caballo o en un coche antiguo, acompañado de tamborileros dhol y de la familia bailando." },
        { numeral: "V", name: "Varmala", sub: "Intercambio de guirnaldas", when: "Mañana del día 3", body: "La novia y el novio intercambian guirnaldas florales en el mandap para aceptarse mutuamente." },
        { numeral: "VI", name: "Pheras", sub: "Siete pasos sagrados", when: "Mañana del día 3", body: "La pareja rodea el fuego sagrado siete veces, cada vuelta un voto. La boda hindú legal." },
        { numeral: "VII", name: "Recepción", sub: "Cena de celebración", when: "Noche del día 3", body: "Recepción de etiqueta, cena en mesa larga, los últimos discursos y el primer baile." },
      ],
    },
    designConcepts: {
      ...
      cards: [
        {
          ...
          rows: [
            ...
            { label: "Ideal para", value: "Playa · pabellón · pabellón con carpa" },
          ],
        },
        {
    ...
    protocols: {
      ...
      items: [
        { title: "El orden ritual no es negociable", body: "Los pheras van antes de la recepción. El baraat no comienza sin que la familia de la novia reciba al novio. No reordenamos las ceremonias por conveniencia del recinto ni por cuestiones de ritmo." },
        { title: "El pandit elige los horarios", body: "Los horarios sagrados (muhurat) los calcula el pandit a partir de las cartas de la pareja. Programamos la boda en torno a ellos, y no al revés." },
        { title: "Los mayores comen primero", body: "Las necesidades dietéticas vegetarianas y jainistas se atienden para los mayores antes de cerrar cualquier menú del cortejo nupcial. La comida no se estiliza antes de ser honesta." },
        { title: "Casta y región son discretas pero reales", body: "Preguntamos, en privado, por la casta, la región y las costumbres familiares. No tratamos la boda como una celebración «india» genérica — las tradiciones punjabi, gujarati, tamil y bengalí difieren." },
        { title: "La música debe ser en vivo siempre que sea posible", body: "Tamborileros dhol para el baraat, músicos clásicos para los pheras. La música grabada se permite en el sangeet y la recepción, pero no en los momentos sagrados." },
        { title: "El mandap es estructural, no decorativo", body: "El mandap alberga el fuego sagrado y los siete pasos. Se construye para resistir la ceremonia — usamos estructuras con carga calculada, drapeados ignífugos y construcción tradicional de pilares." },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            { time: "Mañana", body: "Llegada de invitados · traslados al aeropuerto · registro en el hotel" },
        ...
        },
        {
          ...
          events: [
            ...
            { time: "19:30", body: "Sangeet · actuaciones en escenario · cena cóctel · baile hasta medianoche" },
          ],
        },
        {
          numeral: "III",
          ...
          events: [
            { time: "09:00", body: "Preparación de novia y novio · suites separadas" },
            { time: "10:30", body: "Procesión baraat · dhol · caballo · 30 minutos" },
            { time: "11:00", body: "Varmala · intercambio de guirnaldas" },
            { time: "11:30", body: "Pheras en el mandap · 90 minutos" },
            { time: "13:30", body: "Almuerzo indio tradicional · servicio en hoja de plátano" },
            { time: "19:00", body: "Cócteles de recepción" },
            { time: "20:30", body: "Cena de recepción · mesa larga · primer baile · discursos" },
          ],
        },
        {
          numeral: "IV",
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Costa de Amalfi", sub: "Italia · mayo – octubre", imageKey: "compat-2", destinationHref: destinationPath("es", "amalfi") },
        { rating: 4, name: "Lago de Como", sub: "Italia · junio – septiembre", imageKey: "compat-3", destinationHref: destinationPath("es", "lake-como") },
        { rating: 4, name: "Costa Azul", sub: "Francia · junio – septiembre", imageKey: "compat-4", destinationHref: destinationPath("es", "cote-dazur") },
        { rating: 4, name: "Toscana", sub: "Italia · mayo – octubre", imageKey: "compat-5", destinationHref: destinationPath("es", "tuscany") },
        { rating: 3, name: "St. Barths", sub: "Caribe · noviembre – abril", imageKey: "compat-6", destinationHref: destinationPath("es", "st-barths") },
        { rating: 3, name: "Provenza", sub: "Francia · mayo – septiembre", imageKey: "compat-7", destinationHref: destinationPath("es", "provence") },
        { rating: 3, name: "Aspen y Napa", sub: "Estados Unidos · diciembre – marzo", imageKey: "compat-8", destinationHref: destinationPath("es", "aspen-napa") },
      ],
    },
    guest: {
      ...
      cells: [
        { title: "Viajes y alojamiento", body: "Bloques de habitaciones en tres categorías de hotel — premium, estándar y familiar. Traslados al aeropuerto coordinados a lo largo de tres días de llegadas. Paquetes de bienvenida en cada habitación con el programa, el código de vestimenta de cada evento y los contactos de emergencia." },
        { title: "Mayores y movilidad", body: "Asientos reservados, transporte separado, un enlace para mayores del equipo del atelier. Habitaciones en planta baja reservadas para invitados mayores de setenta y cinco años. Asistencia médica de guardia durante todo el fin de semana." },
        { title: "Niños y guardería", body: "Equipo de guardería multilingüe para edades de 0 a 12 años, presente en el sangeet y la recepción. Menús infantiles en cada comida. Salas tranquilas para las siestas durante las ceremonias diurnas." },
        { title: "Protocolo dietético", body: "Menús vegetarianos, veganos, jainistas, sin gluten y sin alérgenos en cada comida. Requisitos dietéticos religiosos (kosher, halal) coordinados cuando las familias mixtas lo requieren. Tres comidas diarias durante todo el fin de semana." },
        { title: "Logística del vestuario", body: "Servicio de planchado en el hotel para la llegada, mitad de semana y la mañana de la recepción. Asistencia para el atado de saris y turbantes disponible a petición. Lehengas planchados y preparados la mañana de los pheras." },
        { title: "Comunicaciones", body: "Grupo de WhatsApp para cada invitado, tres semanas antes. Sitio web dedicado a la boda con programa diario, códigos de vestimenta y mapas del recinto. Guías impresas en cada paquete de bienvenida." },
      ],
    },
    related: {
      ...
      headline: "Del *diario.*",
      articles: [
        { category: "Bodas Indias · Punta Cana", title: "Los mejores recintos para bodas indias en Punta Cana", body: "Un registro vivo de los resorts que acogen un baraat de 300 invitados con gracia.", imageKey: "culture-related-1" },
        { category: "Varios días · Planificación", title: "El sangeet: por qué la noche anterior importa aún más", body: "Sobre el ensayo que ya no es un ensayo.", imageKey: "culture-related-2" },
        { category: "Diseño · India", title: "Una guía de campo de los estilos de mandap", body: "Notas de diseño punjabi, gujarati, tamil y bengalí — y en qué se diferencian.", imageKey: "culture-related-3" },
        { category: "Coste · India", title: "Lo que cuesta de verdad una boda india de lujo", body: "Presupuestos francos de 2026 por número de invitados.", imageKey: "culture-related-4" },
        { category: "Tradición", title: "Mehndi, en detalle", body: "Sobre la noche de henna que se ha convertido en el evento más fotografiado del fin de semana.", imageKey: "culture-related-5" },
      ],
      sidebarDestinations: [
      ...
      sidebarCultures: [
        ...
        { label: "Bodas del sur de Asia", href: culturePath("es", "south-asian-weddings") },
      ],
    },
    faq: {
      ...
      items: [
        {
          question: "¿Con cuánta antelación deberíamos planificar una boda india en destino?",
          answer: [
        ...
        {
          question: "¿Traen su propio pandit y especialistas, o recurren a locales?",
          answer: [
        ...
        {
          question: "¿Pueden atender requisitos dietéticos vegetarianos, jainistas o gujaratis?",
          answer: [
        ...
        {
          question: "¿Pueden acoger las tradiciones punjabi, gujarati y del sur de India igual de bien?",
          answer: [
        ...
        {
          question: "¿Cómo funcionan las bodas indias interreligiosas — hindú-cristiana, hindú-judía, sij-hindú?",
          answer: [
  ...
  fr: {
    ...
    factStrip: [
      { label: "Durée du mariage", value: "3 – 5 jours", sub: "5 – 8 cérémonies" },
      { label: "Nombre d'invités", value: "200 – 800", sub: "Davantage sur demande" },
      { label: "Délai", value: "18 – 24 mois", sub: "Les spécialistes se réservent tôt" },
      { label: "Régions courantes", value: "Pendjab · Gujarat", sub: "Tamoul · Bengali · Sikh" },
      { label: "Cuisine", value: "Multirégionale", sub: "À dominante végétarienne" },
    ...
    ceremonyArc: {
      ...
      steps: [
        { numeral: "I", name: "Mehndi", sub: "Soirée du henné", when: "Soir du jour 1", body: "Mains et pieds décorés d'un henné minutieux. Musique, danse, un rassemblement informel des femmes." },
        { numeral: "II", name: "Haldi", sub: "Cérémonie du curcuma", when: "Matin du jour 2", body: "La mariée et le marié sont enduits de pâte de curcuma par la famille. Souvent tenue séparément, en blanc." },
        { numeral: "III", name: "Sangeet", sub: "Musique et spectacles", when: "Soir du jour 2", body: "Spectacles chorégraphiés par les deux familles. La soirée la plus théâtrale de la semaine." },
        { numeral: "IV", name: "Baraat", sub: "Procession du marié", when: "Matin du jour 3", body: "Le marié arrive à cheval ou dans une voiture ancienne, accompagné de tambours dhol et de la famille qui danse." },
        { numeral: "V", name: "Varmala", sub: "Échange de guirlandes", when: "Matin du jour 3", body: "La mariée et le marié échangent des guirlandes de fleurs au mandap pour s'accepter l'un l'autre." },
        { numeral: "VI", name: "Pheras", sub: "Sept pas sacrés", when: "Matin du jour 3", body: "Le couple fait sept fois le tour du feu sacré, chaque tour étant un vœu. Le mariage hindou légal." },
        { numeral: "VII", name: "Réception", sub: "Dîner de célébration", when: "Soir du jour 3", body: "Réception en tenue de soirée, dîner en table d'honneur, les derniers discours et la première danse." },
      ],
    },
    designConcepts: {
      ...
      cards: [
        {
          ...
          rows: [
            ...
            { label: "Idéal pour", value: "Plage · pavillon · pavillon sous tente" },
          ],
        },
        {
    ...
    protocols: {
      ...
      items: [
        { title: "L'ordre rituel n'est pas négociable", body: "Les pheras précèdent la réception. Le baraat ne commence pas sans que la famille de la mariée accueille le marié. Nous ne réorganisons pas les cérémonies par commodité de lieu ou par souci de rythme." },
        { title: "Le pandit choisit les horaires", body: "Les horaires sacrés (muhurat) sont calculés par le pandit à partir des thèmes du couple. Nous organisons le mariage autour d'eux — et non l'inverse." },
        { title: "Les aînés mangent d'abord", body: "Les exigences végétariennes et jaïnes sont prises en compte pour les aînés avant d'arrêter tout menu du cortège nuptial. La cuisine n'est pas stylisée avant d'être honnête." },
        { title: "Caste et région sont discrètes mais réelles", body: "Nous demandons, en privé, la caste, la région et les coutumes familiales. Nous ne traitons pas le mariage comme une célébration « indienne » générique — les traditions pendjabie, gujaratie, tamoule et bengalie diffèrent." },
        { title: "La musique doit être live autant que possible", body: "Tambours dhol pour le baraat, musiciens classiques pour les pheras. La musique enregistrée est permise au sangeet et à la réception, mais pas aux moments sacrés." },
        { title: "Le mandap est structurel, non décoratif", body: "Le mandap abrite le feu sacré et les sept pas. Il est bâti pour tenir toute la cérémonie — nous employons des structures à charge calculée, des drapés ignifuges et une construction de piliers traditionnelle." },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            { time: "Matin", body: "Arrivées des invités · transferts aéroport · enregistrement à l'hôtel" },
        ...
        },
        {
          ...
          events: [
            ...
            { time: "19h30", body: "Sangeet · spectacles sur scène · dîner cocktail · danse jusqu'à minuit" },
          ],
        },
        {
          numeral: "III",
          ...
          events: [
            ...
            { time: "10h30", body: "Procession baraat · dhol · cheval · 30 minutes" },
            { time: "11h00", body: "Varmala · échange de guirlandes" },
            { time: "11h30", body: "Pheras au mandap · 90 minutes" },
            { time: "13h30", body: "Déjeuner indien traditionnel · service sur feuille de bananier" },
            { time: "19h00", body: "Cocktails de réception" },
            { time: "20h30", body: "Dîner de réception · table d'honneur · première danse · discours" },
          ],
        },
        {
          numeral: "IV",
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Côte amalfitaine", sub: "Italie · mai – octobre", imageKey: "compat-2", destinationHref: destinationPath("fr", "amalfi") },
        { rating: 4, name: "Lac de Côme", sub: "Italie · juin – septembre", imageKey: "compat-3", destinationHref: destinationPath("fr", "lake-como") },
        { rating: 4, name: "Côte d'Azur", sub: "France · juin – septembre", imageKey: "compat-4", destinationHref: destinationPath("fr", "cote-dazur") },
        { rating: 4, name: "Toscane", sub: "Italie · mai – octobre", imageKey: "compat-5", destinationHref: destinationPath("fr", "tuscany") },
        { rating: 3, name: "Saint-Barthélemy", sub: "Caraïbes · novembre – avril", imageKey: "compat-6", destinationHref: destinationPath("fr", "st-barths") },
        { rating: 3, name: "Provence", sub: "France · mai – septembre", imageKey: "compat-7", destinationHref: destinationPath("fr", "provence") },
        { rating: 3, name: "Aspen & Napa", sub: "États-Unis · décembre – mars", imageKey: "compat-8", destinationHref: destinationPath("fr", "aspen-napa") },
      ],
    },
    guest: {
      ...
      cells: [
        { title: "Voyage et hébergement", body: "Blocs de chambres dans trois catégories d'hôtel — premium, standard et familial. Transferts aéroport coordonnés sur trois jours d'arrivées. Pochettes de bienvenue dans chaque chambre avec le programme, le code vestimentaire par événement et les contacts d'urgence." },
        { title: "Aînés et mobilité", body: "Places réservées, transport séparé, un référent aînés de l'équipe de l'atelier. Chambres au rez-de-chaussée réservées aux invités de plus de soixante-quinze ans. Médecin de garde pour toute la durée du week-end." },
        { title: "Enfants et garde", body: "Équipe de garde multilingue pour les 0 à 12 ans, présente au sangeet et à la réception. Menus enfants à chaque repas. Salles calmes pour les siestes pendant les cérémonies de jour." },
        { title: "Protocole alimentaire", body: "Menus végétariens, végétaliens, jaïns, sans gluten et sans allergène à chaque repas. Exigences alimentaires religieuses (casher, halal) coordonnées lorsque des familles mixtes le requièrent. Trois repas par jour sur tout le week-end." },
        { title: "Logistique des tenues", body: "Service de repassage à l'hôtel pour l'arrivée, le milieu de semaine et le matin de la réception. Aide au nouage des saris et des turbans disponible sur demande. Lehengas repassés et préparés le matin des pheras." },
        { title: "Communication", body: "Groupe WhatsApp pour chaque invité, trois semaines avant. Site web dédié au mariage avec programme quotidien, codes vestimentaires et plans du lieu. Guides imprimés dans chaque pochette de bienvenue." },
      ],
    },
    related: {
      ...
      headline: "Du *journal.*",
      articles: [
        { category: "Mariages Indiens · Punta Cana", title: "Les meilleurs lieux de mariage indien à Punta Cana", body: "Un registre vivant des resorts qui accueillent un baraat de 300 invités avec grâce.", imageKey: "culture-related-1" },
        { category: "Plusieurs jours · Planification", title: "Le sangeet : pourquoi la veille compte encore plus", body: "Sur la répétition qui n'en est plus une.", imageKey: "culture-related-2" },
        { category: "Design · Inde", title: "Un guide pratique des styles de mandap", body: "Notes de design pendjabi, gujarati, tamoul et bengali — et leurs différences.", imageKey: "culture-related-3" },
        { category: "Coût · Inde", title: "Ce que coûte vraiment un mariage indien de luxe", body: "Budgets francs 2026 selon le nombre d'invités.", imageKey: "culture-related-4" },
        { category: "Tradition", title: "Le mehndi, en détail", body: "Sur la soirée du henné devenue l'événement le plus photographié du week-end.", imageKey: "culture-related-5" },
      ],
      sidebarDestinations: [
      ...
      sidebarCultures: [
        ...
        { label: "Mariages d'Asie du Sud", href: culturePath("fr", "south-asian-weddings") },
      ],
    },
    faq: {
      ...
      items: [
        {
          question: "Combien de temps à l'avance faut-il planifier un mariage indien en destination ?",
          answer: [
        ...
        {
          question: "Apportez-vous votre propre pandit et vos spécialistes, ou faites-vous appel à des prestataires locaux ?",
          answer: [
        ...
        {
          question: "Pouvez-vous répondre aux exigences végétariennes, jaïnes ou gujaraties ?",
          answer: [
        ...
        {
          question: "Quel est le coût type d'un mariage indien en destination ?",
          answer: [
        ...
        {
          question: "Pouvez-vous accueillir aussi bien les traditions pendjabie, gujaratie et de l'Inde du Sud ?",
          answer: [
        ...
        {
          question: "Comment fonctionnent les mariages indiens interconfessionnels — hindou-chrétien, hindou-juif, sikh-hindou ?",
          answer: [
        ...
        {
          question: "Et les invités qui n'ont jamais assisté à un mariage indien ?",
          answer: [
  ...
  pt: {
    ...
    factStrip: [
      { label: "Duração do casamento", value: "3 – 5 dias", sub: "5 – 8 cerimónias" },
      { label: "Número de convidados", value: "200 – 800", sub: "Mais a pedido" },
      { label: "Antecedência", value: "18 – 24 meses", sub: "Os especialistas reservam-se cedo" },
      { label: "Regiões comuns", value: "Punjab · Gujarat", sub: "Tamil · Bengali · Sikh" },
    ...
    ceremonyArc: {
      ...
      steps: [
        { numeral: "I", name: "Mehndi", sub: "Noite de hena", when: "Noite do dia 1", body: "Mãos e pés decorados com hena intrincada. Música, dança, um encontro informal das mulheres." },
        { numeral: "II", name: "Haldi", sub: "Cerimónia da curcuma", when: "Manhã do dia 2", body: "A noiva e o noivo são ungidos com pasta de curcuma pela família. Muitas vezes realizada em separado, de branco." },
        { numeral: "III", name: "Sangeet", sub: "Música e atuações", when: "Noite do dia 2", body: "Atuações coreografadas por ambas as famílias. A noite mais teatral da semana." },
        { numeral: "IV", name: "Baraat", sub: "Procissão do noivo", when: "Manhã do dia 3", body: "O noivo chega a cavalo ou num carro clássico, acompanhado de tocadores de dhol e da família a dançar." },
        { numeral: "V", name: "Varmala", sub: "Troca de guirlandas", when: "Manhã do dia 3", body: "A noiva e o noivo trocam guirlandas de flores no mandap para se aceitarem mutuamente." },
        { numeral: "VI", name: "Pheras", sub: "Sete passos sagrados", when: "Manhã do dia 3", body: "O casal rodeia o fogo sagrado sete vezes, cada volta um voto. O casamento hindu legal." },
        { numeral: "VII", name: "Receção", sub: "Jantar de celebração", when: "Noite do dia 3", body: "Receção de gala, jantar em mesa comprida, os últimos discursos e a primeira dança." },
      ],
    },
    designConcepts: {
      ...
      cards: [
        {
          ...
          rows: [
            ...
            { label: "Ideal para", value: "Praia · pavilhão · pavilhão com tenda" },
          ],
        },
        {
    ...
    protocols: {
      ...
      items: [
        { title: "A ordem ritual não é negociável", body: "Os pheras vêm antes da receção. O baraat não começa sem que a família da noiva receba o noivo. Não reorganizamos as cerimónias por conveniência do espaço nem por questões de ritmo." },
        { title: "O pandit escolhe os horários", body: "Os horários sagrados (muhurat) são calculados pelo pandit a partir dos mapas do casal. Organizamos o casamento em torno deles — e não o contrário." },
        { title: "Os mais velhos comem primeiro", body: "As necessidades alimentares vegetarianas e jainistas são acauteladas para os mais velhos antes de se fechar qualquer ementa do cortejo nupcial. A comida não é estilizada antes de ser honesta." },
        { title: "Casta e região são discretas mas reais", body: "Perguntamos, em privado, sobre casta, região e costumes familiares. Não tratamos o casamento como uma celebração «indiana» genérica — as tradições punjabi, gujarati, tamil e bengali diferem." },
        { title: "A música deve ser ao vivo sempre que possível", body: "Tocadores de dhol para o baraat, músicos clássicos para os pheras. A música gravada é permitida no sangeet e na receção, mas não nos momentos sagrados." },
        { title: "O mandap é estrutural, não decorativo", body: "O mandap acolhe o fogo sagrado e os sete passos. É construído para durar toda a cerimónia — usamos estruturas com carga calculada, drapeados ignífugos e construção tradicional de pilares." },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            { time: "Manhã", body: "Chegada de convidados · transferes do aeroporto · check-in no hotel" },
        ...
        },
        {
          ...
          events: [
            ...
            { time: "19:30", body: "Sangeet · atuações em palco · jantar cocktail · dança até à meia-noite" },
          ],
        },
        {
          numeral: "III",
          ...
          events: [
            { time: "09:00", body: "Preparação da noiva e do noivo · suítes separadas" },
            { time: "10:30", body: "Procissão baraat · dhol · cavalo · 30 minutos" },
            { time: "11:00", body: "Varmala · troca de guirlandas" },
            { time: "11:30", body: "Pheras no mandap · 90 minutos" },
            { time: "13:30", body: "Almoço indiano tradicional · serviço em folha de bananeira" },
            { time: "19:00", body: "Cocktails de receção" },
            { time: "20:30", body: "Jantar de receção · mesa comprida · primeira dança · discursos" },
          ],
        },
        {
          numeral: "IV",
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Costa Amalfitana", sub: "Itália · maio – outubro", imageKey: "compat-2", destinationHref: destinationPath("pt", "amalfi") },
        { rating: 4, name: "Lago de Como", sub: "Itália · junho – setembro", imageKey: "compat-3", destinationHref: destinationPath("pt", "lake-como") },
        { rating: 4, name: "Costa Azul", sub: "França · junho – setembro", imageKey: "compat-4", destinationHref: destinationPath("pt", "cote-dazur") },
        { rating: 4, name: "Toscana", sub: "Itália · maio – outubro", imageKey: "compat-5", destinationHref: destinationPath("pt", "tuscany") },
        { rating: 3, name: "St. Barths", sub: "Caraíbas · novembro – abril", imageKey: "compat-6", destinationHref: destinationPath("pt", "st-barths") },
        { rating: 3, name: "Provença", sub: "França · maio – setembro", imageKey: "compat-7", destinationHref: destinationPath("pt", "provence") },
        { rating: 3, name: "Aspen e Napa", sub: "Estados Unidos · dezembro – março", imageKey: "compat-8", destinationHref: destinationPath("pt", "aspen-napa") },
      ],
    },
    guest: {
      ...
      cells: [
        { title: "Viagens e alojamento", body: "Blocos de quartos em três categorias de hotel — premium, padrão e família. Transferes do aeroporto coordenados ao longo de três dias de chegadas. Pacotes de boas-vindas em cada quarto com o programa, o código de vestuário por evento e os contactos de emergência." },
        { title: "Mais velhos e mobilidade", body: "Lugares reservados, transporte separado, um elo de ligação para os mais velhos da equipa do ateliê. Quartos no piso térreo reservados para convidados com mais de setenta e cinco anos. Apoio médico de permanência durante todo o fim de semana." },
        { title: "Crianças e acompanhamento", body: "Equipa de acompanhamento multilingue para idades dos 0 aos 12 anos, presente no sangeet e na receção. Ementas infantis em cada refeição. Salas tranquilas para as sestas durante as cerimónias diurnas." },
        { title: "Protocolo alimentar", body: "Ementas vegetarianas, veganas, jainistas, sem glúten e sem alergénios em cada refeição. Requisitos alimentares religiosos (kosher, halal) coordenados quando famílias mistas o exigem. Três refeições diárias ao longo do fim de semana." },
        { title: "Logística do vestuário", body: "Serviço de engomadoria no hotel para a chegada, meio da semana e manhã da receção. Apoio para atar saris e turbantes disponível a pedido. Lehengas engomados e preparados na manhã dos pheras." },
        { title: "Comunicações", body: "Grupo de WhatsApp para cada convidado, três semanas antes. Website dedicado ao casamento com programa diário, códigos de vestuário e mapas do espaço. Guias impressos em cada pacote de boas-vindas." },
      ],
    },
    related: {
      ...
      headline: "Do *diário.*",
      articles: [
        { category: "Casamentos Indianos · Punta Cana", title: "Os melhores espaços para casamentos indianos em Punta Cana", body: "Um registo vivo dos resorts que acolhem um baraat de 300 convidados com graça.", imageKey: "culture-related-1" },
        { category: "Vários dias · Planeamento", title: "O sangeet: porque a noite anterior importa ainda mais", body: "Sobre o ensaio que já não é um ensaio.", imageKey: "culture-related-2" },
        { category: "Design · Índia", title: "Um guia de campo dos estilos de mandap", body: "Notas de design punjabi, gujarati, tamil e bengali — e como diferem.", imageKey: "culture-related-3" },
        { category: "Custo · Índia", title: "O que custa de facto um casamento indiano de luxo", body: "Orçamentos francos de 2026 por número de convidados.", imageKey: "culture-related-4" },
        { category: "Tradição", title: "Mehndi, em detalhe", body: "Sobre a noite de hena que se tornou o evento mais fotografado do fim de semana.", imageKey: "culture-related-5" },
      ],
      sidebarDestinations: [
      ...
      sidebarCultures: [
        ...
        { label: "Casamentos do sul da Ásia", href: culturePath("pt", "south-asian-weddings") },
      ],
    },
    faq: {
      ...
      items: [
        {
          question: "Com que antecedência devemos planear um casamento indiano em destino?",
          answer: [
        ...
        {
          question: "Trazem o vosso próprio pandit e especialistas, ou recorrem a locais?",
          answer: [
        ...
        {
          question: "Conseguem responder a requisitos alimentares vegetarianos, jainistas ou gujaratis?",
          answer: [
        ...
        {
          question: "Conseguem acolher as tradições punjabi, gujarati e do sul da Índia igualmente bem?",
          answer: [
        ...
        {
          question: "Como funcionam os casamentos indianos inter-religiosos — hindu-cristão, hindu-judaico, sikh-hindu?",
          answer: [
        ...
        {
          question: "E os convidados que nunca assistiram a um casamento indiano?",
          answer: [
  ...
  de: {
    ...
    factStrip: [
      ...
      { label: "Vorlaufzeit", value: "18 – 24 Monate", sub: "Spezialisten buchen früh" },
      { label: "Häufige Regionen", value: "Punjab · Gujarat", sub: "Tamil · Bengali · Sikh" },
    ...
    ceremonyArc: {
      ...
      steps: [
        { numeral: "I", name: "Mehndi", sub: "Henna-Nacht", when: "Tag 1 abends", body: "Hände und Füße werden mit kunstvollem Henna verziert. Musik, Tanz, eine zwanglose Versammlung der Frauen." },
        { numeral: "II", name: "Haldi", sub: "Kurkuma-Zeremonie", when: "Tag 2 morgens", body: "Braut und Bräutigam werden von der Familie mit Kurkumapaste gesalbt. Oft getrennt gehalten, in Weiß." },
        { numeral: "III", name: "Sangeet", sub: "Musik & Darbietungen", when: "Tag 2 abends", body: "Choreografierte Darbietungen beider Familien. Der theatralischste Abend der Woche." },
        { numeral: "IV", name: "Baraat", sub: "Prozession des Bräutigams", when: "Tag 3 morgens", body: "Der Bräutigam kommt zu Pferd oder im Oldtimer, begleitet von Dhol-Trommlern und tanzender Familie." },
        { numeral: "V", name: "Varmala", sub: "Girlandentausch", when: "Tag 3 morgens", body: "Braut und Bräutigam tauschen am Mandap Blumengirlanden, um einander anzunehmen." },
        { numeral: "VI", name: "Pheras", sub: "Sieben heilige Schritte", when: "Tag 3 morgens", body: "Das Paar umrundet siebenmal das heilige Feuer, jede Runde ein Gelübde. Die rechtsgültige hinduistische Hochzeit." },
        { numeral: "VII", name: "Empfang", sub: "Festdinner", when: "Tag 3 abends", body: "Empfang in Abendgarderobe, Dinner an der langen Tafel, die letzten Reden und der erste Tanz." },
      ],
    },
    designConcepts: {
      ...
      cards: [
        {
          ...
          rows: [
            ...
            { label: "Am besten für", value: "Strand · Pavillon · Zeltpavillon" },
          ],
        },
        {
          title: "Tiefrot & Gold",
    ...
    protocols: {
      ...
      items: [
        { title: "Die Ritualordnung ist nicht verhandelbar", body: "Die Pheras kommen vor dem Empfang. Das Baraat beginnt nicht, ohne dass die Familie der Braut den Bräutigam empfängt. Wir ordnen Zeremonien nicht aus Gründen der Veranstaltungslogistik oder des Tempos um." },
        { title: "Der Pandit bestimmt die Zeiten", body: "Die heiligen Zeiten (Muhurat) berechnet der Pandit anhand der Horoskope des Paares. Wir planen die Hochzeit um sie herum — nicht umgekehrt." },
        { title: "Die Ältesten essen zuerst", body: "Vegetarische und jainistische Ernährungsanforderungen werden für die Ältesten berücksichtigt, bevor irgendein Menü der Hochzeitsgesellschaft festgelegt wird. Essen wird nicht stilisiert, bevor es ehrlich ist." },
        { title: "Kaste und Region sind leise, aber real", body: "Wir fragen, vertraulich, nach Kaste, Region und Familienbräuchen. Wir behandeln die Hochzeit nicht als generische „indische“ Feier — die Traditionen der Punjabi, Gujarati, Tamilen und Bengalen unterscheiden sich." },
        { title: "Musik soll, wo möglich, live sein", body: "Dhol-Trommler für das Baraat, klassische Musiker für die Pheras. Aufgenommene Musik ist beim Sangeet und Empfang erlaubt, aber nicht in heiligen Momenten." },
        { title: "Das Mandap ist tragend, nicht dekorativ", body: "Das Mandap beherbergt das heilige Feuer und die sieben Schritte. Es ist gebaut, um die Zeremonie zu überdauern — wir verwenden lastgeprüfte Strukturen, feuersichere Drapierung und traditionelle Säulenkonstruktion." },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            { time: "Vormittag", body: "Gästeankünfte · Flughafentransfers · Hotel-Check-in" },
        ...
        },
        {
          ...
          events: [
            ...
            { time: "19:30", body: "Sangeet · Bühnendarbietungen · Cocktaildinner · Tanz bis Mitternacht" },
          ],
        },
        {
          numeral: "III",
          ...
          events: [
            { time: "09:00", body: "Vorbereitung von Braut und Bräutigam · getrennte Suiten" },
            { time: "10:30", body: "Baraat-Prozession · Dhol · Pferd · 30 Minuten" },
            { time: "11:00", body: "Varmala · Girlandentausch" },
            { time: "11:30", body: "Pheras am Mandap · 90 Minuten" },
            { time: "13:30", body: "Traditioneller indischer Lunch · Servieren auf Bananenblatt" },
            { time: "19:00", body: "Empfangscocktails" },
            { time: "20:30", body: "Empfangsdinner · lange Tafel · erster Tanz · Reden" },
          ],
        },
        {
          numeral: "IV",
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Amalfiküste", sub: "Italien · Mai – Oktober", imageKey: "compat-2", destinationHref: destinationPath("de", "amalfi") },
        { rating: 4, name: "Comer See", sub: "Italien · Juni – September", imageKey: "compat-3", destinationHref: destinationPath("de", "lake-como") },
        { rating: 4, name: "Côte d'Azur", sub: "Frankreich · Juni – September", imageKey: "compat-4", destinationHref: destinationPath("de", "cote-dazur") },
        { rating: 4, name: "Toskana", sub: "Italien · Mai – Oktober", imageKey: "compat-5", destinationHref: destinationPath("de", "tuscany") },
        { rating: 3, name: "St. Barths", sub: "Karibik · November – April", imageKey: "compat-6", destinationHref: destinationPath("de", "st-barths") },
        { rating: 3, name: "Provence", sub: "Frankreich · Mai – September", imageKey: "compat-7", destinationHref: destinationPath("de", "provence") },
        { rating: 3, name: "Aspen & Napa", sub: "Vereinigte Staaten · Dezember – März", imageKey: "compat-8", destinationHref: destinationPath("de", "aspen-napa") },
      ],
    },
    guest: {
      ...
      cells: [
        { title: "Anreise & Unterbringung", body: "Gruppenkontingente in drei Hotelkategorien — Premium, Standard und Familie. Flughafentransfers über drei Ankunftstage koordiniert. Willkommenspakete in jedem Zimmer mit Programm, Dresscode pro Veranstaltung und Notfallkontakten." },
        { title: "Ältere & Mobilität", body: "Reservierte Plätze, gesonderter Transport, eine Betreuungsperson für die Älteren aus dem Atelier-Team. Erdgeschosszimmer für Gäste über fünfundsiebzig reserviert. Ärztlicher Bereitschaftsdienst für die gesamte Dauer des Wochenendes." },
        { title: "Kinder & Betreuung", body: "Mehrsprachiges Betreuungsteam für 0 bis 12 Jahre, vor Ort beim Sangeet und Empfang. Kindermenüs bei jeder Mahlzeit. Ruheräume für den Mittagsschlaf während der Tageszeremonien." },
        { title: "Ernährungsprotokoll", body: "Vegetarische, vegane, jainistische, glutenfreie und allergenfreie Menüs bei jeder Mahlzeit. Religiöse Ernährungsvorschriften (koscher, halal) koordiniert, wo gemischte Familien es erfordern. Drei Mahlzeiten täglich über das Wochenende." },
        { title: "Garderoben-Logistik", body: "Bügelservice im Hotel für Ankunft, Wochenmitte und Empfangsmorgen. Hilfe beim Binden von Sari und Turban auf Abruf verfügbar. Lehengas am Morgen der Pheras gebügelt und vorbereitet." },
        { title: "Kommunikation", body: "WhatsApp-Gruppe für jeden Gast, drei Wochen zuvor. Eigene Hochzeitswebsite mit Tagesprogramm, Dresscodes und Lageplänen. Gedruckte Leitfäden in jedem Willkommenspaket." },
      ],
    },
    related: {
      eyebrow: "Weiterlesen",
      ...
      articles: [
        { category: "Indische Hochzeiten · Punta Cana", title: "Die besten Locations für indische Hochzeiten in Punta Cana", body: "Ein lebendiges Register der Resorts, die ein Baraat mit 300 Gästen mit Anmut tragen.", imageKey: "culture-related-1" },
        { category: "Mehrtägig · Planung", title: "Das Sangeet: Warum der Abend zuvor noch mehr zählt", body: "Über die Probe, die keine Probe mehr ist.", imageKey: "culture-related-2" },
        { category: "Design · Indisch", title: "Ein Feldführer der Mandap-Stile", body: "Designnotizen zu Punjabi, Gujarati, Tamil und Bengali — und worin sie sich unterscheiden.", imageKey: "culture-related-3" },
        { category: "Kosten · Indisch", title: "Was eine indische Luxushochzeit wirklich kostet", body: "Offene Budgets für 2026 nach Gästezahl.", imageKey: "culture-related-4" },
        { category: "Tradition", title: "Mehndi, im Detail", body: "Über die Henna-Nacht, die zum meistfotografierten Ereignis des Wochenendes geworden ist.", imageKey: "culture-related-5" },
      ],
      sidebarDestinations: [
      ...
      sidebarCultures: [
        ...
        { label: "Südasiatische Hochzeiten", href: culturePath("de", "south-asian-weddings") },
      ],
    },
    faq: {
      ...
      items: [
        {
          question: "Wie lange im Voraus sollten wir eine indische Destination-Hochzeit planen?",
          answer: [
        ...
        {
          question: "Bringen Sie Ihren eigenen Pandit und Ihre Spezialisten mit, oder arbeiten Sie mit lokalen?",
          answer: [
        ...
        {
          question: "Können Sie vegetarische, jainistische oder Gujarati-Ernährungsanforderungen erfüllen?",
          answer: [
        ...
        {
          question: "Was kostet eine indische Destination-Hochzeit typischerweise?",
          answer: [
        ...
        {
          question: "Können Sie Punjabi-, Gujarati- und südindische Traditionen gleichermaßen gut ausrichten?",
          answer: [
        ...
        {
          question: "Wie funktionieren interreligiöse indische Hochzeiten — hinduistisch-christlich, hinduistisch-jüdisch, sikh-hinduistisch?",
          answer: [
        ...
        {
          question: "Was ist mit Gästen, die noch nie auf einer indischen Hochzeit waren?",
          answer: [
  ...
  it: {
    ...
    factStrip: [
      { label: "Durata del matrimonio", value: "3 – 5 giorni", sub: "5 – 8 cerimonie" },
      { label: "Numero di invitati", value: "200 – 800", sub: "Di più su richiesta" },
      { label: "Anticipo", value: "18 – 24 mesi", sub: "Gli specialisti si prenotano presto" },
      { label: "Regioni comuni", value: "Punjab · Gujarat", sub: "Tamil · Bengalese · Sikh" },
    ...
    ceremonyArc: {
      ...
      steps: [
        { numeral: "I", name: "Mehndi", sub: "Notte dell'henné", when: "Sera del giorno 1", body: "Mani e piedi decorati con henné intricato. Musica, danza, un raduno informale delle donne." },
        { numeral: "II", name: "Haldi", sub: "Cerimonia della curcuma", when: "Mattina del giorno 2", body: "Sposa e sposo vengono unti con pasta di curcuma dalla famiglia. Spesso tenuta separatamente, in bianco." },
        { numeral: "III", name: "Sangeet", sub: "Musica e spettacoli", when: "Sera del giorno 2", body: "Spettacoli coreografati da entrambe le famiglie. La serata più teatrale della settimana." },
        { numeral: "IV", name: "Baraat", sub: "Processione dello sposo", when: "Mattina del giorno 3", body: "Lo sposo arriva a cavallo o su un'auto d'epoca, accompagnato da tamburini dhol e dalla famiglia che danza." },
        { numeral: "V", name: "Varmala", sub: "Scambio di ghirlande", when: "Mattina del giorno 3", body: "Sposa e sposo si scambiano ghirlande di fiori al mandap per accettarsi a vicenda." },
        { numeral: "VI", name: "Pheras", sub: "Sette passi sacri", when: "Mattina del giorno 3", body: "La coppia gira sette volte attorno al fuoco sacro, ogni giro un voto. Il matrimonio indù legale." },
        { numeral: "VII", name: "Ricevimento", sub: "Cena di celebrazione", when: "Sera del giorno 3", body: "Ricevimento in abito da sera, cena a tavolata, gli ultimi discorsi e il primo ballo." },
      ],
    },
    designConcepts: {
      ...
      cards: [
        {
          ...
          rows: [
            ...
            { label: "Ideale per", value: "Spiaggia · padiglione · padiglione con tenda" },
          ],
        },
        {
    ...
    protocols: {
      ...
      items: [
        { title: "L'ordine rituale non è negoziabile", body: "I pheras vengono prima del ricevimento. Il baraat non comincia senza che la famiglia della sposa accolga lo sposo. Non riordiniamo le cerimonie per comodità della location o per ragioni di ritmo." },
        { title: "Il pandit sceglie gli orari", body: "Gli orari sacri (muhurat) sono calcolati dal pandit a partire dai temi natali della coppia. Programmiamo il matrimonio attorno a essi — e non viceversa." },
        { title: "Gli anziani mangiano per primi", body: "Le esigenze alimentari vegetariane e jainiste sono accolte per gli anziani prima di chiudere qualsiasi menù del corteo nuziale. Il cibo non viene stilizzato prima di essere onesto." },
        { title: "Casta e regione sono discrete ma reali", body: "Chiediamo, in privato, casta, regione e usanze familiari. Non trattiamo il matrimonio come una generica celebrazione «indiana» — le tradizioni punjabi, gujarati, tamil e bengalesi differiscono." },
        { title: "La musica deve essere dal vivo ove possibile", body: "Tamburini dhol per il baraat, musicisti classici per i pheras. La musica registrata è ammessa al sangeet e al ricevimento, ma non nei momenti sacri." },
        { title: "Il mandap è strutturale, non decorativo", body: "Il mandap custodisce il fuoco sacro e i sette passi. È costruito per reggere l'intera cerimonia — usiamo strutture a portata calcolata, drappeggi ignifughi e costruzione tradizionale dei pilastri." },
      ],
    },
    planning: {
      ...
      days: [
        {
          ...
          events: [
            { time: "Mattina", body: "Arrivi degli invitati · transfer dall'aeroporto · check-in in hotel" },
        ...
        },
        {
          ...
          events: [
            ...
            { time: "19:30", body: "Sangeet · spettacoli sul palco · cena cocktail · ballo fino a mezzanotte" },
          ],
        },
        {
          numeral: "III",
          ...
          events: [
            { time: "09:00", body: "Preparazione di sposa e sposo · suite separate" },
            { time: "10:30", body: "Processione baraat · dhol · cavallo · 30 minuti" },
            { time: "11:00", body: "Varmala · scambio di ghirlande" },
            { time: "11:30", body: "Pheras al mandap · 90 minuti" },
            { time: "13:30", body: "Pranzo indiano tradizionale · servizio su foglia di banano" },
            { time: "19:00", body: "Cocktail di ricevimento" },
            { time: "20:30", body: "Cena di ricevimento · tavolata · primo ballo · discorsi" },
          ],
        },
        {
          numeral: "IV",
    ...
    compatibility: {
      ...
      cards: [
        ...
        { rating: 5, name: "Costiera Amalfitana", sub: "Italia · maggio – ottobre", imageKey: "compat-2", destinationHref: destinationPath("it", "amalfi") },
        { rating: 4, name: "Lago di Como", sub: "Italia · giugno – settembre", imageKey: "compat-3", destinationHref: destinationPath("it", "lake-como") },
        { rating: 4, name: "Costa Azzurra", sub: "Francia · giugno – settembre", imageKey: "compat-4", destinationHref: destinationPath("it", "cote-dazur") },
        { rating: 4, name: "Toscana", sub: "Italia · maggio – ottobre", imageKey: "compat-5", destinationHref: destinationPath("it", "tuscany") },
        { rating: 3, name: "St. Barths", sub: "Caraibi · novembre – aprile", imageKey: "compat-6", destinationHref: destinationPath("it", "st-barths") },
        { rating: 3, name: "Provenza", sub: "Francia · maggio – settembre", imageKey: "compat-7", destinationHref: destinationPath("it", "provence") },
        { rating: 3, name: "Aspen e Napa", sub: "Stati Uniti · dicembre – marzo", imageKey: "compat-8", destinationHref: destinationPath("it", "aspen-napa") },
      ],
    },
    guest: {
      ...
      cells: [
        { title: "Viaggi e alloggio", body: "Blocchi di camere in tre fasce d'hotel — premium, standard e famiglia. Transfer dall'aeroporto coordinati su tre giorni di arrivi. Pacchetti di benvenuto in ogni camera con il programma, il dress code per evento e i contatti d'emergenza." },
        { title: "Anziani e mobilità", body: "Posti riservati, trasporto separato, un referente per gli anziani del team dell'atelier. Camere al piano terra riservate agli invitati oltre i settantacinque anni. Assistenza medica reperibile per tutta la durata del fine settimana." },
        { title: "Bambini e assistenza", body: "Team di assistenza multilingue per le età da 0 a 12 anni, presente al sangeet e al ricevimento. Menù per bambini a ogni pasto. Stanze tranquille per i riposini durante le cerimonie diurne." },
        { title: "Protocollo alimentare", body: "Menù vegetariani, vegani, jainisti, senza glutine e senza allergeni a ogni pasto. Requisiti alimentari religiosi (kosher, halal) coordinati dove famiglie miste lo richiedono. Tre pasti al giorno per tutto il fine settimana." },
        { title: "Logistica dell'abbigliamento", body: "Servizio di stiratura in hotel per l'arrivo, metà settimana e mattina del ricevimento. Assistenza per annodare sari e turbanti disponibile su richiesta. Lehenga stirati e preparati la mattina dei pheras." },
        { title: "Comunicazioni", body: "Gruppo WhatsApp per ogni invitato, tre settimane prima. Sito web dedicato al matrimonio con programma giornaliero, dress code e mappe della location. Guide stampate in ogni pacchetto di benvenuto." },
      ],
    },
    related: {
      ...
      headline: "Dal *diario.*",
      articles: [
        { category: "Matrimoni Indiani · Punta Cana", title: "Le migliori location per matrimoni indiani a Punta Cana", body: "Un registro vivo dei resort che accolgono un baraat da 300 invitati con grazia.", imageKey: "culture-related-1" },
        { category: "Più giorni · Pianificazione", title: "Il sangeet: perché la sera prima conta ancora di più", body: "Sulla prova che non è più una prova.", imageKey: "culture-related-2" },
        { category: "Design · Indiano", title: "Una guida pratica agli stili di mandap", body: "Note di design punjabi, gujarati, tamil e bengalese — e come differiscono.", imageKey: "culture-related-3" },
        { category: "Costo · Indiano", title: "Quanto costa davvero un matrimonio indiano di lusso", body: "Budget franchi per il 2026 per numero di invitati.", imageKey: "culture-related-4" },
        { category: "Tradizione", title: "Mehndi, nel dettaglio", body: "Sulla notte dell'henné diventata l'evento più fotografato del fine settimana.", imageKey: "culture-related-5" },
      ],
      sidebarDestinations: [
      ...
      sidebarCultures: [
        ...
        { label: "Matrimoni dell'Asia meridionale", href: culturePath("it", "south-asian-weddings") },
      ],
    },
    faq: {
      ...
      items: [
        {
          question: "Con quanto anticipo dovremmo pianificare un matrimonio indiano in destinazione?",
          answer: [
        ...
        {
          question: "Portate il vostro pandit e i vostri specialisti, o ne usate di locali?",
          answer: [
        ...
        {
          question: "Potete soddisfare esigenze alimentari vegetariane, jainiste o gujarati?",
          answer: [
        ...
        {
          question: "Qual è il costo tipico di un matrimonio indiano in destinazione?",
          answer: [
        ...
        {
          question: "Potete accogliere le tradizioni punjabi, gujarati e dell'India del Sud con la stessa cura?",
          answer: [
        ...
        {
          question: "Come funzionano i matrimoni indiani interreligiosi — indù-cristiano, indù-ebraico, sikh-indù?",
          answer: [
        ...
        {
          question: "E gli invitati che non hanno mai partecipato a un matrimonio indiano?",
          answer: [
